...
public class ReportFragment extends Fragment {
   ...
   private void dispatchCreate(ActivityInitializationListener var1) {
      if (var1 != null) {
         var1.onCreate();
      }
   ...
   private void dispatchResume(ActivityInitializationListener var1) {
      if (var1 != null) {
         var1.onResume();
      }
   ...
   private void dispatchStart(ActivityInitializationListener var1) {
      if (var1 != null) {
         var1.onStart();
      }
   ...
   public static void injectIfNeededIn(Activity var0) {
      if (VERSION.SDK_INT >= 29) {
         ReportFragment.LifecycleCallbacks.registerIn(var0);
      }
   ...
   void setProcessListener(ActivityInitializationListener var1) {
   ...
   static class LifecycleCallbacks implements Application.ActivityLifecycleCallbacks {
      static void registerIn(Activity var0) {
         var0.registerActivityLifecycleCallbacks(new LifecycleCallbacks());
      }
