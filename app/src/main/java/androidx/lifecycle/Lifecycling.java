...
public class Lifecycling {
      ...
      label82: {
         ...
         label61: {
            ...
            try {
               ...
               var20 = var3.append(var20).append(".").append(var2).toString();
   ...
   static LifecycleEventObserver lifecycleEventObserver(Object var0) {
      boolean var4 = var0 instanceof LifecycleEventObserver;
      ...
      if (var4 && var3) {
         ...
         if (getObserverConstructorType(var5) != 2) {
            return new ReflectiveGenericLifecycleObserver(var0);
         } else {
            List var7 = (List)sClassToAdapters.get(var5);
            int var2 = var7.size();
            int var1 = 0;
            if (var2 == 1) {
               ...
               for(var6 = new GeneratedAdapter[var7.size()]; var1 < var7.size(); ++var1) {
                  var6[var1] = createGeneratedAdapter((Constructor)var7.get(var1), var0);
               }
