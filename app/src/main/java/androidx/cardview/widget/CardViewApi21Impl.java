...
class CardViewApi21Impl implements CardViewImpl {
   ...
   public void updatePadding(CardViewDelegate var1) {
      if (!var1.getUseCompatPadding()) {
         ...
         float var3 = this.getMaxElevation(var1);
         float var2 = this.getRadius(var1);
         int var4 = (int)Math.ceil((double)RoundRectDrawableWithShadow.calculateHorizontalPadding(var3, var2, var1.getPreventCornerOverlap()));
         int var5 = (int)Math.ceil((double)RoundRectDrawableWithShadow.calculateVerticalPadding(var3, var2, var1.getPreventCornerOverlap()));
