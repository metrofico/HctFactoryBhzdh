   ...
   public void initStatic() {
      RoundRectDrawableWithShadow.sRoundRectHelper = new RoundRectDrawableWithShadow.RoundRectHelper(this) {
         ...
         public void drawRoundRect(Canvas var1, RectF var2, float var3, Paint var4) {
            ...
            float var9 = var2.width() - var6 - 1.0F;
            float var5 = var2.height();
            if (var3 >= 1.0F) {
               float var7 = var3 + 0.5F;
               RectF var11 = this.this$0.mCornerRect;
               float var8 = -var7;
               var11.set(var8, var8, var7, var7);
               int var10 = var1.save();
               var1.translate(var2.left + var7, var2.top + var7);
               var1.drawArc(this.this$0.mCornerRect, 180.0F, 90.0F, true, var4);
               var1.translate(var9, 0.0F);
               var1.rotate(90.0F);
               var1.drawArc(this.this$0.mCornerRect, 180.0F, 90.0F, true, var4);
               ...
               var1.drawRect(var2.left + var7 - 1.0F, var2.top, var2.right - var7 + 1.0F, var2.top + var7, var4);
               var1.drawRect(var2.left + var7 - 1.0F, var2.bottom - var7, var2.right - var7 + 1.0F, var2.bottom, var4);
            }
