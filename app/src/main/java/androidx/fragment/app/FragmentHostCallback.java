...
public abstract class FragmentHostCallback extends FragmentContainer {
   ...
   public void onStartActivityFromFragment(Fragment var1, Intent var2, int var3, Bundle var4) {
      if (var3 == -1) {
         ContextCompat.startActivity(this.mContext, var2, var4);
      } else {
   ...
   @Deprecated
   public void onStartIntentSenderFromFragment(Fragment var1, IntentSender var2, int var3, Intent var4, int var5, int var6, int var7, Bundle var8) throws IntentSender.SendIntentException {
      if (var3 == -1) {
