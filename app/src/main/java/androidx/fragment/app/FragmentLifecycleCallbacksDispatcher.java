...
class FragmentLifecycleCallbacksDispatcher {
   ...
   void dispatchOnFragmentActivityCreated(Fragment var1, Bundle var2, boolean var3) {
      ...
      while(true) {
         FragmentLifecycleCallbacksHolder var5;
         do {
            if (!var6.hasNext()) {
               return;
            }

            var5 = (FragmentLifecycleCallbacksHolder)var6.next();
   ...
   void dispatchOnFragmentAttached(Fragment var1, boolean var2) {
      Context var3 = this.mFragmentManager.getHost().getContext();
      Fragment var4 = this.mFragmentManager.getParent();
      if (var4 != null) {
         var4.getParentFragmentManager().getLifecycleCallbacksDispatcher().dispatchOnFragmentAttached(var1, true);
      }
      ...
      while(true) {
         ...
         var5.mCallback.onFragmentAttached(this.mFragmentManager, var1, var3);
      }
   }
   ...
   void dispatchOnFragmentDestroyed(Fragment var1, boolean var2) {
      ...
      while(true) {
         ...
         do {
            ...
            var5 = (FragmentLifecycleCallbacksHolder)var4.next();
         } while(var2 && !var5.mRecursive);
   ...
   void dispatchOnFragmentDetached(Fragment var1, boolean var2) {
      ...
      while(true) {
         FragmentLifecycleCallbacksHolder var4;
         do {
            if (!var5.hasNext()) {
               return;
            }

            var4 = (FragmentLifecycleCallbacksHolder)var5.next();
   ...
   void dispatchOnFragmentPreAttached(Fragment var1, boolean var2) {
      Context var3 = this.mFragmentManager.getHost().getContext();
      Fragment var4 = this.mFragmentManager.getParent();
      if (var4 != null) {
         var4.getParentFragmentManager().getLifecycleCallbacksDispatcher().dispatchOnFragmentPreAttached(var1, true);
      }

      Iterator var5 = this.mLifecycleCallbacks.iterator();

      while(true) {
         FragmentLifecycleCallbacksHolder var6;
         do {
            if (!var5.hasNext()) {
               return;
            }

            var6 = (FragmentLifecycleCallbacksHolder)var5.next();
         } while(var2 && !var6.mRecursive);

         var6.mCallback.onFragmentPreAttached(this.mFragmentManager, var1, var3);
      }
   }
   ...
   void dispatchOnFragmentStarted(Fragment var1, boolean var2) {
      ...
      while(true) {
         ...
         var5.mCallback.onFragmentStarted(this.mFragmentManager, var1);
      }
   }
   ...
   void dispatchOnFragmentStopped(Fragment var1, boolean var2) {
      ...
      while(true) {
         ...
         var5.mCallback.onFragmentStopped(this.mFragmentManager, var1);
      }
   }
   ...
   void dispatchOnFragmentViewCreated(Fragment var1, View var2, Bundle var3, boolean var4) {
      ...
      while(true) {
         ...
         do {
            ...
            var6 = (FragmentLifecycleCallbacksHolder)var7.next();
   ...
   public void registerFragmentLifecycleCallbacks(FragmentManager.FragmentLifecycleCallbacks var1, boolean var2) {
      this.mLifecycleCallbacks.add(new FragmentLifecycleCallbacksHolder(var1, var2));
   }
   ...
   public void unregisterFragmentLifecycleCallbacks(FragmentManager.FragmentLifecycleCallbacks var1) {
      ...
      label245: {
         ...
         for(; var2 < var3; ++var2) {
            try {
               if (((FragmentLifecycleCallbacksHolder)this.mLifecycleCallbacks.get(var2)).mCallback == var1) {
