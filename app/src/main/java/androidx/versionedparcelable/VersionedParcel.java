...
public abstract class VersionedParcel {
   ...
   private Exception createException(int var1, String var2) {
      switch (var1) {
         ...
         case -8:
         default:
            return new RuntimeException("Unknown exception code: " + var1 + " msg " + var2);
         case -7:
   ...
   private int getType(Object var1) {
      if (var1 instanceof String) {
         ...
         throw new IllegalArgumentException(var1.getClass().getName() + " cannot be VersionedParcelled");
      }
   }
   ...
   private void writeSerializable(Serializable var1) {
      if (var1 == null) {
         ...
         try {
            ...
            throw new RuntimeException("VersionedParcelable encountered IOException writing serializable object (name = " + var2 + ")", var5);
         }
      }
   }
   ...
   private void writeVersionedParcelableCreator(VersionedParcelable var1) {
      ...
      try {
         ...
         throw new RuntimeException(var1.getClass().getSimpleName() + " does not have a Parcelizer", var3);
      }
      ...
      if (!this.readField(var2)) {
         ...
         if (var3 < 0) {
            ...
            if (var3 == 0) {
               ...
               for(var2 = 0; var2 < var3; ++var2) {
                  var5.put(var6.get(var2), var4.get(var2));
               }
   ...
   protected Serializable readSerializable() {
      ...
      if (var1 == null) {
         ...
         try {
            ObjectInputStream var3 = new ObjectInputStream(this, var2) {
            ...
            Serializable var6 = (Serializable)var3.readObject();
            return var6;
         } catch (IOException var4) {
            throw new RuntimeException("VersionedParcelable encountered IOException reading a Serializable object (name = " + var1 + ")", var4);
         } catch (ClassNotFoundException var5) {
            throw new RuntimeException("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = " + var1 + ")", var5);
         }
      }
   }
