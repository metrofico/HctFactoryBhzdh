...
class VersionedParcelStream extends VersionedParcel {
   ...
   private VersionedParcelStream(InputStream var1, OutputStream var2, ArrayMap var3, ArrayMap var4, ArrayMap var5) {
      ...
      if (var1 != null) {
         var6 = new DataInputStream(new FilterInputStream(this, var1) {
            ...
            public int read() throws IOException {
               if (this.this$0.mFieldSize != -1 && this.this$0.mCount >= this.this$0.mFieldSize) {
                  ...
                  int var1 = super.read();
                  VersionedParcelStream var2 = this.this$0;
                  ++var2.mCount;
                  return var1;
               }
            }
            ...
            public int read(byte[] var1, int var2, int var3) throws IOException {
               if (this.this$0.mFieldSize != -1 && this.this$0.mCount >= this.this$0.mFieldSize) {
                  ...
                  if (var2 > 0) {
                     VersionedParcelStream var4 = this.this$0;
                     var4.mCount += var2;
                  }
            ...
            public long skip(long var1) throws IOException {
               if (this.this$0.mFieldSize != -1 && this.this$0.mCount >= this.this$0.mFieldSize) {
                  ...
                  if (var1 > 0L) {
                     VersionedParcelStream var3 = this.this$0;
   ...
   private void writeObject(Object var1) {
      if (var1 == null) {
         ...
         if (!(var1 instanceof float[])) {
            throw new IllegalArgumentException("Unsupported type " + var1.getClass());
         }
   ...
   public void closeField() {
      FieldBuffer var1 = this.mFieldBuffer;
      if (var1 != null) {
         try {
   ...
   public Bundle readBundle() {
      ...
      if (var2 < 0) {
         ...
         for(int var1 = 0; var1 < var2; ++var1) {
            ...
            this.readObject(this.readInt(), var3, var4);
         }
   ...
   public boolean readField(int var1) {
      while(true) {
         ...
         if (var3 < var2) {
            try {
               this.mMasterInput.skip((long)(var2 - var3));
   ...
   public void setOutputField(int var1) {
      this.closeField();
      FieldBuffer var2 = new FieldBuffer(var1, this.mMasterOutput);
   ...
   private static class FieldBuffer {
      ...
      FieldBuffer(int var1, DataOutputStream var2) {
         ...
         this.mOutput = var3;
         this.mDataStream = new DataOutputStream(var3);
         this.mFieldId = var1;
         this.mTarget = var2;
      }
