...
public class BatchingListUpdateCallback implements ListUpdateCallback {
   ...
   public void onChanged(int var1, int var2, Object var3) {
      if (this.mLastEventType == 3) {
         ...
         int var6 = this.mLastEventCount;
         if (var1 <= var4 + var6) {
            int var5 = var1 + var2;
            if (var5 >= var4 && this.mLastEventPayload == var3) {
               this.mLastEventPosition = Math.min(var1, var4);
               this.mLastEventCount = Math.max(var6 + var4, var5) - this.mLastEventPosition;
               return;
            }
         }
      }
   ...
   public void onInserted(int var1, int var2) {
      if (this.mLastEventType == 1) {
         int var4 = this.mLastEventPosition;
         if (var1 >= var4) {
            int var3 = this.mLastEventCount;
            if (var1 <= var4 + var3) {
               this.mLastEventCount = var3 + var2;
               this.mLastEventPosition = Math.min(var1, var4);
               return;
            }
         }
