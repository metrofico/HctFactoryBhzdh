...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
   ...
   public int calculateDxToMakeVisible(View var1, int var2) {
      RecyclerView.LayoutManager var4 = this.getLayoutManager();
      if (var4 != null && var4.canScrollHorizontally()) {
         RecyclerView.LayoutParams var3 = (RecyclerView.LayoutParams)var1.getLayoutParams();
         return this.calculateDtToFit(var4.getDecoratedLeft(var1) - var3.leftMargin, var4.getDecoratedRight(var1) + var3.rightMargin, var4.getPaddingLeft(), var4.getWidth() - var4.getPaddingRight(), var2);
      } else {
         return 0;
      }
   }
   ...
   protected int calculateTimeForDeceleration(int var1) {
      return (int)Math.ceil((double)this.calculateTimeForScrolling(var1) / 0.3356);
   }
   ...
   protected int getHorizontalSnapPreference() {
      PointF var2 = this.mTargetVector;
      byte var1;
      if (var2 != null && var2.x != 0.0F) {
   ...
   protected void onTargetFound(View var1, RecyclerView.State var2, RecyclerView.SmoothScroller.Action var3) {
      int var5 = this.calculateDxToMakeVisible(var1, this.getHorizontalSnapPreference());
      int var6 = this.calculateDyToMakeVisible(var1, this.getVerticalSnapPreference());
      int var4 = this.calculateTimeForDeceleration((int)Math.sqrt((double)(var5 * var5 + var6 * var6)));
      if (var4 > 0) {
         var3.update(-var5, -var6, var4, this.mDecelerateInterpolator);
      }
