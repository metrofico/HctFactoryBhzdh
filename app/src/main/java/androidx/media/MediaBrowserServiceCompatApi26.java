...
class MediaBrowserServiceCompatApi26 {
   ...
   static {
      try {
         Field var0 = MediaBrowserService.Result.class.getDeclaredField("mFlags");
         sResultFlags = var0;
   ...
   static class MediaBrowserServiceAdaptor extends MediaBrowserServiceCompatApi23.MediaBrowserServiceAdaptor {
      ...
      public void onLoadChildren(String var1, MediaBrowserService.Result var2, Bundle var3) {
         MediaSessionCompat.ensureClassLoader(var3);
         ((ServiceCompatProxy)this.mServiceProxy).onLoadChildren(var1, new ResultWrapper(var2), var3);
      }
   }
   ...
   public interface ServiceCompatProxy extends MediaBrowserServiceCompatApi23.ServiceCompatProxy {
      void onLoadChildren(String var1, ResultWrapper var2, Bundle var3);
   }
}
