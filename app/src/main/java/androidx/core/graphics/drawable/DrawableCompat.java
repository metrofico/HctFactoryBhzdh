...
public final class DrawableCompat {
   ...
   public static void applyTheme(Drawable var0, Resources.Theme var1) {
   ...
   public static void clearColorFilter(Drawable var0) {
      if (VERSION.SDK_INT >= 23) {
         ...
         if (var0 instanceof InsetDrawable) {
            ...
            DrawableContainer.DrawableContainerState var4 = (DrawableContainer.DrawableContainerState)((DrawableContainer)var0).getConstantState();
            if (var4 != null) {
               int var1 = 0;
   ...
   public static void inflate(Drawable var0, Resources var1, XmlPullParser var2, AttributeSet var3, Resources.Theme var4) throws XmlPullParserException, IOException {
      if (VERSION.SDK_INT >= 21) {
   ...
   public static void setTintMode(Drawable var0, PorterDuff.Mode var1) {
      if (VERSION.SDK_INT >= 21) {
