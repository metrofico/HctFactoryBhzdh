...
public final class TimeUtils {
   ...
   private static int formatDurationLocked(long var0, int var2) {
      ...
      long var17;
      int var4 = (var17 = var0 - 0L) == 0L ? 0 : (var17 < 0L ? -1 : 1);
      if (var4 == 0) {
         while(var2 - 1 > 0) {
            var13[0] = ' ';
         }
         ...
         if (var2 != 0) {
            ...
            var4 += accumField(var6, 1, var12, 2);
            if (var4 > 0) {
               var12 = true;
            } else {
               var12 = false;
         ...
         var7 = printField(var13, var7, 'd', var9, false, 0);
         if (var7 != var9) {
            var12 = true;
         } else {
            var12 = false;
         ...
         var6 = printField(var13, var6, 'h', var7, var12, var16);
         if (var6 != var9) {
            var12 = true;
         } else {
            var12 = false;
