...
@Metadata(
   ...
   d2 = {"size", "", "Landroid/util/SparseIntArray;", "getSize", "(Landroid/util/SparseIntArray;)I", "contains", "", "key", "containsKey", "containsValue", "value", "forEach", "", "action", "Lkotlin/Function2;", "Lkotlin/ParameterName;", "name", "getOrDefault", "defaultValue", "getOrElse", "Lkotlin/Function0;", "isEmpty", "isNotEmpty", "keyIterator", "Lkotlin/collections/IntIterator;", "plus", "other", "putAll", "remove", "set", "valueIterator", "core-ktx_release"},
   k = 2,
   mv = {1, 1, 15}
)
public final class SparseIntArrayKt {
   public static final boolean contains(SparseIntArray var0, int var1) {
   ...
   public static final boolean containsKey(SparseIntArray var0, int var1) {
   ...
   public static final boolean containsValue(SparseIntArray var0, int var1) {
   ...
   public static final void forEach(SparseIntArray var0, Function2 var1) {
   ...
   public static final int getOrDefault(SparseIntArray var0, int var1, int var2) {
      Intrinsics.checkParameterIsNotNull(var0, "$this$getOrDefault");
      return var0.get(var1, var2);
   }

   public static final int getOrElse(SparseIntArray var0, int var1, Function0 var2) {
      ...
      if (var1 != -1) {
         var1 = var0.valueAt(var1);
      } else {
         var1 = ((Number)var2.invoke()).intValue();
      }

      return var1;
   }

   public static final int getSize(SparseIntArray var0) {
      Intrinsics.checkParameterIsNotNull(var0, "$this$size");
      return var0.size();
   }

   public static final boolean isEmpty(SparseIntArray var0) {
   ...
   public static final boolean isNotEmpty(SparseIntArray var0) {
   ...
   public static final IntIterator keyIterator(SparseIntArray var0) {
      ...
      return (IntIterator)(new IntIterator(var0) {
         ...
         public int nextInt() {
            SparseIntArray var2 = this.$this_keyIterator;
            int var1 = this.index++;
   ...
   public static final SparseIntArray plus(SparseIntArray var0, SparseIntArray var1) {
      Intrinsics.checkParameterIsNotNull(var0, "$this$plus");
      Intrinsics.checkParameterIsNotNull(var1, "other");
      SparseIntArray var2 = new SparseIntArray(var0.size() + var1.size());
      putAll(var2, var0);
      putAll(var2, var1);
      return var2;
   }

   public static final void putAll(SparseIntArray var0, SparseIntArray var1) {
   ...
   public static final boolean remove(SparseIntArray var0, int var1, int var2) {
   ...
   public static final void set(SparseIntArray var0, int var1, int var2) {
      Intrinsics.checkParameterIsNotNull(var0, "$this$set");
      var0.put(var1, var2);
   }

   public static final IntIterator valueIterator(SparseIntArray var0) {
      ...
      return (IntIterator)(new IntIterator(var0) {
         ...
         public int nextInt() {
            SparseIntArray var2 = this.$this_valueIterator;
            int var1 = this.index++;
