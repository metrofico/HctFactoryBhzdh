...
public final class InputContentInfoCompat {
   ...
   public InputContentInfoCompat(Uri var1, ClipDescription var2, Uri var3) {
      if (VERSION.SDK_INT >= 25) {
         this.mImpl = new InputContentInfoCompatApi25Impl(var1, var2, var3);
      } else {
         this.mImpl = new InputContentInfoCompatBaseImpl(var1, var2, var3);
      }

   }

   private InputContentInfoCompat(InputContentInfoCompatImpl var1) {
      this.mImpl = var1;
   }
   ...
   public static InputContentInfoCompat wrap(Object var0) {
      if (var0 == null) {
         ...
         return VERSION.SDK_INT < 25 ? null : new InputContentInfoCompat(new InputContentInfoCompatApi25Impl(var0));
      }
   }
