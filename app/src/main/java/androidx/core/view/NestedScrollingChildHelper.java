...
public class NestedScrollingChildHelper {
   ...
   public boolean dispatchNestedPreScroll(int var1, int var2, int[] var3, int[] var4, int var5) {
      boolean var10 = this.isNestedScrollingEnabled();
      boolean var9 = false;
      boolean var8 = var9;
      if (var10) {
         ViewParent var12 = this.getNestedScrollingParentForType(var5);
         if (var12 == null) {
            return false;
         }
         ...
         if (var1 == 0 && var2 == 0) {
            ...
            int[] var11 = var3;
            if (var3 == null) {
               var11 = this.getTempNestedScrollConsumed();
            }

            var11[0] = 0;
            var11[1] = 0;
            ViewParentCompat.onNestedPreScroll(var12, this.mView, var1, var2, var11, var5);
            if (var4 != null) {
               this.mView.getLocationInWindow(var4);
               var4[0] -= var6;
               var4[1] -= var7;
