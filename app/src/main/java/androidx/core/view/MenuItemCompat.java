...
public final class MenuItemCompat {
   ...
   public static PorterDuff.Mode getIconTintMode(MenuItem var0) {
      if (var0 instanceof SupportMenuItem) {
   ...
   public static void setIconTintMode(MenuItem var0, PorterDuff.Mode var1) {
      if (var0 instanceof SupportMenuItem) {
   ...
   public static MenuItem setOnActionExpandListener(MenuItem var0, OnActionExpandListener var1) {
      return var0.setOnActionExpandListener(new MenuItem.OnActionExpandListener(var1) {
