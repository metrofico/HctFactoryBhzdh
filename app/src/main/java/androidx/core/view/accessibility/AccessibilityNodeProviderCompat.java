...
public class AccessibilityNodeProviderCompat {
   ...
   public void addExtraDataToAccessibilityNodeInfo(int var1, AccessibilityNodeInfoCompat var2, String var3, Bundle var4) {
   }
   ...
   static class AccessibilityNodeProviderApi26 extends AccessibilityNodeProviderApi19 {
      AccessibilityNodeProviderApi26(AccessibilityNodeProviderCompat var1) {
         super(var1);
      }

      public void addExtraDataToAccessibilityNodeInfo(int var1, AccessibilityNodeInfo var2, String var3, Bundle var4) {
         this.mCompat.addExtraDataToAccessibilityNodeInfo(var1, AccessibilityNodeInfoCompat.wrap(var2), var3, var4);
      }
   }
}
