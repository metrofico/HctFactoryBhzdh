...
public class Person {
   ...
   public static Person fromAndroidPerson(android.app.Person var0) {
      Builder var2 = (new Builder()).setName(var0.getName());
      IconCompat var1;
   ...
   public static Person fromBundle(Bundle var0) {
      ...
      Builder var2 = (new Builder()).setName(var0.getCharSequence("name"));
      IconCompat var3;
      if (var1 != null) {
   ...
   public static Person fromPersistableBundle(PersistableBundle var0) {
      return (new Builder()).setName(var0.getString("name")).setUri(var0.getString("uri")).setKey(var0.getString("key")).setBot(var0.getBoolean("isBot")).setImportant(var0.getBoolean("isImportant")).build();
   }
   ...
   public static class Builder {
      ...
      public Builder setBot(boolean var1) {
         this.mIsBot = var1;
         return this;
      }
      ...
      public Builder setImportant(boolean var1) {
         this.mIsImportant = var1;
         return this;
      }

      public Builder setKey(String var1) {
         this.mKey = var1;
         return this;
      }
      ...
      public Builder setUri(String var1) {
         this.mUri = var1;
         return this;
      }
   }
