...
public class TypedArrayUtils {
   ...
   public static ColorStateList getNamedColorStateList(TypedArray var0, XmlPullParser var1, Resources.Theme var2, String var3, int var4) {
      if (hasAttribute(var1, var3)) {
         TypedValue var5 = new TypedValue();
         var0.getValue(var4, var5);
         if (var5.type != 2) {
            return var5.type >= 28 && var5.type <= 31 ? getNamedColorStateListFromInt(var5) : ColorStateListInflaterCompat.inflate(var0.getResources(), var0.getResourceId(var4, 0), var2);
         } else {
            throw new UnsupportedOperationException("Failed to resolve attribute at index " + var4 + ": " + var5);
         }
      } else {
         return null;
      }
   ...
   public static ComplexColorCompat getNamedComplexColor(TypedArray var0, XmlPullParser var1, Resources.Theme var2, String var3, int var4, int var5) {
      if (hasAttribute(var1, var3)) {
   ...
   public static TypedArray obtainAttributes(Resources var0, Resources.Theme var1, AttributeSet var2, int[] var3) {
