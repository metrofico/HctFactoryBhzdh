...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
   ...
   public ListMenuItemView(Context var1, AttributeSet var2, int var3) {
      ...
      Resources.Theme var4 = var1.getTheme();
   ...
   public void adjustListItemSelectionBounds(Rect var1) {
      ...
      if (var2 != null && var2.getVisibility() == 0) {
         LinearLayout.LayoutParams var3 = (LinearLayout.LayoutParams)this.mGroupDivider.getLayoutParams();
   ...
   protected void onFinishInflate() {
      ...
      TextView var2 = (TextView)this.findViewById(R.id.title);
   ...
   protected void onMeasure(int var1, int var2) {
      if (this.mIconView != null && this.mPreserveIconSpacing) {
         ViewGroup.LayoutParams var4 = this.getLayoutParams();
         LinearLayout.LayoutParams var3 = (LinearLayout.LayoutParams)this.mIconView.getLayoutParams();
   ...
   public void setCheckable(boolean var1) {
      if (var1 || this.mRadioButton != null || this.mCheckBox != null) {
         ...
         if (var1) {
            ...
            if (((CompoundButton)var3).getVisibility() != 0) {
               ((CompoundButton)var3).setVisibility(0);
            }

            if (var2 != null && ((CompoundButton)var2).getVisibility() != 8) {
               ((CompoundButton)var2).setVisibility(8);
            }
         } else {
   ...
   public void setIcon(Drawable var1) {
      ...
      if (var2 || this.mPreserveIconSpacing) {
         ...
         if (var3 != null || var1 != null || this.mPreserveIconSpacing) {
            if (var3 == null) {
               this.insertIconView();
            }
