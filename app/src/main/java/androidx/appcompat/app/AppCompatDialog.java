...
public class AppCompatDialog extends Dialog implements AppCompatCallback {
   ...
   public AppCompatDialog(Context var1, int var2) {
      ...
      this.mKeyDispatcher = new KeyEventDispatcher.Component(this) {
         ...
         public boolean superDispatchKeyEvent(KeyEvent var1) {
            return this.this$0.superDispatchKeyEvent(var1);
         }
      };
   ...
   protected AppCompatDialog(Context var1, boolean var2, DialogInterface.OnCancelListener var3) {
