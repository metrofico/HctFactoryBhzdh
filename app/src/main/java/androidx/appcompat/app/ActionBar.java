...
public abstract class ActionBar {
   ...
   public interface TabListener {
      void onTabReselected(Tab var1, FragmentTransaction var2);

      void onTabSelected(Tab var1, FragmentTransaction var2);

      void onTabUnselected(Tab var1, FragmentTransaction var2);
   }
}
