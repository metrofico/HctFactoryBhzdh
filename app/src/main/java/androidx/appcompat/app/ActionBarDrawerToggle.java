...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
   ...
   ActionBarDrawerToggle(Activity var1, Toolbar var2, DrawerLayout var3, DrawerArrowDrawable var4, int var5, int var6) {
      ...
      if (var2 != null) {
         this.mActivityImpl = new ToolbarCompatDelegate(var2);
         var2.setNavigationOnClickListener(new View.OnClickListener(this) {
            ...
            public void onClick(View var1) {
               if (this.this$0.mDrawerIndicatorEnabled) {
                  ...
                  this.this$0.mToolbarNavigationClickListener.onClick(var1);
               }

            }
         });
      } else if (var1 instanceof DelegateProvider) {
         this.mActivityImpl = ((DelegateProvider)var1).getDrawerToggleDelegate();
      } else {
         this.mActivityImpl = new FrameworkActionBarDelegate(var1);
      }
   ...
   public void setToolbarNavigationClickListener(View.OnClickListener var1) {
