...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
   ...
   DropDownListView createDropDownListView(Context var1, boolean var2) {
      MenuDropDownListView var3 = new MenuDropDownListView(var1, var2);
   ...
   public static class MenuDropDownListView extends DropDownListView {
      ...
      public boolean onKeyDown(int var1, KeyEvent var2) {
         ...
         if (var3 != null && var1 == this.mAdvanceKey) {
            ...
            MenuAdapter var5;
            if (var4 instanceof HeaderViewListAdapter) {
               var5 = (MenuAdapter)((HeaderViewListAdapter)var4).getWrappedAdapter();
            } else {
               var5 = (MenuAdapter)var4;
            }

            var5.getAdapterMenu().close(false);
            return true;
         } else {
