...
public class ThemeUtils {
   ...
   public static void checkAppCompatTheme(View var0, Context var1) {
      ...
      try {
         if (!var5.hasValue(R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            Log.e("ThemeUtils", var2.append("View ").append(var0.getClass()).append(" is an AppCompat widget that can only be used with a Theme.AppCompat theme (or descendant).").toString());
         }
      } finally {
         var5.recycle();
      }
   ...
   private static TypedValue getTypedValue() {
      ThreadLocal var2 = TL_TYPED_VALUE;
