...
public abstract class LoaderManager {
   ...
   public abstract Loader initLoader(int var1, Bundle var2, LoaderCallbacks var3);

   public abstract void markForRedelivery();

   public abstract Loader restartLoader(int var1, Bundle var2, LoaderCallbacks var3);
