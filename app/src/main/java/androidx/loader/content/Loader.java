...
public class Loader {
   ...
   public void deliverCancellation() {
      OnLoadCanceledListener var1 = this.mOnLoadCanceledListener;
      if (var1 != null) {
   ...
   public void deliverResult(Object var1) {
      OnLoadCompleteListener var2 = this.mListener;
      if (var2 != null) {
   ...
   public void registerListener(int var1, OnLoadCompleteListener var2) {
   ...
   public void registerOnLoadCanceledListener(OnLoadCanceledListener var1) {
   ...
   public void unregisterListener(OnLoadCompleteListener var1) {
      OnLoadCompleteListener var2 = this.mListener;
      if (var2 != null) {
         if (var2 == var1) {
            this.mListener = null;
   ...
   public void unregisterOnLoadCanceledListener(OnLoadCanceledListener var1) {
      OnLoadCanceledListener var2 = this.mOnLoadCanceledListener;
      if (var2 != null) {
         if (var2 == var1) {
