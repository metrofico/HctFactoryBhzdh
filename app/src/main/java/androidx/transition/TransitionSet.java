...
public class TransitionSet extends Transition {
   ...
   private void setupStartEndListeners() {
      TransitionSetListener var1 = new TransitionSetListener(this);
   ...
   protected void createAnimators(ViewGroup var1, TransitionValuesMaps var2, TransitionValuesMaps var3, ArrayList var4, ArrayList var5) {
      long var10 = this.getStartDelay();
      int var7 = this.mTransitions.size();

      for(int var6 = 0; var6 < var7; ++var6) {
         Transition var12 = (Transition)this.mTransitions.get(var6);
         if (var10 > 0L && (this.mPlayTogether || var6 == 0)) {
            long var8 = var12.getStartDelay();
            if (var8 > 0L) {
               var12.setStartDelay(var8 + var10);
            } else {
               var12.setStartDelay(var10);
            }
         }
      ...
      if (this.mTransitions.isEmpty()) {
         ...
         if (!this.mPlayTogether) {
            for(int var1 = 1; var1 < this.mTransitions.size(); ++var1) {
               ((Transition)this.mTransitions.get(var1 - 1)).addListener(new TransitionListenerAdapter(this, (Transition)this.mTransitions.get(var1)) {
   ...
   String toString(String var1) {
      ...
      for(int var2 = 0; var2 < this.mTransitions.size(); ++var2) {
         var3 = var3 + "\n" + ((Transition)this.mTransitions.get(var2)).toString(var1 + "  ");
      }
