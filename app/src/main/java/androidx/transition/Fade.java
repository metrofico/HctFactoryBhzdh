...
public class Fade extends Visibility {
   ...
   private Animator createAnimation(View var1, float var2, float var3) {
      if (var2 == var3) {
         return null;
      } else {
         ...
         var4.addListener(new FadeAnimatorListener(var1));
         this.addListener(new TransitionListenerAdapter(this, var1) {
            final Fade this$0;
            final View val$view;
