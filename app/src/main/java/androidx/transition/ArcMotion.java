...
public class ArcMotion extends PathMotion {
   ...
   public Path getPath(float var1, float var2, float var3, float var4) {
      ...
      float var9 = var10 - var5;
      var12 = var12 * var12 + var9 * var9;
      var9 = this.mMaximumTangent;
      var8 = var8 * var9 * var9;
      if (!(var12 < var7)) {
         if (var12 > var8) {
            var7 = var8;
      ...
      if (var7 != 0.0F) {
         ...
         var8 = (var6 - var11) * var7 + var11;
         var9 = var10 + var7 * (var5 - var10);
      }

      var14.cubicTo((var1 + var8) / 2.0F, (var2 + var9) / 2.0F, (var8 + var3) / 2.0F, (var9 + var4) / 2.0F, var3, var4);
      return var14;
   }
