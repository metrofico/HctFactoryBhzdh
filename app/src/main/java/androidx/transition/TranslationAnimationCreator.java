...
class TranslationAnimationCreator {
   ...
   static Animator createAnimation(View var0, TransitionValues var1, int var2, int var3, float var4, float var5, float var6, float var7, TimeInterpolator var8) {
      ...
      if (var13 != null) {
         var4 = (float)(var13[0] - var2) + var9;
         var5 = (float)(var13[1] - var3) + var10;
      }

      int var12 = Math.round(var4 - var9);
      int var11 = Math.round(var5 - var10);
      ...
      if (var4 == var6 && var5 == var7) {
         ...
         TransitionPositionListener var14 = new TransitionPositionListener(var0, var1.view, var2 + var12, var3 + var11, var9, var10);
   ...
   private static class TransitionPositionListener extends AnimatorListenerAdapter {
      ...
      TransitionPositionListener(View var1, View var2, int var3, int var4, float var5, float var6) {
         ...
         this.mStartY = var4 - Math.round(var1.getTranslationY());
         this.mTerminalX = var5;
         this.mTerminalY = var6;
         int[] var7 = (int[])var2.getTag(R.id.transition_position);
         this.mTransitionPosition = var7;
         if (var7 != null) {
            var2.setTag(R.id.transition_position, (Object)null);
         }
