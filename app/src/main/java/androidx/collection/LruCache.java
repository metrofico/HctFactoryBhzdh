...
public class LruCache {
   ...
   public final String toString() {
      ...
      label128: {
         ...
         label115:
         try {
            String var16 = String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", this.maxSize, this.hitCount, this.missCount, var1);
            return var16;
      ...
      while(true) {
         ...
         label443: {
            label448: {
               ...
               Object var48;
               try {
                  Map.Entry var3 = (Map.Entry)this.map.entrySet().iterator().next();
                  var2 = var3.getKey();
                  var48 = var3.getValue();
            ...
            try {
               ...
               IllegalStateException var47 = new IllegalStateException(var49.append(this.getClass().getName()).append(".sizeOf() is reporting inconsistent results!").toString());
               throw var47;
