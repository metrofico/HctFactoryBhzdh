   ...
   public abstract static class Stub extends Binder implements INotificationSideChannel {
      ...
      public static INotificationSideChannel asInterface(IBinder var0) {
         if (var0 == null) {
            ...
            return (INotificationSideChannel)(var1 != null && var1 instanceof INotificationSideChannel ? (INotificationSideChannel)var1 : new Proxy(var0));
         }
      }
      ...
      public static boolean setDefaultImpl(INotificationSideChannel var0) {
         if (INotificationSideChannel.Stub.Proxy.sDefaultImpl == null) {
            if (var0 != null) {
