...
public final class MediaDescriptionCompat implements Parcelable {
   ...
   public static MediaDescriptionCompat fromMediaDescription(Object var0) {
      Bundle var3 = null;
      Bundle var2 = null;
      MediaDescriptionCompat var1 = var3;
      if (var0 != null) {
         var1 = var3;
         if (VERSION.SDK_INT >= 21) {
            ...
            var3 = MediaDescriptionCompatApi21.getExtras(var0);
            Uri var5;
            if (var3 != null) {
   ...
   public static final class Builder {
      ...
      public Builder setDescription(CharSequence var1) {
      ...
      public Builder setIconBitmap(Bitmap var1) {
         this.mIcon = var1;
         return this;
      }

      public Builder setIconUri(Uri var1) {
         this.mIconUri = var1;
         return this;
      }

      public Builder setMediaId(String var1) {
         this.mMediaId = var1;
         return this;
      }

      public Builder setMediaUri(Uri var1) {
         this.mMediaUri = var1;
         return this;
      }

      public Builder setSubtitle(CharSequence var1) {
         this.mSubtitle = var1;
         return this;
      }
