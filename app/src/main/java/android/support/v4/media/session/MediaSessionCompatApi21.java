...
class MediaSessionCompatApi21 {
   ...
   public static void setCallback(Object var0, Object var1, Handler var2) {
      ((MediaSession)var0).setCallback((MediaSession.Callback)var1, var2);
   }
   ...
   public static void setPlaybackToLocal(Object var0, int var1) {
      AudioAttributes.Builder var2 = new AudioAttributes.Builder();
   ...
   public static void setQueue(Object var0, List var1) {
      if (var1 == null) {
         ...
         while(var3.hasNext()) {
            var2.add((MediaSession.QueueItem)var3.next());
         }
   ...
   public static Object verifyToken(Object var0) {
      if (var0 instanceof MediaSession.Token) {
         return var0;
      } else {
   ...
   static class QueueItem {
      ...
      public static Object createItem(Object var0, long var1) {
         return new MediaSession.QueueItem((MediaDescription)var0, var1);
      }

      public static Object getDescription(Object var0) {
         return ((MediaSession.QueueItem)var0).getDescription();
      }

      public static long getQueueId(Object var0) {
         return ((MediaSession.QueueItem)var0).getQueueId();
      }
   }
}
