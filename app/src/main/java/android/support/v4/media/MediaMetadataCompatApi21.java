...
class MediaMetadataCompatApi21 {
   ...
   public static class Builder {
      ...
      public static Object build(Object var0) {
         return ((MediaMetadata.Builder)var0).build();
      }
