...
class MediaDescriptionCompatApi21 {
   ...
   static class Builder {
      ...
      public static Object build(Object var0) {
         return ((MediaDescription.Builder)var0).build();
      }
