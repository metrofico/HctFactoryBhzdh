   ...
   public abstract static class Stub extends Binder implements IMediaControllerCallback {
      ...
      public static IMediaControllerCallback asInterface(IBinder var0) {
         if (var0 == null) {
            ...
            return (IMediaControllerCallback)(var1 != null && var1 instanceof IMediaControllerCallback ? (IMediaControllerCallback)var1 : new Proxy(var0));
         }
      }
      ...
      public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
         if (var1 != 1598968902) {
            ...
            switch (var1) {
               ...
               case 3:
                  var2.enforceInterface("android.support.v4.media.session.IMediaControllerCallback");
                  PlaybackStateCompat var17 = (PlaybackStateCompat)var12;
                  if (var2.readInt() != 0) {
               ...
               case 4:
                  var2.enforceInterface("android.support.v4.media.session.IMediaControllerCallback");
                  MediaMetadataCompat var16 = var8;
                  if (var2.readInt() != 0) {
               ...
               case 6:
                  var2.enforceInterface("android.support.v4.media.session.IMediaControllerCallback");
                  CharSequence var15 = (CharSequence)var9;
                  if (var2.readInt() != 0) {
               ...
               case 8:
                  var2.enforceInterface("android.support.v4.media.session.IMediaControllerCallback");
                  ParcelableVolumeInfo var13 = (ParcelableVolumeInfo)var11;
                  if (var2.readInt() != 0) {
      ...
      private static class Proxy implements IMediaControllerCallback {
         ...
         public void onShuffleModeChanged(int var1) throws RemoteException {
            ...
            try {
               var3.writeInterfaceToken("android.support.v4.media.session.IMediaControllerCallback");
               var3.writeInt(var1);
               this.mRemote.transact(12, var3, (Parcel)null, 1);
            } finally {
               var3.recycle();
            }
         ...
         public void onShuffleModeChangedRemoved(boolean var1) throws RemoteException {
            ...
            label77: {
               ...
               label81: {
                  boolean var10001;
                  try {
                     var4.writeInterfaceToken("android.support.v4.media.session.IMediaControllerCallback");
                  } catch (Throwable var10) {
                     var10000 = var10;
                     var10001 = false;
                     break label81;
                  ...
                  try {
                     var4.writeInt(var2);
                     this.mRemote.transact(10, var4, (Parcel)null, 1);
                     break label77;
                  } catch (Throwable var9) {
                     var10000 = var9;
                     var10001 = false;
