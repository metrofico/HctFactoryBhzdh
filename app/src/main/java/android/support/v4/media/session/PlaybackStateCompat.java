...
public final class PlaybackStateCompat implements Parcelable {
   ...
   public static PlaybackStateCompat fromPlaybackState(Object var0) {
      List var3 = null;
      Bundle var2 = null;
      PlaybackStateCompat var1 = var3;
      if (var0 != null) {
         var1 = var3;
         if (VERSION.SDK_INT >= 21) {
            var3 = PlaybackStateCompatApi21.getCustomActions(var0);
            ArrayList var4;
            if (var3 != null) {
               ...
               while(var5.hasNext()) {
                  var4.add(PlaybackStateCompat.CustomAction.fromCustomAction(var5.next()));
               }
            } else {
               var4 = null;
            }
            ...
            var1 = new PlaybackStateCompat(PlaybackStateCompatApi21.getState(var0), PlaybackStateCompatApi21.getPosition(var0), PlaybackStateCompatApi21.getBufferedPosition(var0), PlaybackStateCompatApi21.getPlaybackSpeed(var0), PlaybackStateCompatApi21.getActions(var0), 0, PlaybackStateCompatApi21.getErrorMessage(var0), PlaybackStateCompatApi21.getLastPositionUpdateTime(var0), var4, PlaybackStateCompatApi21.getActiveQueueItemId(var0), var2);
            var1.mStateObj = var0;
         }
      }
      ...
      if (this.mStateObj == null && VERSION.SDK_INT >= 21) {
         ...
         if (this.mCustomActions != null) {
            ...
            while(true) {
               ...
               var2.add(((CustomAction)var3.next()).getCustomAction());
            }
         }
   ...
   public String toString() {
      ...
      var1.append(", error code=").append(this.mErrorCode);
      var1.append(", error message=").append(this.mErrorMessage);
   ...
   public static final class Builder {
      ...
      public Builder(PlaybackStateCompat var1) {
         ...
         if (var1.mCustomActions != null) {
            var2.addAll(var1.mCustomActions);
         }
      ...
      public Builder addCustomAction(CustomAction var1) {
         if (var1 != null) {
      ...
      public Builder addCustomAction(String var1, String var2, int var3) {
         return this.addCustomAction(new CustomAction(var1, var2, var3, (Bundle)null));
      }
      ...
      public Builder setActions(long var1) {
         this.mActions = var1;
         return this;
      }

      public Builder setActiveQueueItemId(long var1) {
         this.mActiveItemId = var1;
         return this;
      }

      public Builder setBufferedPosition(long var1) {
         this.mBufferedPosition = var1;
         return this;
      }

      public Builder setErrorMessage(int var1, CharSequence var2) {
         this.mErrorCode = var1;
         this.mErrorMessage = var2;
         return this;
      }

      public Builder setErrorMessage(CharSequence var1) {
      ...
      public Builder setState(int var1, long var2, float var4) {
         return this.setState(var1, var2, var4, SystemClock.elapsedRealtime());
      }

      public Builder setState(int var1, long var2, float var4, long var5) {
         this.mState = var1;
         this.mPosition = var2;
   ...
   public static final class CustomAction implements Parcelable {
      public static final Parcelable.Creator CREATOR = new Parcelable.Creator() {
         public CustomAction createFromParcel(Parcel var1) {
            return new CustomAction(var1);
         }

         public CustomAction[] newArray(int var1) {
            return new CustomAction[var1];
         }
      };
      ...
      public static CustomAction fromCustomAction(Object var0) {
         if (var0 != null && VERSION.SDK_INT >= 21) {
            CustomAction var1 = new CustomAction(PlaybackStateCompatApi21.CustomAction.getAction(var0), PlaybackStateCompatApi21.CustomAction.getName(var0), PlaybackStateCompatApi21.CustomAction.getIcon(var0), PlaybackStateCompatApi21.CustomAction.getExtras(var0));
