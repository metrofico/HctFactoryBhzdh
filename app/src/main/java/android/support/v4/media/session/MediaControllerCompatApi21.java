...
class MediaControllerCompatApi21 {
   ...
   public static Object fromToken(Context var0, Object var1) {
      return new MediaController(var0, (MediaSession.Token)var1);
   }
   ...
   public static void registerCallback(Object var0, Object var1, Handler var2) {
      ((MediaController)var0).registerCallback((MediaController.Callback)var1, var2);
   }
   ...
   public static void unregisterCallback(Object var0, Object var1) {
      ((MediaController)var0).unregisterCallback((MediaController.Callback)var1);
   }
   ...
   static class CallbackProxy extends MediaController.Callback {
      ...
      public void onAudioInfoChanged(MediaController.PlaybackInfo var1) {
   ...
   public static class PlaybackInfo {
      ...
      public static AudioAttributes getAudioAttributes(Object var0) {
         return ((MediaController.PlaybackInfo)var0).getAudioAttributes();
      }

      public static int getCurrentVolume(Object var0) {
         return ((MediaController.PlaybackInfo)var0).getCurrentVolume();
      }
      ...
      public static int getMaxVolume(Object var0) {
         return ((MediaController.PlaybackInfo)var0).getMaxVolume();
      }

      public static int getPlaybackType(Object var0) {
         return ((MediaController.PlaybackInfo)var0).getPlaybackType();
      }

      public static int getVolumeControl(Object var0) {
         return ((MediaController.PlaybackInfo)var0).getVolumeControl();
      }
   ...
   public static class TransportControls {
      ...
      public static void fastForward(Object var0) {
         ((MediaController.TransportControls)var0).fastForward();
      }

      public static void pause(Object var0) {
         ((MediaController.TransportControls)var0).pause();
      }

      public static void play(Object var0) {
         ((MediaController.TransportControls)var0).play();
      }

      public static void playFromMediaId(Object var0, String var1, Bundle var2) {
         ((MediaController.TransportControls)var0).playFromMediaId(var1, var2);
      }

      public static void playFromSearch(Object var0, String var1, Bundle var2) {
         ((MediaController.TransportControls)var0).playFromSearch(var1, var2);
      }

      public static void rewind(Object var0) {
         ((MediaController.TransportControls)var0).rewind();
      }

      public static void seekTo(Object var0, long var1) {
         ((MediaController.TransportControls)var0).seekTo(var1);
      }

      public static void sendCustomAction(Object var0, String var1, Bundle var2) {
         ((MediaController.TransportControls)var0).sendCustomAction(var1, var2);
      }

      public static void setRating(Object var0, Object var1) {
         ((MediaController.TransportControls)var0).setRating((Rating)var1);
      }

      public static void skipToNext(Object var0) {
         ((MediaController.TransportControls)var0).skipToNext();
      }

      public static void skipToPrevious(Object var0) {
         ((MediaController.TransportControls)var0).skipToPrevious();
      }

      public static void skipToQueueItem(Object var0, long var1) {
         ((MediaController.TransportControls)var0).skipToQueueItem(var1);
      }

      public static void stop(Object var0) {
         ((MediaController.TransportControls)var0).stop();
      }
   }
}
