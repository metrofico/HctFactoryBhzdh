...
class MediaBrowserCompatApi26 {
   ...
   static Object createSubscriptionCallback(SubscriptionCallback var0) {
      return new SubscriptionCallbackProxy(var0);
   }

   public static void subscribe(Object var0, String var1, Bundle var2, Object var3) {
      ((MediaBrowser)var0).subscribe(var1, var2, (MediaBrowser.SubscriptionCallback)var3);
   }

   public static void unsubscribe(Object var0, String var1, Object var2) {
      ((MediaBrowser)var0).unsubscribe(var1, (MediaBrowser.SubscriptionCallback)var2);
   }
   ...
   static class SubscriptionCallbackProxy extends MediaBrowserCompatApi21.SubscriptionCallbackProxy {
      SubscriptionCallbackProxy(SubscriptionCallback var1) {
         super(var1);
      }

      public void onChildrenLoaded(String var1, List var2, Bundle var3) {
         MediaSessionCompat.ensureClassLoader(var3);
         ((SubscriptionCallback)this.mSubscriptionCallback).onChildrenLoaded(var1, var2, var3);
      }

      public void onError(String var1, Bundle var2) {
         MediaSessionCompat.ensureClassLoader(var2);
         ((SubscriptionCallback)this.mSubscriptionCallback).onError(var1, var2);
      }
   }
}
