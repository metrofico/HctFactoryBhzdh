...
public final class RatingCompat implements Parcelable {
         ...
         if (VERSION.SDK_INT >= 19) {
            ...
            if (var4.isRated()) {
               switch (var1) {
                  ...
                  case 4:
                  case 5:
                     var2 = newStarRating(var1, var4.getStarRating());
                     break;
                  case 6:
   ...
   public String toString() {
      StringBuilder var3 = (new StringBuilder()).append("Rating:style=").append(this.mRatingStyle).append(" rating=");
