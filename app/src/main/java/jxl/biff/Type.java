...
public final class Type {
   ...
   private Type(int var1, ArbitraryType var2) {
      this.value = var1;
   }

   public static Type createType(int var0) {
      return new Type(var0, arbitrary);
   }

   public static Type getType(int var0) {
      int var1 = 0;
