...
public class ComboBox implements DrawingGroupObject {
   ...
   public ComboBox(DrawingGroupObject var1, DrawingGroup var2, WorkbookSettings var3) {
   ...
   public ComboBox(MsoDrawingRecord var1, ObjRecord var2, DrawingData var3, DrawingGroup var4, WorkbookSettings var5) {
   ...
   public void writeAdditionalRecords(File var1) throws IOException {
      if (this.origin == Origin.READ) {
         ...
         var1.write(new ObjRecord(this.objectId, ObjRecord.COMBOBOX));
      }
   }
