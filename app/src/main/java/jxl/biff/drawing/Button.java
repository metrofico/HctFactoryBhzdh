...
public class Button implements DrawingGroupObject {
   ...
   public Button(DrawingGroupObject var1, DrawingGroup var2, WorkbookSettings var3) {
   ...
   public Button(MsoDrawingRecord var1, ObjRecord var2, DrawingData var3, DrawingGroup var4, WorkbookSettings var5) {
