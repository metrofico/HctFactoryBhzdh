...
public class Colour {
   ...
   static {
      Colour var0 = new Colour(22, "grey 25%", 192, 192, 192);
      GREY_25_PERCENT = var0;
      Colour var1 = new Colour(23, "grey 50%", 128, 128, 128);
      GREY_50_PERCENT = var1;
      ...
      Colour var2 = new Colour(63, "grey 80%", 51, 51, 51);
      GREY_80_PERCENT = var2;
   ...
   protected Colour(int var1, String var2, int var3, int var4, int var5) {
      this.value = var1;
      this.string = var2;
      this.rgb = new RGB(var3, var4, var5);
      Colour[] var7 = colours;
      Colour[] var6 = new Colour[var7.length + 1];
      colours = var6;
      System.arraycopy(var7, 0, var6, 0, var7.length);
      colours[var7.length] = this;
   }
   ...
   public static Colour getInternalColour(int var0) {
      int var1 = 0;
