...
public final class PaperSize {
   ...
   private PaperSize(int var1) {
      this(var1, true);
   }

   private PaperSize(int var1, boolean var2) {
      this.val = var1;
      PaperSize[] var3 = paperSizes;
      if (var1 >= var3.length && var2) {
         PaperSize[] var4 = new PaperSize[var1 + 1];
   ...
   public static PaperSize getPaperSize(int var0) {
      PaperSize[] var1 = paperSizes;
      PaperSize var3;
