...
public final class UIntArrayKt {
   private static final int[] UIntArray(int var0, Function1 var1) {
      Intrinsics.checkNotNullParameter(var1, "init");
      int[] var3 = new int[var0];

      for(int var2 = 0; var2 < var0; ++var2) {
         var3[var2] = ((UInt)var1.invoke(var2)).unbox_impl();
      }

      return UIntArray.constructor_impl(var3);
   }

   private static final int[] uintArrayOf__ajY_9A(int... var0) {
