...
public abstract class DeepRecursiveScope {
   ...
   // $FF: synthetic method
   public DeepRecursiveScope(DefaultConstructorMarker var1) {
      this();
   }

   public abstract Object callRecursive(Object var1, Continuation var2);

   public abstract Object callRecursive(DeepRecursiveFunction var1, Object var2, Continuation var3);
   ...
   public final Void invoke(DeepRecursiveFunction var1, Object var2) {
