...
public abstract class SequenceScope {
   public abstract Object yield(Object var1, Continuation var2);

   public final Object yieldAll(Iterable var1, Continuation var2) {
   ...
   public abstract Object yieldAll(Iterator var1, Continuation var2);

   public final Object yieldAll(Sequence var1, Continuation var2) {
      Object var3 = this.yieldAll(var1.iterator(), var2);
      return var3 == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? var3 : Unit.INSTANCE;
   }
}
