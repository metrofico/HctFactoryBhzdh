...
public final class ByteStreamsKt {
   ...
   public static final ByteIterator iterator(BufferedInputStream var0) {
      Intrinsics.checkNotNullParameter(var0, "<this>");
      return (ByteIterator)(new ByteIterator(var0) {
         ...
         private final void prepareNext() {
            if (!this.nextPrepared && !this.finished) {
               int var1 = this.$this_iterator.read();
               this.nextByte = var1;
               boolean var2 = true;
   ...
   public static final byte[] readBytes(InputStream var0, int var1) {
      ...
      Intrinsics.checkNotNullExpressionValue(var3, "buffer.toByteArray()");
      return var3;
   }
