...
public abstract class ContinuationImpl extends BaseContinuationImpl {
   ...
   public ContinuationImpl(Continuation var1) {
   ...
   public ContinuationImpl(Continuation var1, CoroutineContext var2) {
      super(var1);
      this._context = var2;
   }
   ...
   public final Continuation intercepted() {
      Continuation var2 = this.intercepted;
      Continuation var1 = var2;
      if (var2 == null) {
         label13: {
            ContinuationInterceptor var3 = (ContinuationInterceptor)this.getContext().get((CoroutineContext.Key)ContinuationInterceptor.Key);
            if (var3 != null) {
               var2 = var3.interceptContinuation((Continuation)this);
               var1 = var2;
               if (var2 != null) {
                  break label13;
               }
