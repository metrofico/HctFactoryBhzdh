...
public final class CoroutineContextImplKt {
   public static final CoroutineContext.Element getPolymorphicElement(CoroutineContext.Element var0, CoroutineContext.Key var1) {
      ...
      if (var2) {
         ...
         if (var4.isSubKey$kotlin_stdlib(var0.getKey())) {
            ...
            if (var0 instanceof CoroutineContext.Element) {
               var5 = var0;
            }
         }
