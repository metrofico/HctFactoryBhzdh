...
final class ReversedList extends AbstractMutableList {
   ...
   public void add(int var1, Object var2) {
      this.delegate.add(CollectionsKt__ReversedViewsKt.access$reversePositionIndex((List)this, var1), var2);
   }
   ...
   public Object get(int var1) {
      return this.delegate.get(CollectionsKt__ReversedViewsKt.access$reverseElementIndex((List)this, var1));
   }
   ...
   public Object removeAt(int var1) {
      return this.delegate.remove(CollectionsKt__ReversedViewsKt.access$reverseElementIndex((List)this, var1));
   }

   public Object set(int var1, Object var2) {
      return this.delegate.set(CollectionsKt__ReversedViewsKt.access$reverseElementIndex((List)this, var1), var2);
   }
}
