...
class SetsKt__SetsKt extends SetsKt__SetsJVMKt {
   ...
   private static final Set buildSet(int var0, Function1 var1) {
   ...
   private static final Set buildSet(Function1 var0) {
   ...
   public static final HashSet hashSetOf(Object... var0) {
   ...
   public static final LinkedHashSet linkedSetOf(Object... var0) {
      Intrinsics.checkNotNullParameter(var0, "elements");
   ...
   public static final Set mutableSetOf(Object... var0) {
      Intrinsics.checkNotNullParameter(var0, "elements");
      return (Set)ArraysKt.toCollection(var0, (Collection)(new LinkedHashSet(MapsKt.mapCapacity(var0.length))));
   }

   public static final Set optimizeReadOnlySet(Set var0) {
   ...
   private static final Set orEmpty(Set var0) {
      Set var1 = var0;
      if (var0 == null) {
   ...
   public static final Set setOfNotNull(Object var0) {
      Set var1;
      if (var0 != null) {
         var1 = SetsKt.setOf(var0);
      } else {
         var1 = SetsKt.emptySet();
      }
   ...
   public static final Set setOfNotNull(Object... var0) {
      Intrinsics.checkNotNullParameter(var0, "elements");
      return (Set)ArraysKt.filterNotNullTo(var0, (Collection)(new LinkedHashSet()));
   }
}
