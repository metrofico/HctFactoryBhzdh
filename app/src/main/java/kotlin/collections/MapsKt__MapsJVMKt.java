...
class MapsKt__MapsJVMKt extends MapsKt__MapWithDefaultKt {
   ...
   public static final Map build(Map var0) {
      Intrinsics.checkNotNullParameter(var0, "builder");
      return ((MapBuilder)var0).build();
   }

   private static final Map buildMapInternal(int var0, Function1 var1) {
   ...
   private static final Map buildMapInternal(Function1 var0) {
   ...
   public static final Map createMapBuilder(int var0) {
      return (Map)(new MapBuilder(var0));
   }

   public static final Object getOrPut(ConcurrentMap var0, Object var1, Function0 var2) {
      ...
      if (var4 == null) {
         var3 = var2.invoke();
         Object var5 = var0.putIfAbsent(var1, var3);
         if (var5 != null) {
            var3 = var5;
         }
      }
   ...
   public static final SortedMap sortedMapOf(Comparator var0, Pair... var1) {
   ...
   public static final SortedMap sortedMapOf(Pair... var0) {
   ...
   private static final Properties toProperties(Map var0) {
      Intrinsics.checkNotNullParameter(var0, "<this>");
   ...
   public static final Map toSingletonMap(Map var0) {
      Intrinsics.checkNotNullParameter(var0, "<this>");
      Map.Entry var1 = (Map.Entry)var0.entrySet().iterator().next();
      var0 = Collections.singletonMap(var1.getKey(), var1.getValue());
      Intrinsics.checkNotNullExpressionValue(var0, "with(entries.iterator().…ingletonMap(key, value) }");
      return var0;
   }

   private static final Map toSingletonMapOrSelf(Map var0) {
      Intrinsics.checkNotNullParameter(var0, "<this>");
      return MapsKt.toSingletonMap(var0);
   }

   public static final SortedMap toSortedMap(Map var0) {
      Intrinsics.checkNotNullParameter(var0, "<this>");
      return (SortedMap)(new TreeMap(var0));
   }

   public static final SortedMap toSortedMap(Map var0, Comparator var1) {
      Intrinsics.checkNotNullParameter(var0, "<this>");
