...
public final class KotlinNothingValueException extends RuntimeException {
   ...
   public KotlinNothingValueException(String var1) {
      super(var1);
   }

   public KotlinNothingValueException(String var1, Throwable var2) {
      super(var1, var2);
   }

   public KotlinNothingValueException(Throwable var1) {
      super(var1);
   }
}
