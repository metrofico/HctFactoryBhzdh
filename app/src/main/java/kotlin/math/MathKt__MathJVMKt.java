...
class MathKt__MathJVMKt extends MathKt__MathHKt {
   ...
   private static final double nextDown(double var0) {
      return Math.nextAfter(var0, Double.NEGATIVE_INFINITY);
   }
