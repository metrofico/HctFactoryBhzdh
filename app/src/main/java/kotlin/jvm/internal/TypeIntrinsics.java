...
public class TypeIntrinsics {
   ...
   public static Map.Entry asMutableMapEntry(Object var0) {
   ...
   public static Map.Entry asMutableMapEntry(Object var0, String var1) {
      if (var0 instanceof KMappedMarker && !(var0 instanceof KMutableMap.Entry)) {
         throwCce(var1);
      }
   ...
   public static Map.Entry castToMapEntry(Object var0) {
      try {
         Map.Entry var2 = (Map.Entry)var0;
         return var2;
      } catch (ClassCastException var1) {
         throw throwCce(var1);
      }
   ...
   public static boolean isMutableMapEntry(Object var0) {
      boolean var1;
      if (!(var0 instanceof Map.Entry) || var0 instanceof KMappedMarker && !(var0 instanceof KMutableMap.Entry)) {
         var1 = false;
      } else {
         var1 = true;
      }
