...
public class AdaptedFunctionReference implements FunctionBase, Serializable {
   ...
   public boolean equals(Object var1) {
      ...
      if (this == var1) {
         ...
         AdaptedFunctionReference var3 = (AdaptedFunctionReference)var1;
         if (this.isTopLevel != var3.isTopLevel || this.arity != var3.arity || this.flags != var3.flags || !Intrinsics.areEqual(this.receiver, var3.receiver) || !Intrinsics.areEqual((Object)this.owner, (Object)var3.owner) || !this.name.equals(var3.name) || !this.signature.equals(var3.signature)) {
            var2 = false;
         }
   ...
   public int hashCode() {
      ...
      Class var7 = this.owner;
      if (var7 != null) {
         var2 = var7.hashCode();
      }

      int var4 = this.name.hashCode();
      int var5 = this.signature.hashCode();
      short var3;
      if (this.isTopLevel) {
         var3 = 1231;
      } else {
      ...
      return (((((var1 * 31 + var2) * 31 + var4) * 31 + var5) * 31 + var3) * 31 + this.arity) * 31 + this.flags;
   }
