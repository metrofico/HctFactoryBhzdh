...
@Metadata(
   ...
   d2 = {"Lkotlin/ranges/UIntProgressionIterator;", "", "Lkotlin/UInt;", "first", "last", "step", "", "(IIILkotlin/jvm/internal/DefaultConstructorMarker;)V", "finalElement", "I", "hasNext", "", "next", "next-pVg5ArA", "()I", "kotlin-stdlib"},
   k = 1,
   mv = {1, 7, 1},
   xi = 48
)
final class UIntProgressionIterator implements Iterator, KMappedMarker {
   ...
   private UIntProgressionIterator(int var1, int var2, int var3) {
      ...
      label20: {
         ...
         var5 = true;
         int var4 = UnsignedKt.uintCompare(var1, var2);
         if (var3 > 0) {
            if (var4 <= 0) {
               break label20;
            }
      ...
      this.hasNext = var5;
      this.step = UInt.constructor_impl(var3);
      if (!this.hasNext) {
         var1 = var2;
      }
   ...
   public int next_pVg5ArA() {
      ...
      if (var1 == this.finalElement) {
         ...
         this.next = UInt.constructor_impl(this.step + var1);
      }
