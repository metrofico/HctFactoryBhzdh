...
public final class DeepRecursiveKt {
   ...
   static {
      ...
      UNDEFINED_RESULT = Result.constructor_impl(IntrinsicsKt.getCOROUTINE_SUSPENDED());
   }
   ...
   public static final Object invoke(DeepRecursiveFunction var0, Object var1) {
      Intrinsics.checkNotNullParameter(var0, "<this>");
      return (new DeepRecursiveScopeImpl(var0.getBlock$kotlin_stdlib(), var1)).runCallLoop();
   }
}
