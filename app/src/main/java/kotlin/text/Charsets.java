...
public final class Charsets {
   ...
   public final Charset UTF32() {
      ...
      Charset var1 = var2;
      if (var2 == null) {
         Charsets var3 = (Charsets)this;
         var1 = Charset.forName("UTF-32");
         Intrinsics.checkNotNullExpressionValue(var1, "forName(\"UTF-32\")");
         utf_32 = var1;
      }
   ...
   public final Charset UTF32_BE() {
      Charset var2 = utf_32be;
      Charset var1 = var2;
      if (var2 == null) {
         Charsets var3 = (Charsets)this;
         var1 = Charset.forName("UTF-32BE");
         Intrinsics.checkNotNullExpressionValue(var1, "forName(\"UTF-32BE\")");
         utf_32be = var1;
      }
   ...
   public final Charset UTF32_LE() {
      Charset var2 = utf_32le;
      Charset var1 = var2;
      if (var2 == null) {
         Charsets var3 = (Charsets)this;
         var1 = Charset.forName("UTF-32LE");
         Intrinsics.checkNotNullExpressionValue(var1, "forName(\"UTF-32LE\")");
         utf_32le = var1;
      }
