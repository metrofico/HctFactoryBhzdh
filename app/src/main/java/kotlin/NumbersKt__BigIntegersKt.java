...
class NumbersKt__BigIntegersKt extends NumbersKt__BigDecimalsKt {
   ...
   private static final BigInteger and(BigInteger var0, BigInteger var1) {
      ...
      var0 = var0.and(var1);
      Intrinsics.checkNotNullExpressionValue(var0, "this.and(other)");
      return var0;
   }
   ...
   private static final BigInteger dec(BigInteger var0) {
      ...
      Intrinsics.checkNotNullExpressionValue(var0, "this.subtract(BigInteger.ONE)");
      return var0;
   }
   ...
   private static final BigInteger div(BigInteger var0, BigInteger var1) {
      ...
      Intrinsics.checkNotNullExpressionValue(var0, "this.divide(other)");
      return var0;
   }
   ...
   private static final BigInteger inc(BigInteger var0) {
      ...
      Intrinsics.checkNotNullExpressionValue(var0, "this.add(BigInteger.ONE)");
      return var0;
   }
   ...
   private static final BigInteger inv(BigInteger var0) {
      Intrinsics.checkNotNullParameter(var0, "<this>");
      var0 = var0.not();
      Intrinsics.checkNotNullExpressionValue(var0, "this.not()");
      return var0;
   }
   ...
   private static final BigInteger or(BigInteger var0, BigInteger var1) {
      ...
      Intrinsics.checkNotNullParameter(var1, "other");
      var0 = var0.or(var1);
      Intrinsics.checkNotNullExpressionValue(var0, "this.or(other)");
      return var0;
   }
   ...
   private static final BigInteger shl(BigInteger var0, int var1) {
      ...
      Intrinsics.checkNotNullExpressionValue(var0, "this.shiftLeft(n)");
      return var0;
   }
   ...
   private static final BigInteger shr(BigInteger var0, int var1) {
      ...
      Intrinsics.checkNotNullExpressionValue(var0, "this.shiftRight(n)");
      return var0;
   }
   ...
   static BigDecimal toBigDecimal$default(BigInteger var0, int var1, MathContext var2, int var3, Object var4) {
      ...
      if ((var3 & 2) != 0) {
         ...
         Intrinsics.checkNotNullExpressionValue(var2, "UNLIMITED");
      }
   ...
   private static final BigInteger xor(BigInteger var0, BigInteger var1) {
      ...
      Intrinsics.checkNotNullParameter(var1, "other");
      var0 = var0.xor(var1);
      Intrinsics.checkNotNullExpressionValue(var0, "this.xor(other)");
      return var0;
   }
}
