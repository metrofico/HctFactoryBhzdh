...
public final class TimeoutCancellationException extends CancellationException implements CopyableThrowable {
   ...
   public TimeoutCancellationException(String var1) {
      this(var1, (Job)null);
   }

   public TimeoutCancellationException(String var1, Job var2) {
      super(var1);
      this.coroutine = var2;
   }
   ...
   public TimeoutCancellationException createCopy() {
      ...
      TimeoutCancellationException var2 = new TimeoutCancellationException(var1, this.coroutine);
      var2.initCause((Throwable)this);
      return var2;
   }
}
