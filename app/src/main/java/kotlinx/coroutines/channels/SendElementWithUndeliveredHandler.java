...
public final class SendElementWithUndeliveredHandler extends SendElement {
   ...
   public SendElementWithUndeliveredHandler(Object var1, CancellableContinuation var2, Function1 var3) {
      super(var1, var2);
   ...
   public void undeliveredElement() {
      OnUndeliveredElementKt.callUndeliveredElement(this.onUndeliveredElement, this.getPollResult(), this.cont.getContext());
   }
}
