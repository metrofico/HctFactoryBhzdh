...
public final class Closed extends Send implements ReceiveOrClosed {
   ...
   public final Throwable getReceiveException() {
      ...
      if (var1 == null) {
         var1 = (Throwable)(new ClosedReceiveChannelException("Channel was closed"));
      }
   ...
   public Symbol tryResumeReceive(Object var1, PrepareOp var2) {
      Symbol var3 = CancellableContinuationImplKt.RESUME_TOKEN;
      if (var2 != null) {
         var2.finishPrepare();
      }
