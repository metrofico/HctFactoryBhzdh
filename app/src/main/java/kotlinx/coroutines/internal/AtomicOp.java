...
public abstract class AtomicOp extends OpDescriptor {
   ...
   public final Object decide(Object var1) {
      ...
      Object var3 = this._consensus;
      if (var3 != AtomicKt.NO_DECISION) {
         return var3;
      } else {
         return AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_consensus$FU, this, AtomicKt.NO_DECISION, var1) ? var1 : this._consensus;
      }
   }
   ...
   public final Object perform(Object var1) {
      ...
      Object var2 = var3;
      if (var3 == AtomicKt.NO_DECISION) {
         var2 = this.decide(this.prepare(var1));
      }
