...
class ChannelFlowBuilder extends ChannelFlow {
   ...
   public ChannelFlowBuilder(Function2 var1, CoroutineContext var2, int var3, BufferOverflow var4) {
      super(var2, var3, var4);
      this.block = var1;
   }

   // $FF: synthetic method
   public ChannelFlowBuilder(Function2 var1, CoroutineContext var2, int var3, BufferOverflow var4, int var5, DefaultConstructorMarker var6) {
      if ((var5 & 2) != 0) {
   ...
   // $FF: synthetic method
   static Object collectTo$suspendImpl(ChannelFlowBuilder var0, ProducerScope var1, Continuation var2) {
      Object var3 = var0.block.invoke(var1, var2);
   ...
   protected ChannelFlow create(CoroutineContext var1, int var2, BufferOverflow var3) {
      return (ChannelFlow)(new ChannelFlowBuilder(this.block, var1, var2, var3));
   }
