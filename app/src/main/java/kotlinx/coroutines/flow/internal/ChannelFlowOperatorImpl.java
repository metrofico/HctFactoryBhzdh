...
public final class ChannelFlowOperatorImpl extends ChannelFlowOperator {
   public ChannelFlowOperatorImpl(Flow var1, CoroutineContext var2, int var3, BufferOverflow var4) {
      super(var1, var2, var3, var4);
   }

   // $FF: synthetic method
   public ChannelFlowOperatorImpl(Flow var1, CoroutineContext var2, int var3, BufferOverflow var4, int var5, DefaultConstructorMarker var6) {
      if ((var5 & 2) != 0) {
   ...
   protected ChannelFlow create(CoroutineContext var1, int var2, BufferOverflow var3) {
      return (ChannelFlow)(new ChannelFlowOperatorImpl(this.flow, var1, var2, var3));
   }
   ...
   protected Object flowCollect(FlowCollector var1, Continuation var2) {
      Object var3 = this.flow.collect(var1, var2);
