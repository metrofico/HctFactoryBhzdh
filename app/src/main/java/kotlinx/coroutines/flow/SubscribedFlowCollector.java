...
public final class SubscribedFlowCollector implements FlowCollector {
   ...
   public SubscribedFlowCollector(FlowCollector var1, Function2 var2) {
      this.collector = var1;
      this.action = var2;
   }

   public Object emit(Object var1, Continuation var2) {
      return this.collector.emit(var1, var2);
   }

   public final Object onSubscription(Continuation param1) {
