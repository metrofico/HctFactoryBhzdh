...
public class canbus21air extends BaseActivity {
   ...
   protected void ProcessData(byte[] var1) {
      if (var1[0] == 33) {
         ...
         if ((var1[3] & 64) != 0 && (var1[3] & 32) != 0) {
            this.updateView(2131165190, 2131099692);
         } else if ((var1[3] & 32) != 0 && (var1[3] & 128) != 0) {
   ...
   public void syncbutton(View var1) {
      ...
      switch (var2) {
         case 2131165187:
            this.SetCmdkey((byte)-84, (byte)2);
            break;
         case 2131165188:
            this.SetCmdkey((byte)-84, (byte)1);
            break;
         case 2131165189:
            this.SetCmdkey((byte)-84, (byte)3);
            break;
         case 2131165190:
            this.SetCmdkey((byte)-84, (byte)4);
            break;
         case 2131165191:
            this.SetCmdkey((byte)-84, (byte)5);
            break;
         case 2131165192:
            this.SetCmdkey((byte)-84, (byte)6);
            break;
         default:
            switch (var2) {
               case 2131165198:
                  ...
                  break;
               case 2131165199:
                  this.SetCmdkey((byte)-83, (byte)2);
                  break;
               case 2131165200:
                  this.SetCmdkey((byte)-83, (byte)3);
                  break;
               case 2131165201:
                  this.SetCmdkey((byte)-83, (byte)4);
                  break;
               case 2131165202:
                  this.SetCmdkey((byte)-83, (byte)5);
                  break;
               case 2131165203:
                  this.SetCmdkey((byte)-83, (byte)6);
                  break;
               case 2131165204:
                  this.SetCmdkey((byte)-83, (byte)7);
            }
      }
