...
public class canbus44settings extends BaseActivity implements View.OnClickListener, View.OnTouchListener {
   private Handler handler = new Handler(this) {
      final canbus44settings this$0;
      ...
      public void handleMessage(Message var1) {
         ...
         if (this.this$0.keycmd != 0) {
            canbus44settings var2;
            if (this.this$0.keycmd != 32 && this.this$0.keycmd != 64 && this.this$0.keycmd != -128) {
               var2 = this.this$0;
               var2.SetCmdkey(var2.keycmd);
               this.this$0.handler.sendEmptyMessageDelayed(1, 200L);
            } else {
               var2 = this.this$0;
               var2.SetCmdkey_Raise(var2.keycmd);
            }
         }
   ...
   private void SetCmdkey(byte var1) {
      ...
      short var2 = (short)(var3[1] + var3[2] + (var3[3] & 255));
      var3[4] = (byte)(var2 >> 8 & 255);
      var3[5] = (byte)(var2 & 255);
      this.WritePort(var3);
   }

   private void SetCmdkey_R(byte var1) {
      byte[] var3 = new byte[]{-3, 5, 38, var1, 0, 0};
      short var2 = (short)(var3[1] + var3[2] + (var3[3] & 255));
      var3[4] = (byte)(var2 >> 8 & 255);
      var3[5] = (byte)(var2 & 255);
      this.WritePort(var3);
   ...
   private void SetCmdkey_Raise(byte var1) {
      byte[] var3 = new byte[]{-3, 5, 38, var1, 0, 0};
      short var2 = (short)(var3[1] + var3[2] + (var3[3] & 255));
      var3[4] = (byte)(var2 >> 8 & 255);
      var3[5] = (byte)(var2 & 255);
   ...
   protected void onCreate(Bundle var1) {
      ...
      if (this.getCarType() == 1) {
         ...
         ((Button)this.findViewById(2131165261)).setText(2131296749);
      }
