...
@Metadata(
   ...
   d2 = {"Lcom/hzbhd/ui/life/BaseFrameLayout;", "Lcom/hzbhd/ui/base/BhdFrameLayout;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "attrs", "Landroid/util/AttributeSet;", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "defStyleAttr", "", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "defStyleRes", "(Landroid/content/Context;Landroid/util/AttributeSet;II)V", "emptyBinding", "Lcom/hzbhd/ui/life/EmptyBinding;", "isAdd", "", "isNeedAdd", "mVisibility", "mWindowVisibility", "myLifeCycleOwner", "Lcom/hzbhd/ui/life/MyLifeCycleOwner;", "getMyLifeCycleOwner", "()Lcom/hzbhd/ui/life/MyLifeCycleOwner;", "setMyLifeCycleOwner", "(Lcom/hzbhd/ui/life/MyLifeCycleOwner;)V", "addBaseChild", "", "addOrRemoveView", "autoInitChild", "autoRemoveChild", "generateDefaultLayoutParams", "Landroid/widget/FrameLayout$LayoutParams;", "getBinding", "initChild", "onAttachedToWindow", "onDetachedFromWindow", "onFinishInflate", "onLifeCycleChange", "state", "Landroidx/lifecycle/Lifecycle$State;", "onViewAdd", "onVisibilityChanged", "changedView", "Landroid/view/View;", "visibility", "onWindowVisibilityChanged", "lifeview_release"},
   k = 1,
   mv = {1, 6, 0},
   xi = 48
)
         ...
         public final void invoke() {
            if (this.this$0.isNeedAdd) {
               ...
               if (var1 != null) {
                  ...
                  if (var2 != null) {
                     BaseFrameLayout var3 = this.this$0;
                     var3.addView(var2);
                     var3.onViewAdd();
                  }
               }
      ...
      BhdViewUtil.INSTANCE.runBack((Function0)(new Function0(this) {
         ...
         public final void invoke() {
            if (!this.this$0.autoRemoveChild() && this.this$0.emptyBinding != null) {
               ...
               EmptyBinding var3 = this.this$0.emptyBinding;
               if (var3 != null) {
                  MyLifeCycleOwner var2 = this.this$0.getMyLifeCycleOwner();
                  Intrinsics.checkNotNull(var2);
                  var3.addObserver((LifecycleOwner)var2);
               }

               var3 = this.this$0.emptyBinding;
               if (var3 != null) {
                  var3.bindAction();
               }
