...
public class BaseLifeFrameLayout extends BhdFrameLayout implements LifecycleOwner {
   ...
   public BaseLifeFrameLayout(Context var1) {
   ...
   public BaseLifeFrameLayout(Context var1, AttributeSet var2) {
      Intrinsics.checkNotNullParameter(var1, "context");
   ...
   public BaseLifeFrameLayout(Context var1, AttributeSet var2, int var3) {
      Intrinsics.checkNotNullParameter(var1, "context");
   ...
   public BaseLifeFrameLayout(Context var1, AttributeSet var2, int var3, int var4) {
      Intrinsics.checkNotNullParameter(var1, "context");
   ...
   public void addOrRemoveView() {
      BhdViewUtil.INSTANCE.runUi((Function0)(new Function0(this) {
         final BaseLifeFrameLayout this$0;
   ...
   public void onLifeCycleChange(Lifecycle.State var1) {
      ...
      if (this.getMLifecycleRegistry().getCurrentState() != var1 && LogUtil.log5()) {
         LogUtil.d("onLifeCycleChange():" + this.getClass().getSimpleName() + " : " + var1);
      }
