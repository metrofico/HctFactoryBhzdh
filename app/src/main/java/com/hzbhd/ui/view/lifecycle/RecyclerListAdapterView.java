...
@Metadata(
   ...
   d2 = {"Lcom/hzbhd/ui/view/lifecycle/RecyclerListAdapterView;", "Lcom/hzbhd/ui/view/lifecycle/BaseLifeRelativeLayout;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "attrs", "Landroid/util/AttributeSet;", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "defStyleAttr", "", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "defStyleRes", "(Landroid/content/Context;Landroid/util/AttributeSet;II)V", "isAdd", "", "itemInfo", "Lcom/hzbhd/ui/view/lifecycle/RecyclerListAdapterView$ItemInfo;", "getItemInfo", "()Lcom/hzbhd/ui/view/lifecycle/RecyclerListAdapterView$ItemInfo;", "recyclerView", "Landroidx/recyclerview/widget/RecyclerView;", "getRecyclerView", "()Landroidx/recyclerview/widget/RecyclerView;", "setRecyclerView", "(Landroidx/recyclerview/widget/RecyclerView;)V", "afterViewInit", "", "beforeViewInit", "clearDataWhenHide", "getAdapter", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "getLayoutManager", "Landroidx/recyclerview/widget/RecyclerView$LayoutManager;", "getScrollStyle", "initAttr", "initData", "onLifeCycleChange", "state", "Landroidx/lifecycle/Lifecycle$State;", "ItemInfo", "commonview-base_release"},
   k = 1,
   mv = {1, 7, 1},
   xi = 48
)
public abstract class RecyclerListAdapterView extends BaseLifeRelativeLayout {
   ...
   private final void initAttr(Context var1, AttributeSet var2) {
      if (var2 != null) {
         ...
         this.itemInfo.setDefItemLayout(var3.getResourceId(R.styleable.recycleViewAttrs_default_item_layout, 0));
         this.itemInfo.setDefItemWidth(var3.getLayoutDimension(R.styleable.recycleViewAttrs_default_item_width, -2));
         this.itemInfo.setDefItemHeight(var3.getLayoutDimension(R.styleable.recycleViewAttrs_default_item_height, -2));
         this.itemInfo.setFirstItemLayout(var3.getResourceId(R.styleable.recycleViewAttrs_first_item_layout, 0));
         this.itemInfo.setLastItemLayout(var3.getResourceId(R.styleable.recycleViewAttrs_last_item_layout, 0));
         this.itemInfo.setScrollbarStyle(var3.getResourceId(R.styleable.recycleViewAttrs_scroll_style, 0));
         this.itemInfo.setDefaultItemLayoutChild(var3.getResourceId(R.styleable.recycleViewAttrs_default_item_layout_child, 0));
         this.itemInfo.setRecyclerViewStyle(var3.getResourceId(R.styleable.recycleViewAttrs_recyclerview_style, 0));
         var3.recycle();
      }
         ...
         if (!this.isAdd) {
            ...
            BaseUtil.INSTANCE.runBack((Function0)(new Function0(this) {
               ...
               public final void invoke() {
                  ...
                  BaseUtil.INSTANCE.runUi((Function0)(new Function0(this.this$0) {
                     final RecyclerListAdapterView this$0;
   ...
   @Metadata(
      d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u001a\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002R\u001a\u0010\u0003\u001a\u00020\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0005\u0010\u0006\"\u0004\b\u0007\u0010\bR\u001a\u0010\t\u001a\u00020\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\n\u0010\u0006\"\u0004\b\u000b\u0010\bR\u001a\u0010\f\u001a\u00020\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\r\u0010\u0006\"\u0004\b\u000e\u0010\bR\u001a\u0010\u000f\u001a\u00020\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0010\u0010\u0006\"\u0004\b\u0011\u0010\bR\u001a\u0010\u0012\u001a\u00020\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0013\u0010\u0006\"\u0004\b\u0014\u0010\bR\u001a\u0010\u0015\u001a\u00020\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0016\u0010\u0006\"\u0004\b\u0017\u0010\bR\u001a\u0010\u0018\u001a\u00020\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0019\u0010\u0006\"\u0004\b\u001a\u0010\bR\u001a\u0010\u001b\u001a\u00020\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u001c\u0010\u0006\"\u0004\b\u001d\u0010\b¨\u0006\u001e"},
      d2 = {"Lcom/hzbhd/ui/view/lifecycle/RecyclerListAdapterView$ItemInfo;", "", "()V", "defItemHeight", "", "getDefItemHeight", "()I", "setDefItemHeight", "(I)V", "defItemLayout", "getDefItemLayout", "setDefItemLayout", "defItemWidth", "getDefItemWidth", "setDefItemWidth", "defaultItemLayoutChild", "getDefaultItemLayoutChild", "setDefaultItemLayoutChild", "firstItemLayout", "getFirstItemLayout", "setFirstItemLayout", "lastItemLayout", "getLastItemLayout", "setLastItemLayout", "recyclerViewStyle", "getRecyclerViewStyle", "setRecyclerViewStyle", "scrollbarStyle", "getScrollbarStyle", "setScrollbarStyle", "commonview-base_release"},
      k = 1,
      mv = {1, 7, 1},
      xi = 48
   )
