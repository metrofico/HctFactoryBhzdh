...
@Metadata(
   ...
   d2 = {"Lcom/hzbhd/ui/view/colorview/PressedDrawable;", "Landroid/graphics/drawable/StateListDrawable;", "context", "Landroid/content/Context;", "nId", "", "pId", "sId", "dId", "(Landroid/content/Context;IIII)V", "n", "Landroid/graphics/drawable/Drawable;", "p", "s", "d", "(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V", "commonview-base_release"},
   k = 1,
   mv = {1, 7, 1},
   xi = 48
)
public final class PressedDrawable extends StateListDrawable {
   public PressedDrawable(Context var1, int var2, int var3, int var4, int var5) {
      ...
      if (var2 != 0) {
         ...
         this.addState(new int[]{-16842919}, var7);
      }
