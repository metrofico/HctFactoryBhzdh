...
public class MsgMgr extends AbstractMsgMgr {
   ...
   private void carSettingInfo0x33() {
      ...
      int var9 = var10[4];
      int var8 = var10[5];
      int var7 = var10[6] * 256 + var10[7];
      int var5 = var10[8];
      int var3 = (short)(var10[9] << 8 & '\uff00' | var10[10] & 255);
      int var6 = var10[11];
      int var4 = var10[12];
      float var1 = (float)((double)var10[13] * 0.1);
      ArrayList var11 = new ArrayList();
      var11.add(new DriverUpdateEntity(0, 0, var2 + "L/100km"));
      var11.add(new DriverUpdateEntity(0, 1, var9 * 256 + var8 + "KM"));
      if (var7 >= 1023) {
         var11.add(new DriverUpdateEntity(0, 2, "--KM"));
      } else {
         var11.add(new DriverUpdateEntity(0, 2, var7 + "KM"));
      }

      var11.add(new DriverUpdateEntity(0, 3, var5 + "%"));
      var11.add(new DriverUpdateEntity(0, 4, var6 * 256 + var4 + "KM"));
      var11.add(new DriverUpdateEntity(0, 5, var1 + "V"));
      var11.add(new DriverUpdateEntity(0, 6, var3 + "°"));
      Context var12;
   ...
   private void tpmsInfo0x25() {
      ...
      var1.add(new TireUpdateEntity(1, 0, new String[]{var5.append(var4[5] + var4[4] * 256).append("KPA").toString()}));
      ...
      var1.add(new TireUpdateEntity(3, 0, new String[]{var5.append(var4[9] + var4[8] * 256).append("KPA").toString()}));
