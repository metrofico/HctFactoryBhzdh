   ...
   public UiMgr(Context var1) {
      ...
      var3.setOnSettingItemSelectListener(new OnSettingItemSelectListener(this, var1) {
         ...
         public void onClickItem(int var1, int var2, int var3) {
            if (var1 == 0) {
               ...
               SharePreUtil.setIntValue(this.val$context, "_36_SAVE_LANGUAGE", var3);
         ...
         public void position(AmplifierActivity.AmplifierPosition var1, int var2) {
            ...
            if (var3 != 1) {
               if (var3 == 2) {
                  ...
                  SharePreUtil.setIntValue(this.val$context, "_36_amplifier_balance", this.this$0.data2);
                  this.this$0.msgMgr.initAmplifierData(this.val$context);
               }
            } else {
               this.this$0.data1 = 10 - var2;
               SharePreUtil.setIntValue(this.val$context, "_36_amplifier_fade", this.this$0.data1);
               this.this$0.msgMgr.initAmplifierData(this.val$context);
            }
            ...
            if (var7 != 1) {
               ...
               if (var7 != 2) {
                  if (var7 == 3) {
                     ...
                     var5 = (byte)this.this$0.data4;
                     var2 += 10;
                     CanbusMsgSender.sendMsg(new byte[]{22, -57, 0, var4, var6, var3, var5, (byte)var2});
                     this.this$0.data5 = var2;
                     SharePreUtil.setIntValue(this.val$context, "_36_amplifier_bass", this.this$0.data5);
                     this.this$0.msgMgr.initAmplifierData(this.val$context);
                  }
               } else {
                  ...
                  var2 += 10;
                  CanbusMsgSender.sendMsg(new byte[]{22, -57, 0, var5, var3, var4, (byte)var2, (byte)this.this$0.data5});
                  this.this$0.data4 = var2;
                  SharePreUtil.setIntValue(this.val$context, "_36_amplifier_middle", this.this$0.data4);
                  this.this$0.msgMgr.initAmplifierData(this.val$context);
               }
            } else {
               ...
               SharePreUtil.setIntValue(this.val$context, "_36_amplifier_treble", this.this$0.data3);
               this.this$0.msgMgr.initAmplifierData(this.val$context);
            }
      ...
      var2.setOnPanoramicItemClickListener(new OnPanoramicItemClickListener(this, var1) {
         ...
         public void onClickItem(int var1) {
            boolean var4 = SharePreUtil.getBoolValue(this.val$context, "_36_is_back_camera", false);
      ...
      var2.setOnBackCameraStatusListener(new OnBackCameraStatusListener(this, var1, var2) {
         ...
         public void addViewToWindows() {
            boolean var2 = SharePreUtil.getBoolValue(this.val$context, "_36_is_back_camera", false);
            boolean var4 = SharePreUtil.getBoolValue(this.val$context, "_36_is_panoramic", false);
