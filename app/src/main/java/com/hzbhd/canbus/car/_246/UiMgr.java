...
public class UiMgr extends AbstractUiMgr {
   ...
   OnSettingItemSelectListener onSettingItemSelectListener = new OnSettingItemSelectListener(this) {
      ...
      public void onClickItem(int var1, int var2, int var3) {
         UiMgr var4 = this.this$0;
         if (var1 == var4.getSettingLeftIndexes(var4.mContext, "_246_paring_info") && var2 == 1) {
   ...
   private void intiData(Context var1) {
      this.initAmplifierInfo(var1);
   ...
   protected void initAmplifierInfo(Context var1) {
      if (var1 != null) {
         GeneralAmplifierData.leftRight = SharePreUtil.getIntValue(var1, this.BALANCE, 0);
         GeneralAmplifierData.frontRear = SharePreUtil.getIntValue(var1, this.FADER, 0);
         GeneralAmplifierData.volume = SharePreUtil.getIntValue(var1, this.VOL, 0);
         GeneralAmplifierData.bandBass = SharePreUtil.getIntValue(var1, this.BASS, 0) + 9;
         GeneralAmplifierData.bandMiddle = SharePreUtil.getIntValue(var1, this.MIDTONE, 0) + 9;
         GeneralAmplifierData.bandTreble = SharePreUtil.getIntValue(var1, this.TREBLE, 0) + 9;
      }
      ...
      var2.startTimer(new TimerTask(this, var2) {
...

         {
            ...
            byte[] var7 = new byte[]{22, -96, 1, (byte)GeneralAmplifierData.leftRight};
            byte[] var6 = new byte[]{22, -96, 2, (byte)GeneralAmplifierData.frontRear};
            byte[] var8 = new byte[]{22, -96, 3, (byte)(GeneralAmplifierData.bandBass - 9)};
            byte[] var4 = new byte[]{22, -96, 4, (byte)(GeneralAmplifierData.bandMiddle - 9)};
            byte[] var5 = new byte[]{22, -96, 5, (byte)(GeneralAmplifierData.bandTreble - 9)};
            this.commands = new byte[][]{{22, -96, 0, var3}, var7, var6, var8, var4, var5};
            this.i = 0;
         }
