   ...
   public void canbusInfoChange(Context var1, byte[] var2) {
      ...
      switch (this.getFrameData()[4]) {
         ...
         case 2:
            ...
            break;
         case 3:
            this.realKeyClick(var1, 188);
            break;
         case 4:
            this.realKeyClick(var1, 3);
            break;
         case 5:
            this.realKeyClick(var1, 45);
            break;
         case 6:
            this.realKeyClick(var1, 46);
            break;
         case 7:
            this.realKeyClick(var1, 2);
      }
