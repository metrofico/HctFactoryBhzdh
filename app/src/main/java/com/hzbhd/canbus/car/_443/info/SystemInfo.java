...
@Metadata(
   ...
   d2 = {"Lcom/hzbhd/canbus/car/_443/info/SystemInfo;", "", "()V", "calendar", "Ljava/util/Calendar;", "mDeviceInfo", "", "mcuInfo", "IntToByte", "", "data", "", "byteToInt", "byte", "getDayOfYear", "getDeviceInfo", "getMcuInfo", "getYear", "get_MMI_SWMainNo", "get_MMI_SWYear", "get_MMI_SubSwNo", "get_MMI_Swweek", "get_MMI_TruckSize", "get_MMI_TruckType", "Companion", "CanBusInfo_release"},
   k = 1,
   mv = {1, 7, 1},
   xi = 48
)
public final class SystemInfo {
   ...
   @Metadata(
      ...
      d2 = {"Lcom/hzbhd/canbus/car/_443/info/SystemInfo$Companion;", "", "()V", "instance", "Lcom/hzbhd/canbus/car/_443/info/SystemInfo;", "getInstance", "()Lcom/hzbhd/canbus/car/_443/info/SystemInfo;", "instance$delegate", "Lkotlin/Lazy;", "CanBusInfo_release"},
      k = 1,
      mv = {1, 7, 1},
      xi = 48
   )
