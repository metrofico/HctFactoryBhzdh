...
public class MsgMgr extends AbstractMsgMgr {
   ...
   private int getAuto(boolean var1, boolean var2) {
      if (var1) {
         return 1;
      } else {
         return var2 ? 2 : 0;
   ...
   private void initAmplifier(Context var1) {
      ...
      var2.startTimer(new TimerTask(this, var2) {
...

         {
            this.this$0 = var1;
            this.val$util = var2;
            byte[] var8 = new byte[]{22, -127, 1, 1};
            byte var4 = (byte)GeneralAmplifierData.frontRear;
            byte var3 = (byte)GeneralAmplifierData.leftRight;
            byte[] var5 = new byte[]{22, -96, 3, (byte)(GeneralAmplifierData.bandBass - 9)};
            byte[] var6 = new byte[]{22, -96, 5, (byte)(GeneralAmplifierData.bandMiddle - 9)};
            byte[] var9 = new byte[]{22, -96, 4, (byte)(GeneralAmplifierData.bandTreble - 9)};
            byte[] var7 = new byte[]{22, -96, 0, (byte)GeneralAmplifierData.volume};
            this.iterator = Arrays.stream(new byte[][]{var8, {22, -96, 2, var4}, {22, -96, 1, var3}, var5, var6, var9, var7}).iterator();
         }
   ...
   private String resolveLeftAndRightManualTemp(int var1) {
      ...
      if (var1 == 0) {
         ...
         var2 = (double)((float)var1 * 0.5F) + 17.5 + "℃";
      } else {
         var2 = "";
      }
   ...
   private void setAirData0x21() {
      ...
      GeneralAirData.auto_1_2 = this.getAuto(DataHandleUtils.getBoolBit3(this.mCanInfoInt[2]), DataHandleUtils.getBoolBit4(this.mCanInfoInt[2]));
   ...
   private void setCarBodyInfo() {
      ...
      if (var1 != 1) {
         if (var1 != 2) {
            ...
            var2.add(new DriverUpdateEntity(1, 2, var3.append((var4[7] * 256 + var4[8]) / 100).append("V").toString()));
            var2.add(new DriverUpdateEntity(1, 3, (this.mCanInfoByte[9] * 256 + this.mCanInfoInt[10]) / 10 + "℃"));
            StringBuilder var6 = new StringBuilder();
            int[] var5 = this.mCanInfoInt;
            var2.add(new DriverUpdateEntity(1, 4, var6.append(var5[11] * 65536 + var5[12] * 256 + var5[13]).append("Km").toString()));
   ...
   private void sndSimpleVol(byte var1, byte var2, boolean var3) throws RemoteException {
      byte var4 = var1;
      if (var1 >= 30) {
         var4 = 30;
      }
   ...
   private void startTask() {
      byte[] var3 = new byte[]{22, -112, 34};
      byte[] var4 = new byte[]{22, -112, 35};
      byte[] var1 = new byte[]{22, -112, 37};
      byte[] var2 = new byte[]{22, -112, 38};
      byte[] var5 = new byte[]{22, -112, 127};
      Timer var6 = this.mTimer;
      if (var6 == null) {
         var6 = new Timer();
         this.mTimer = var6;
         var6.schedule(new TimerTask(this, new byte[][]{var3, var4, var1, var2}, new byte[][]{{22, -112, 35}, var5}) {
            int i;
            final MsgMgr this$0;
   ...
   public void videoInfoChange(byte var1, byte var2, int var3, int var4, byte var5, byte var6, byte var7, String var8, byte var9, byte var10, String var11, String var12, String var13, int var14, byte var15, boolean var16, int var17) {
      ...
      var11 = (new DecimalFormat("00")).format((long)var5) + ":" + (new DecimalFormat("00")).format((long)var6) + ":" + (new DecimalFormat("00")).format((long)var7);
      var8 = var9 * 256 + var3 + "/" + var4;
      this.sendMediaMsg(" ".getBytes(), var11.getBytes(), var8.getBytes(), " ".getBytes());
   }
}
