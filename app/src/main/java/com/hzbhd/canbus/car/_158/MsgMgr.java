...
public class MsgMgr extends AbstractMsgMgr {
   ...
   private int getAirWhat() {
      ...
      var3[4] = var1 & 240;
      var3[5] = var2[11];
      int[] var4 = new int[]{var1 & 4, var2[8], var2[9], var2[10]};
   ...
   private String getData(int[] var1, float var2, String var3) {
      ...
      return var4 == var6 ? "- - -" : this.mDecimalFormat0p0.format((double)((float)var4 * var2)) + var3;
   }
   ...
   private void initSettingsItem(SettingPageUiSet var1) {
      ...
      for(int var2 = 0; var2 < var6.size(); ++var2) {
         ...
         for(int var3 = 0; var3 < var4.size(); ++var3) {
            ...
            String var7 = var5.getTitleSrn();
            this.mSettingItemHashMap.put(var7, new SettingUpdateHelper(new SettingUpdateEntity(var2, var3, "null_value"), var5.getMin()));
         }
      }
   ...
   private boolean isAirDataChange(byte[] var1) {
      CommUtil.printHexStringByTag("_157_MsgMgr", "isAirDataChange income: ", var1);

      for(int var2 = 2; var2 < var1.length; ++var2) {
         byte[] var3 = this.mAirData;
         if (var3[var2] != var1[var2]) {
            System.arraycopy(var1, 2, var3, 2, var1.length - 2);
   ...
   private boolean isPreCameraOrAuxForeground(Context var1) {
      return SystemUtil.isForeground(var1, new String[]{HzbhdComponentName.PreCameraMainActivity.getClassName(), HzbhdComponentName.AuxMainActivity.getClassName()});
   }
   ...
   private void set0x03RadioFreqData() {
      if ("original_status_radio".equals(this.mOriginalStatus) && this.isDataChange(this.mCanBusInfoInt)) {
         ...
         if (this.mIsOriginalRadioBandAm) {
            ...
            var1.add(new OriginalCarDeviceUpdateEntity(2, var2.append(var3[3] << 8 | var3[4]).append(" KHz").toString()));
            GeneralOriginalCarDeviceData.songList = this.getAmList();
         } else {
            var1.add(new OriginalCarDeviceUpdateEntity(0, "FM"));
            var2 = new StringBuilder();
            var3 = this.mCanBusInfoInt;
            var1.add(new OriginalCarDeviceUpdateEntity(2, var2.append((float)(var3[3] << 8 | var3[4]) / 10.0F).append(" MHz").toString()));
      ...
      if ("original_status_radio".equals(this.mOriginalStatus) && this.isDataChange(this.mCanBusInfoInt)) {
         ...
         if (var6) {
            ...
            while(var3 < 6) {
               ...
               DecimalFormat var11 = this.mDecimalFormat00;
               ++var3;
               var10 = var13.append(var11.format((long)var3)).append("#").toString();
            ...
            while(var3 < 12) {
               ...
               var4 = var3 * 2;
               var5 = var8[var4 + 1 + 2];
               float var2 = (float)(var8[var4 + 2 + 2] | var5 << 8) / 10.0F;
               StringBuilder var9 = new StringBuilder();
               DecimalFormat var12 = this.mDecimalFormat00;
               ++var3;
               var10 = var9.append(var12.format((long)var3)).append("#").toString();
      ...
      if ("original_status_radio".equals(this.mOriginalStatus)) {
         if (this.isDataChange(this.mCanBusInfoInt)) {
            ...
            if (var6) {
               ...
               var4 = var11[5];
               var5 = var11[6];
               this.mAmStorageArray[var11[4] + 1] = new SongListEntity("\t" + var8 + "\t" + (var5 | var4 << 8) + " KHz");
               this.mAmStorageList = new ArrayList();
               SongListEntity[] var10 = this.mAmStorageArray;

               for(var4 = var10.length; var3 < var4; ++var3) {
                  SongListEntity var13 = var10[var3];
                  if (var13 != null && !TextUtils.isEmpty(var13.getTitle())) {
                     this.mAmStorageList.add(var13);
                  }
               }
               ...
               SongListEntity[] var12 = this.mFmStorageArray;
               var5 = var12.length;

               for(var3 = var4; var3 < var5; ++var3) {
                  SongListEntity var9 = var12[var3];
                  if (var9 != null && !TextUtils.isEmpty(var9.getTitle())) {
                     this.mFmStorageList.add(var9);
                  }
               }
   ...
   private void set0x21AirData(Context var1) {
      if (GeneralAirData.climate != DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[6])) {
         ...
         } else if (SystemUtil.isForeground(var1, AirActivity.class.getName())) {
            this.finishActivity();
         }
      }

      byte[] var4 = this.mCanBusInfoByte;
      var4[3] = (byte)(var4[3] & 239);
      var4[6] = (byte)(var4[6] & 191);
      var4[7] = 0;
      var4[9] = (byte)(var4[9] & 239);
      if (this.isAirDataChange(var4)) {
         ...
         GeneralAirData.front_left_temperature = this.resolveAirTemperature(var1, this.mAirData[4] & 255);
         GeneralAirData.front_right_temperature = this.resolveAirTemperature(var1, this.mAirData[5] & 255);
         ...
         GeneralAirData.rear_temperature = this.resolveAirTemperature(var1, this.mAirData[8] & 255);
   ...
   private void set0x32VehicleSettingData() {
      this.updateOutDoorTemp(this.mContext, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 0, 4) - 5 + "LEVEL");
      if (this.isDataChange(this.mCanBusInfoInt)) {
         ArrayList var1 = new ArrayList();
   ...
   public void discInfoChange(byte var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8, boolean var9, int var10, String var11, String var12, String var13) {
      ...
      var1 = (byte)var5;
      byte var16 = (byte)var17[1];
      byte var15 = (byte)var17[2];
      this.sendMediaMessage(SourceConstantsDef.SOURCE_ID.MPEG.ordinal(), new byte[]{22, -61, var14, var1, 0, 0, var16, var15});
   }
   ...
   public void radioInfoChange(int var1, String var2, String var3, String var4, int var5) {
      ...
      byte var8 = (byte)var10[0];
      byte var6 = (byte)var1;
      this.sendMediaMessage(SourceConstantsDef.SOURCE_ID.FM.ordinal(), new byte[]{22, -62, var7, var9, var8, var6});
   ...
   public void videoInfoChange(byte var1, byte var2, int var3, int var4, byte var5, byte var6, byte var7, String var8, byte var9, byte var10, String var11, String var12, String var13, int var14, byte var15, boolean var16, int var17) {
      ...
      var5 = (byte)var4;
      var1 = (byte)var3;
      this.sendMediaMessage(SourceConstantsDef.SOURCE_ID.VIDEO.ordinal(), new byte[]{22, -61, var5, var2, var1, 0, var6, var7});
   }
