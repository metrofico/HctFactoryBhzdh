...
public class MsgMgr extends AbstractMsgMgr {
   ...
   private int getAirWhat() {
      ...
      var5[4] = var2 & 129;
      var5[5] = var4[7];
      int[] var3 = new int[]{var4[2] & 1, var2 & 4, var4[8], var4[9], var4[10]};
      ...
      this.mAirRearDataNow = Arrays.copyOf(var3, 5);
      return var1;
   }
   ...
   private boolean getTemUnitState() {
      String var3 = this.nowTemUnit;
      Context var2 = this.mContext;
      boolean var1 = var3.equals(SharePreUtil.getStringValue(var2, this.getUigMgr(var2).KEY_TEM_UNIT, "C"));
      if (!var1) {
         var2 = this.mContext;
         this.nowTemUnit = SharePreUtil.getStringValue(var2, this.getUigMgr(var2).KEY_TEM_UNIT, "C");
      }
   ...
   private void reportID3InfoFinal(int var1, String var2) {
      ...
      try {
         byte[] var5 = DataHandleUtils.exceptBOMHead(var2.getBytes("unicodeLittle"));
         CanbusMsgSender.sendMsg(DataHandleUtils.makeBytesFixedLength(DataHandleUtils.byteMerger(new byte[]{22, -53, var3}, var5), 22));
   ...
   private void requestData() {
      byte[] var1 = new byte[]{22, -112, 50, 0};
      byte[] var2 = new byte[]{22, -112, 37, 0};
      this.getTimerUtil().startTimer(new TimerTask(this, new byte[][]{var1, {22, -112, 51, 0}, var2, {22, -112, -46, 0}}) {
         int i;
         final MsgMgr this$0;
   ...
   private String resolveAirTemperature(int var1) {
      if (var1 == 0) {
         ...
         if (GeneralAirData.fahrenheit_celsius) {
            var2 = this.mContext;
            return SharePreUtil.getStringValue(var2, this.getUigMgr(var2).KEY_TEM_UNIT, "C").equals("F") ? this.df.format((long)var1) + this.getTempUnitF(this.mContext) : this.df.format((double)(var1 - 32) * 0.55) + this.getTempUnitC(this.mContext);
         } else {
            var2 = this.mContext;
            return SharePreUtil.getStringValue(var2, this.getUigMgr(var2).KEY_TEM_UNIT, "C").equals("C") ? this.df.format((double)((float)var1 * 0.5F)) + this.getTempUnitC(this.mContext) : this.df.format((double)((float)var1 * 0.5F) * 1.8 + 32.0) + this.getTempUnitF(this.mContext);
         }
      }
   }
               ...
               if (var4 == null) {
                  ...
                  label62: {
                     ...
                     while(true) {
                        ...
                        try {
                           sleep(100L);
                           MsgMgr var14 = this.this$0;
                           var14.sendMediaMsg(var14.mContext, this.val$mediaType, var5);
                        } catch (Exception var9) {
                           var10000 = var9;
                           var10001 = false;
                           break;
         ...
         if (var1[3] == 0) {
            this.runOnUi(new CallBackInterface(this) {
               ...
               public void callback() {
                  Toast.makeText(this.this$0.getActivity(), "SUCCESS", 0).show();
               }
            });
         } else {
            this.runOnUi(new CallBackInterface(this) {
               ...
               public void callback() {
                  Toast.makeText(this.this$0.getActivity(), "FAIL", 0).show();
               }
            });
         }
      }
   ...
   private void setAirData0x21() {
      ...
      if (!this.getTemUnitState() || !this.isAirMsgRepeat(this.mCanBusInfoByte)) {
   ...
   private void setCameraStatus0xD1() {
      if (this.is0xD1DataChange()) {
         ...
         byte var1 = 2;
         String var6 = HzbhdComponentName.PreCameraMainActivity.getClassName();
         boolean var3 = false;
         boolean var4 = SystemUtil.isForeground(var7, new String[]{var6, HzbhdComponentName.AuxMainActivity.getClassName()});
   ...
   private void setCompassData0xD2() {
      if (this.is0xD2DataChange()) {
         ...
         String var4 = CommUtil.getStrByResId(var3, var1);
         String var5 = Integer.toString(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 0, 4));
         var1 = (float)(this.mCanBusInfoInt[3] * 3) / 2.0F + "°";
         var2.add((new SettingUpdateEntity(9, 1, var4)).setValueStr(true));
         var2.add((new SettingUpdateEntity(9, 2, var5)).setValueStr(true).setProgress(Integer.valueOf(var5) - 1));
         var2.add((new SettingUpdateEntity(9, 3, var1)).setValueStr(true));
   ...
   private void setFuelData0x33() {
      ...
      if (var2 != 1) {
         ...
         var5.add(new DriverUpdateEntity(0, 0, this.getData(new int[]{var2}, var1 * 0.04761905F, var9)));
   ...
   private void setParkAssistData0x25() {
      if (this.is0x25DataChange()) {
         ...
         var1.add((new SettingUpdateEntity(10, 0, this.getOpenClose(DataHandleUtils.getBoolBit3(this.mCanBusInfoInt[2])))).setValueStr(true));
         var1.add((new SettingUpdateEntity(10, 1, this.getOpenClose(DataHandleUtils.getBoolBit2(this.mCanBusInfoInt[2])))).setValueStr(true));
         var1.add((new SettingUpdateEntity(10, 2, this.getOpenClose(DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[2])))).setValueStr(true));
         var1.add((new SettingUpdateEntity(10, 3, this.getOpenClose(DataHandleUtils.getBoolBit0(this.mCanBusInfoInt[2])))).setValueStr(true));
   ...
   private void setVehicleSetupData0x32() {
      if (this.is0x32DataChange()) {
         ...
         var3.add(new SettingUpdateEntity(5, 6, DataHandleUtils.rangeNumber(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[11], 2, 2), 0, 2)));
         var3.add(new SettingUpdateEntity(8, 0, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[11], 1, 1)));
         var3.add(new SettingUpdateEntity(8, 1, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[11], 0, 1)));
         var3.add(new SettingUpdateEntity(6, 0, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[8], 7, 1)));
         Context var4 = this.mContext;
         String var2;
         if (DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[8])) {
            var2 = "_96_range_unit_mile";
         } else {
            var2 = "unit_km";
         }

         String var7 = CommUtil.getStrByResId(var4, var2);
         ...
         var3.add((new SettingUpdateEntity(7, 0, var6.append(var5[9] * 256 + var5[10]).append(" ").append(var7).toString())).setValueStr(true));
         var3.add(new SettingUpdateEntity(5, 0, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[7], 7, 1)));
         var3.add(new SettingUpdateEntity(5, 1, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[7], 6, 1)));
         var3.add(new SettingUpdateEntity(5, 2, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[7], 5, 1)));
         var3.add(new SettingUpdateEntity(5, 3, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[7], 4, 1)));
         var3.add(new SettingUpdateEntity(5, 4, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[7], 2, 2)));
         var3.add(new SettingUpdateEntity(5, 5, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[7], 0, 2)));
         var3.add(new SettingUpdateEntity(4, 0, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[6], 6, 2)));
         var3.add(new SettingUpdateEntity(4, 1, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[6], 5, 1)));
         var3.add(new SettingUpdateEntity(4, 2, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[6], 4, 1)));
         var3.add(new SettingUpdateEntity(4, 3, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[6], 3, 1)));
         var3.add(new SettingUpdateEntity(4, 4, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[6], 2, 1)));
         var3.add(new SettingUpdateEntity(4, 5, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[6], 1, 1)));
         var3.add(new SettingUpdateEntity(4, 6, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[6], 0, 1)));
         var3.add(new SettingUpdateEntity(3, 0, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[5], 6, 1)));
         var3.add(new SettingUpdateEntity(3, 1, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[5], 5, 1)));
         var3.add(new SettingUpdateEntity(3, 2, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[5], 4, 1)));
         var3.add(new SettingUpdateEntity(3, 3, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[5], 3, 1)));
         var3.add(new SettingUpdateEntity(1, 3, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[5], 0, 3)));
         var3.add(new SettingUpdateEntity(2, 0, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 7, 1)));
         var3.add(new SettingUpdateEntity(2, 1, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 6, 1)));
         var3.add(new SettingUpdateEntity(2, 2, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 4, 2)));
         var3.add(new SettingUpdateEntity(2, 3, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 2, 2)));
         var3.add(new SettingUpdateEntity(2, 4, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 0, 2)));
         var3.add(new SettingUpdateEntity(1, 0, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 4, 3)));
         var3.add(new SettingUpdateEntity(1, 1, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 2, 2)));
         var3.add(new SettingUpdateEntity(1, 2, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 0, 2)));
         int var1 = DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 0, 4);
         var3.add(new SettingUpdateEntity(0, 0, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 6, 2)));
         var3.add(new SettingUpdateEntity(0, 1, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 4, 2)));
         var3.add((new SettingUpdateEntity(0, 2, var1 - 5)).setProgress(var1));
   ...
   public void atvInfoChange() {
      super.atvInfoChange();
      this.sendMediaMsg(SourceConstantsDef.SOURCE_ID.ATV.name(), new byte[][]{{22, -64, 3, 34}, {22, -61, 0, 0, 0, 0, 0, 0}});
   }
   ...
   public void btMusicInfoChange() {
      ...
      String var1 = SourceConstantsDef.SOURCE_ID.BTAUDIO.name();
      byte[] var2 = new byte[]{22, -61, 0, 0, 0, 0, 0, 0};
      this.sendMediaMsg(var1, new byte[][]{{22, -64, 11, 64}, var2});
   }
   ...
   public void btPhoneOutGoingInfoChange(byte[] var1, boolean var2, boolean var3) {
      ...
      byte[] var4 = DataHandleUtils.makeBytesFixedLength(DataHandleUtils.byteMerger(new byte[]{22, -53, 1}, var1), 35, 32);
      var1 = new byte[]{22, -61, 0, 0, 0, 0, 0, 0};
      this.sendMediaMsg((String)null, new byte[][]{{22, -64, 5, 64}, var1, var4});
   }
   ...
   public void discInfoChange(byte var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8, boolean var9, int var10, String var11, String var12, String var13) {
      ...
      this.sendMediaMsg(SourceConstantsDef.SOURCE_ID.MPEG.name(), new byte[][]{{22, -64, 2, 16}, {22, -61, 1, var14, 0, 0, var1, var15}});
   ...
   public void initCommand(Context var1) {
      ...
      this.initID3();
      var1 = this.mContext;
      this.nowTemUnit = SharePreUtil.getStringValue(var1, this.getUigMgr(var1).KEY_TEM_UNIT, "C");
   }
   ...
   public void musicInfoChange(byte var1, byte var2, int var3, int var4, byte var5, byte var6, byte var7, byte var8, byte var9, byte var10, String var11, String var12, String var13, long var14, byte var16, int var17, boolean var18, long var19, String var21, String var22, String var23, boolean var24) {
      ...
      var2 = (byte)var4;
      var5 = (byte)var3;
      this.sendMediaMsg(SourceConstantsDef.SOURCE_ID.MUSIC.name(), new byte[][]{{22, -64, var1, 19}, {22, -61, var2, 0, var5, 0, var6, var7}});
   ...
   public void radioInfoChange(int var1, String var2, String var3, String var4, int var5) {
      ...
      byte var7 = (byte)var1;
      this.sendMediaMsg(SourceConstantsDef.SOURCE_ID.FM.name(), new byte[][]{{22, -64, 1, 1}, {22, -62, var9, var8, var6, var7}});
   }
