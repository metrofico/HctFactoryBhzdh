...
public class MsgMgr extends AbstractMsgMgr {
   ...
   private void setSpeedData0x50() {
      ...
      var1.add(new DriverUpdateEntity(0, 0, var3.append(this.resolveSpeedData(var2[2], var2[3])).append(" Km/h").toString()));
      StringBuilder var5 = new StringBuilder();
      int[] var6 = this.mCanBusInfoInt;
      var1.add(new DriverUpdateEntity(0, 1, var5.append(this.resolveSpeedData(var6[4], var6[5])).append(" RPM").toString()));
