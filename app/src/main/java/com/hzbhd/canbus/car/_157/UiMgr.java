...
public class UiMgr extends AbstractUiMgr {
   ...
   public UiMgr(Context var1) {
         ...
         public void onClickItem(int var1, int var2, int var3) {
            ...
            switch (var5) {
               ...
               case 1005119968:
                  ...
                  break;
               case 1091506812:
                  if (var6.equals("_157_Rear_seat_reminder")) {
                     var4 = 26;
                  }
                  break;
               case 1203911228:
               ...
               case 1300899317:
                  ...
                  break;
               case 1331518256:
                  if (var6.equals("_157_Straight_line_driving_assistance_reminder")) {
                     var4 = 38;
                  }
                  break;
               case 1417574351:
      ...
      var7.setOnOriginalSongItemClickListener(new OnOriginalSongItemClickListener(this, var1) {
         ...
         public void onSongItemClick(int var1) {
            if (var1 != 0) {
               int var3 = this.this$0.getMsgMgr(this.val$context).getOriginalRadioPresetSize();
               int var2 = var3 + 1;
               if (var1 != var2) {
                  if (var1 > var2) {
                     CanbusMsgSender.sendMsg(new byte[]{22, -125, 11, (byte)(var1 - var3 - 1 - 1)});
                  } else {
   ...
   static void lambda$new$4(int var0, int var1, MotionEvent var2) {
      ...
      CanbusMsgSender.sendMsg(new byte[]{22, -104, (byte)var7, var5, var6, var4, var3, 0});
   }
   ...
   // $FF: synthetic method
   void lambda$new$0$com_hzbhd_canbus_car__157_UiMgr(SettingPageUiSet var1, Context var2, int var3, int var4, int var5) {
   ...
   // $FF: synthetic method
   void lambda$new$10$com_hzbhd_canbus_car__157_UiMgr(AirPageUiSet var1, int var2) {
      this.sendAirCommand(var1.getFrontArea().getLineBtnAction()[0][var2]);
   }

   // $FF: synthetic method
   void lambda$new$11$com_hzbhd_canbus_car__157_UiMgr(AirPageUiSet var1, int var2) {
      this.sendAirCommand(var1.getFrontArea().getLineBtnAction()[1][var2]);
   }

   // $FF: synthetic method
   void lambda$new$12$com_hzbhd_canbus_car__157_UiMgr(AirPageUiSet var1, int var2) {
      this.sendAirCommand(var1.getFrontArea().getLineBtnAction()[2][var2]);
   }

   // $FF: synthetic method
   void lambda$new$13$com_hzbhd_canbus_car__157_UiMgr(AirPageUiSet var1, int var2) {
      this.sendAirCommand(var1.getFrontArea().getLineBtnAction()[3][var2]);
   }

   // $FF: synthetic method
   void lambda$new$5$com_hzbhd_canbus_car__157_UiMgr(AirPageUiSet var1, int var2) {
      this.sendPortAirCommand(var1.getFrontArea().getLineBtnAction()[0][var2]);
   }

   // $FF: synthetic method
   void lambda$new$6$com_hzbhd_canbus_car__157_UiMgr(AirPageUiSet var1, int var2) {
      this.sendPortAirCommand(var1.getFrontArea().getLineBtnAction()[1][var2]);
   }

   // $FF: synthetic method
   void lambda$new$7$com_hzbhd_canbus_car__157_UiMgr(AirPageUiSet var1, int var2) {
      this.sendPortAirCommand(var1.getFrontArea().getLineBtnAction()[2][var2]);
   }

   // $FF: synthetic method
   void lambda$new$8$com_hzbhd_canbus_car__157_UiMgr(AirPageUiSet var1, int var2) {
      this.sendPortAirCommand(var1.getFrontArea().getLineBtnAction()[3][var2]);
   }

   // $FF: synthetic method
   void lambda$new$9$com_hzbhd_canbus_car__157_UiMgr(AirPageUiSet var1, int var2) {
