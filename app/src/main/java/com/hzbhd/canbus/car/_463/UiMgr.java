...
public class UiMgr extends AbstractUiMgr {
   ...
   Context mContext;
   private OnAirSeatHeatColdMinPlusClickListener mFrontLeftBottomSeatHeatColdListener = new OnAirSeatHeatColdMinPlusClickListener(this) {
      final UiMgr this$0;
   ...
   private OnAirSeatHeatColdMinPlusClickListener mFrontLeftTopSeatHeatColdListener = new OnAirSeatHeatColdMinPlusClickListener(this) {
      final UiMgr this$0;
   ...
   private OnAirSeatHeatColdMinPlusClickListener mFrontRightBottomSeatHeatColdListener = new OnAirSeatHeatColdMinPlusClickListener(this) {
      final UiMgr this$0;
   ...
   private OnAirSeatHeatColdMinPlusClickListener mFrontRightTopSeatHeatColdListener = new OnAirSeatHeatColdMinPlusClickListener(this) {
      final UiMgr this$0;
      ...
      public void onClickItem(int var1) {
         if (var1 != 0) {
            if (var1 != 1) {
               if (var1 != 2) {
                  if (var1 == 3) {
                     this.this$0.sendAirCmd0x33(37);
                  }
               } else {
                  this.this$0.sendAirCmd0x33(15);
               }
            } else {
               this.this$0.sendAirCmd0x33(35);
            }
         } else {
            this.this$0.sendAirCmd0x33(1);
         }
   ...
   private OnAirBtnClickListener mOnAirBtnClickListenerTop = new OnAirBtnClickListener(this) {
      ...
      public void onClickItem(int var1) {
         if (var1 != 0) {
            if (var1 != 1) {
               if (var1 == 2) {
                  this.this$0.sendAirCmd0x33(2);
               }
            } else {
               this.this$0.sendAirCmd0x33(16);
            }
         } else {
            this.this$0.sendAirCmd0x33(8);
         }
   ...
   OnAirTemperatureUpDownClickListener mOnUpDownClickListenerFrontLeft = new OnAirTemperatureUpDownClickListener(this) {
      ...
      public void onClickDown() {
         this.this$0.sendAirCmd0x33(10);
      }

      public void onClickUp() {
         this.this$0.sendAirCmd0x33(9);
      }
   };
   OnAirTemperatureUpDownClickListener mOnUpDownClickListenerFrontRight = new OnAirTemperatureUpDownClickListener(this) {
      ...
      public void onClickDown() {
         this.this$0.sendAirCmd0x33(12);
      }

      public void onClickUp() {
         this.this$0.sendAirCmd0x33(11);
      }
   };
   ...
   OnAirWindSpeedUpDownClickListener onAirWindSpeedUpDownClickListener = new OnAirWindSpeedUpDownClickListener(this) {
      ...
      public void onClickLeft() {
         this.this$0.sendAirCmd0x33(21);
      }

      public void onClickRight() {
         this.this$0.sendAirCmd0x33(20);
      }
   };
   ...
   public UiMgr(Context var1) {
      ...
      var2.getFrontArea().setSeatHeatColdClickListeners(new OnAirSeatHeatColdMinPlusClickListener[]{this.mFrontLeftTopSeatHeatColdListener, this.mFrontRightTopSeatHeatColdListener, this.mFrontLeftBottomSeatHeatColdListener, this.mFrontRightBottomSeatHeatColdListener});
   }
   ...
   private void sendAirCmd0x33(int var1) {
      CanbusMsgSender.sendMsg(new byte[]{22, 51, (byte)var1, (byte)this.actionTag, 37, 0, -86});
