...
public class UiMgr extends AbstractUiMgr {
   ...
   OnPanoramicItemTouchListener mOnPanoramicItemTouchListener = new OnPanoramicItemTouchListener(this) {
      ...
      public void onTouchItem(MotionEvent var1) {
         ...
         if (var1.getAction() == 0) {
            ...
            CanbusMsgSender.sendMsg(new byte[]{22, -116, 2, (byte)var5, (byte)var2, (byte)var4, (byte)var3});
   ...
   OnSettingItemSelectListener mOnSettingItemSelectListener = new OnSettingItemSelectListener(this) {
      ...
      public void onClickItem(int var1, int var2, int var3) {
         ...
         var6 = this.this$0;
         if (var1 == var6.getSettingLeftIndexes(var6.mContext, "_445_language_setting")) {
            var6 = this.this$0;
            if (var2 == var6.getSettingRightIndex(var6.mContext, "_445_language_setting", "_306_voice_language")) {
               if (var3 == 0) {
                  var6 = this.this$0;
            ...
            var6 = this.this$0;
            if (var2 == var6.getSettingRightIndex(var6.mContext, "_445_language_setting", "_445_language_setting1")) {
   ...
   private void intiUi() {
      ...
      if (this.isDX5High()) {
         ...
         this.removeSettingRightItemByNameList(this.mContext, new String[]{"_306_value_3", "_306_value_5", "_306_value_6", "_306_value_7", "_306_title_2", "_306_title_3", "_306_value_8"});
   ...
   static void lambda$new$0(MotionEvent var0) {
      int var2 = (int)var0.getX();
      int var3 = 600 - (int)var0.getY();
      if (var3 >= 0) {
         if (var2 <= 1024) {
            ...
            if (var1 != 0) {
               if (var1 != 1) {
                  if (var1 == 2) {
                     CanbusMsgSender.sendMsg(new byte[]{22, -116, 2, (byte)(var2 >> 8), (byte)var2, (byte)(var3 >> 8), (byte)var3});
                  }
               } else {
                  CanbusMsgSender.sendMsg(new byte[]{22, -116, 0, (byte)(var2 >> 8), (byte)var2, (byte)(var3 >> 8), (byte)var3});
               }
            } else {
               CanbusMsgSender.sendMsg(new byte[]{22, -116, 1, (byte)(var2 >> 8), (byte)var2, (byte)(var3 >> 8), (byte)var3});
            }
