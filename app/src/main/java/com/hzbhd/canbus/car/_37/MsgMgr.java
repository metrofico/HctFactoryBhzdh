...
public class MsgMgr extends AbstractMsgMgr {
   ...
   private void initAmpCommand() {
      ...
      var1.startTimer(new TimerTask(this, var1) {
...

         {
            this.this$0 = var1;
            this.val$util = var2;
            this.iterator = Arrays.stream(new byte[][]{{22, -60, (byte)var1.mVolume}, {22, -57, 0, (byte)(10 - GeneralAmplifierData.frontRear), (byte)(GeneralAmplifierData.leftRight + 10), (byte)(GeneralAmplifierData.bandTreble + 10), (byte)(GeneralAmplifierData.bandMiddle + 10), (byte)(GeneralAmplifierData.bandBass + 10)}}).iterator();
         }
   ...
   private boolean isOnlyDoorMsgShow() {
      if (SharePreUtil.getBoolValue(this.mContext, "_37_isleft_front_door_open", false) != GeneralDoorData.isLeftFrontDoorOpen) {
         return true;
      } else if (SharePreUtil.getBoolValue(this.mContext, "_37_isright_front_door_open", false) != GeneralDoorData.isRightFrontDoorOpen) {
         return true;
      } else if (SharePreUtil.getBoolValue(this.mContext, "_37_isright_rear_door_open", false) != GeneralDoorData.isRightRearDoorOpen) {
         return true;
      } else if (SharePreUtil.getBoolValue(this.mContext, "_37_isleft_rear_door_open", false) != GeneralDoorData.isLeftRearDoorOpen) {
         return true;
      } else {
         return SharePreUtil.getBoolValue(this.mContext, "_37_isback_open", false) != GeneralDoorData.isBackOpen;
      }
   }

   private boolean isOnlyRearUpdate() {
      if (SharePreUtil.getIntValue(this.mContext, "_37_air_rear", 0) != this.isOnlyRearUpdate) {
         return true;
      } else {
         return SharePreUtil.getIntValue(this.mContext, "_37_air_rear_temp", 0) != this.isOnlyRearTempDate;
      }
   }
   ...
   private void setPanoramicSetting() {
      ...
      byte var5 = DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[3]);
      int var3 = DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 0, 2);
      int var4 = DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 3, 2);

      for(int var1 = 0; var1 < 4; ++var1) {
         var6.add(new SettingUpdateEntity(0, var1, (new int[]{var2, var5, var3, var4})[var1]));
      }
   ...
   private void setPanoramicStatus() {
      ...
      SharePreUtil.setBoolValue(var4, "_37_is_back_camera", var2);
      var4 = this.mContext;
      if (var1 == 2) {
         var2 = true;
      } else {
      ...
      SharePreUtil.setBoolValue(var4, "_37_is_panoramic", var2);
      var4 = this.mContext;
      if (var1 != 0) {
         var2 = true;
      } else {
      ...
      if (!SharePreUtil.getBoolValue(this.mContext, "_37_is_back_camera", false) && !CommUtil.isMiscReverse()) {
         if (SharePreUtil.getBoolValue(this.mContext, "_37_is_panoramic", false)) {
   ...
   private void setTypeDataInfo() {
      ...
      label23: {
         ...
         var1 = 4;
         var4 = DataHandleUtils.getIntFromByteWithBit(var9[4], 0, 2);
         ...
         var6 = DataHandleUtils.getBoolBit5(this.mCanBusInfoInt[4]);
         var5 = DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[4]);
      ...
      var8.add(this.getTireEntity(var1, this.getTisWarmMsg(var2), this.getTirePressure(this.mCanBusInfoInt[5], var4), this.getTireTemp(this.mCanBusInfoInt[6], var3), this.getVoltage(this.mCanBusInfoInt[7], var5), this.getSensor(var6)));
   ...
   void initAmplifierData(Context var1) {
      if (var1 != null) {
         GeneralAmplifierData.frontRear = 10 - SharePreUtil.getIntValue(var1, "_37_amplifier_fade", 0);
         GeneralAmplifierData.leftRight = SharePreUtil.getIntValue(var1, "_37_amplifier_balance", 0) - 10;
         GeneralAmplifierData.bandBass = SharePreUtil.getIntValue(var1, "_37_amplifier_bass", 0) - 10;
         GeneralAmplifierData.bandMiddle = SharePreUtil.getIntValue(var1, "_37_amplifier_middle", 0) - 10;
         GeneralAmplifierData.bandTreble = SharePreUtil.getIntValue(var1, "_37_amplifier_treble", 0) - 10;
      }
   ...
   void setLanguage_recNull(Context var1) {
      int var2 = SharePreUtil.getIntValue(var1, "_37_SAVE_LANGUAGE", 0);
      ArrayList var3 = new ArrayList();
