...
public class MsgMgr extends AbstractMsgMgr {
   ...
   private void setSpeedData0x50() {
      ...
      var1.add(new DriverUpdateEntity(0, 1, var6.append(this.resolveSpeedData(var5[4], var5[5])).append(" RPM").toString()));
   ...
   public void canbusInfoChange(Context var1, byte[] var2) {
      ...
      Log.e("CanBusIError", var18.toString());
   }
   ...
   public void hideButton() {
      if (this.systemButton == null) {
         this.systemButton = new SystemButton(this.getActivity(), "P", new SystemButton.PanoramaListener(this) {
            final MsgMgr this$0;
   ...
   void updateSetting(int var1, int var2, int var3) {
      ...
      boolean var4 = true;
      if (var1 == 1 && var2 == 0) {
         SettingUpdateEntity var5 = new SettingUpdateEntity(1, 1, (Object)null);
         if (var3 != 1) {
            var4 = false;
         }
