...
public class VoiceManger {
   ...
   // $FF: synthetic method
   void lambda$initMediaPlayer$0$com_hzbhd_canbus_car__469_VoiceManger(MediaPlayer var1) {
   ...
   // $FF: synthetic method
   void lambda$initMediaPlayer$1$com_hzbhd_canbus_car__469_VoiceManger(MediaPlayer var1) {
      var1 = this.mMediaPlayer;
      if (var1 != null) {
         var1.start();
      }
