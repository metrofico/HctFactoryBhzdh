...
public class MsgMgr extends AbstractMsgMgr {
   ...
   private void initAmpCommand() {
      ...
      var1.startTimer(new TimerTask(this, var1) {
...

         {
            this.this$0 = var1;
            this.val$util = var2;
            byte var7 = (byte)var1.mVolume;
            byte var3 = (byte)(10 - GeneralAmplifierData.frontRear);
            byte var5 = (byte)(GeneralAmplifierData.leftRight + 10);
            byte var4 = (byte)(GeneralAmplifierData.bandTreble + 10);
            byte var8 = (byte)(GeneralAmplifierData.bandMiddle + 10);
            byte var6 = (byte)(GeneralAmplifierData.bandBass + 10);
            this.iterator = Arrays.stream(new byte[][]{{22, -60, var7}, {22, -57, 0, var3, var5, var4, var8, var6}}).iterator();
         }
   ...
   private boolean isOnlyDoorMsgShow() {
      if (SharePreUtil.getBoolValue(this.mContext, "_36_isleft_front_door_open", false) != GeneralDoorData.isLeftFrontDoorOpen) {
         return true;
      } else if (SharePreUtil.getBoolValue(this.mContext, "_36_isright_front_door_open", false) != GeneralDoorData.isRightFrontDoorOpen) {
         return true;
      } else if (SharePreUtil.getBoolValue(this.mContext, "_36_isright_rear_door_open", false) != GeneralDoorData.isRightRearDoorOpen) {
         return true;
      } else if (SharePreUtil.getBoolValue(this.mContext, "_36_isleft_rear_door_open", false) != GeneralDoorData.isLeftRearDoorOpen) {
         return true;
      } else {
         return SharePreUtil.getBoolValue(this.mContext, "_36_isback_open", false) != GeneralDoorData.isBackOpen;
      }
   }

   private boolean isOnlyRearUpdate() {
      if (SharePreUtil.getIntValue(this.mContext, "_36_air_rear", 0) != this.isOnlyRearUpdate) {
         return true;
      } else {
         return SharePreUtil.getIntValue(this.mContext, "_36_air_rear_temp", 0) != this.isOnlyRearTempDate;
      }
   }
                  ...
                  default:
                     switch (var1) {
                        ...
                        case 61:
                           ...
                           break;
                        case 62:
                           this.realKeyLongClick1(this.mContext, 56, var2[3]);
                           break;
                        case 63:
                           this.realKeyLongClick1(this.mContext, 56, var2[3]);
                           break;
   ...
   private void setCarSpeed() {
      ...
      var2.add(new DriverUpdateEntity(0, 3, var3.append((var1[2] + var1[3] * 256) / 16).append("Km/h").toString()));
      this.updateGeneralDriveData(var2);
      this.updateDriveDataActivity((Bundle)null);
      var1 = this.mCanBusInfoInt;
      this.updateSpeedInfo((var1[2] + var1[3] * 256) / 16);
   }
   ...
   private void setPanoramicSetting() {
      ...
      byte var4 = DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[3]);
      int var5 = DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 0, 2);
      int var2 = DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 3, 2);

      for(int var1 = 0; var1 < 4; ++var1) {
         var6.add(new SettingUpdateEntity(0, var1, (new int[]{var3, var4, var5, var2})[var1]));
      }
   ...
   private void setPanoramicStatus() {
      ...
      SharePreUtil.setBoolValue(var4, "_36_is_back_camera", var2);
      var4 = this.mContext;
      if (var1 == 2) {
         var2 = true;
      } else {
      ...
      SharePreUtil.setBoolValue(var4, "_36_is_panoramic", var2);
      var4 = this.mContext;
      if (var1 != 0) {
         var2 = true;
      } else {
      ...
      if (!SharePreUtil.getBoolValue(this.mContext, "_36_is_back_camera", false) && !CommUtil.isMiscReverse()) {
         if (SharePreUtil.getBoolValue(this.mContext, "_36_is_panoramic", false)) {
   ...
   private void setTypeDataInfo() {
      ...
      label23: {
         ...
         var1 = 4;
         var4 = DataHandleUtils.getIntFromByteWithBit(var8[4], 0, 2);
         var6 = DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 2, 2);
         var5 = DataHandleUtils.getBoolBit4(this.mCanBusInfoInt[4]);
         var2 = DataHandleUtils.getBoolBit5(this.mCanBusInfoInt[4]);
      ...
      var9.add(this.getTireEntity(var1, this.getTisWarmMsg(var6), this.getTirePressure(this.mCanBusInfoInt[5], var4), this.getTireTemp(this.mCanBusInfoInt[6], var5), this.getVoltage(this.mCanBusInfoInt[7], var3), this.getSensor(var2)));
   ...
   public void currentVolumeInfoChange(int var1, boolean var2) {
      ...
      this.mVolume = (int)((float)var1 / 40.0F * 35.0F);
   ...
   void initAmplifierData(Context var1) {
      if (var1 != null) {
         GeneralAmplifierData.frontRear = 10 - SharePreUtil.getIntValue(var1, "_36_amplifier_fade", 0);
         GeneralAmplifierData.leftRight = SharePreUtil.getIntValue(var1, "_36_amplifier_balance", 0) - 10;
         GeneralAmplifierData.bandBass = SharePreUtil.getIntValue(var1, "_36_amplifier_bass", 0) - 10;
         GeneralAmplifierData.bandMiddle = SharePreUtil.getIntValue(var1, "_36_amplifier_middle", 0) - 10;
         GeneralAmplifierData.bandTreble = SharePreUtil.getIntValue(var1, "_36_amplifier_treble", 0) - 10;
      }
   ...
   void setLanguage_recNull(Context var1) {
      int var2 = SharePreUtil.getIntValue(var1, "_36_SAVE_LANGUAGE", 0);
      ArrayList var3 = new ArrayList();
