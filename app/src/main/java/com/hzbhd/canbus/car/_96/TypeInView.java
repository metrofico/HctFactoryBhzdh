...
public class TypeInView implements View.OnClickListener {
   ...
   private void AddPassWard() {
      ...
      if (Arrays.equals(this.array1, this.array2)) {
         ...
         CanbusMsgSender.sendMsg(new byte[]{22, 111, 5, (byte)var1, (byte)var2, (byte)var3});
   ...
   private void TypeInFactory() {
      String var4 = this.Factory_code.getText().toString();
      ...
      if (var2 < 5) {
         ...
         while(true) {
            ...
            var2 = var1 + 1;
            var3[var1] = Integer.parseInt(var4.substring(var1, var2));
            var1 = var2;
         }
      }
   }
   ...
   public static void toJudge(int var0) {
      LinearLayout var1 = switch_add_erase;
      if (var1 != null) {
         LinearLayout var2 = error_code;
         if (var2 != null && enter_code != null) {
            if (var0 == 1) {
   ...
   private void verifyPassword() {
      this.TypeInFactory();
      int[] var4 = this.array;
      int var2 = var4[0] << 4 | var4[1];
      int var3 = var4[2] << 4 | var4[3];
      int var1 = var4[4] << 4 | 0;
      if (var2 == 0 && var3 == 0 && var1 == 0) {
         Toast.makeText(this.mContext, "password error！", 0);
      } else {
         CanbusMsgSender.sendMsg(new byte[]{22, 111, 4, (byte)var2, (byte)var3, (byte)var1});
      }
   }
