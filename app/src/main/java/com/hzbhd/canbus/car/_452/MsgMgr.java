...
public class MsgMgr extends AbstractMsgMgr {
   ...
   private void setAir0x25(int[] var1) {
      if (this.isAirDataChange(var1)) {
         ...
         if (!DataHandleUtils.getBoolBit7(var1[8]) && !DataHandleUtils.getBoolBit6(var1[8])) {
            GeneralAirData.auto = DataHandleUtils.getBoolBit2(var1[2]);
         }
         ...
         GeneralAirData.max_front = DataHandleUtils.getBoolBit7(var1[3]);
         GeneralAirData.dual = DataHandleUtils.getBoolBit6(var1[3]);
         GeneralAirData.front_left_blow_window = DataHandleUtils.getBoolBit7(var1[4]);
         GeneralAirData.front_left_blow_head = DataHandleUtils.getBoolBit6(var1[4]);
         GeneralAirData.front_left_blow_foot = DataHandleUtils.getBoolBit5(var1[4]);
         GeneralAirData.front_right_blow_window = DataHandleUtils.getBoolBit7(var1[4]);
         GeneralAirData.front_right_blow_head = DataHandleUtils.getBoolBit6(var1[4]);
         GeneralAirData.front_right_blow_foot = DataHandleUtils.getBoolBit5(var1[4]);
         ...
         if (var2 == 0) {
            ...
            GeneralAirData.front_left_temperature = this.df_1Decimal.format((double)((float)var1[5] / 2.0F)) + this.getTempUnitC(this.mContext);
         }
         ...
         if (var2 == 0) {
            ...
            GeneralAirData.front_right_temperature = this.df_1Decimal.format((double)((float)var1[6] / 2.0F)) + this.getTempUnitC(this.mContext);
         }
