...
public class MsgMgr extends AbstractMsgMgr {
   ...
   private boolean isOnlyDoorMsgShow() {
      if (SharePreUtil.getBoolValue(this.mContext, "_175_isleft_front_door_open", false) != GeneralDoorData.isLeftFrontDoorOpen) {
         return true;
      } else if (SharePreUtil.getBoolValue(this.mContext, "_175_isright_front_door_open", false) != GeneralDoorData.isRightFrontDoorOpen) {
         return true;
      } else if (SharePreUtil.getBoolValue(this.mContext, "_175_isright_rear_door_open", false) != GeneralDoorData.isRightRearDoorOpen) {
         return true;
      } else if (SharePreUtil.getBoolValue(this.mContext, "_175_isleft_rear_door_open", false) != GeneralDoorData.isLeftRearDoorOpen) {
         return true;
      } else {
         return SharePreUtil.getBoolValue(this.mContext, "_175_isback_open", false) != GeneralDoorData.isBackOpen;
      }
   }

   private boolean isOnlyRearUpdate() {
      if (SharePreUtil.getIntValue(this.mContext, "_175_air_rear", 0) != this.isOnlyRearUpdate) {
         return true;
      } else {
         return SharePreUtil.getIntValue(this.mContext, "_175_air_rear_temp", 0) != this.isOnlyRearTempDate;
      }
   }
   ...
   private void setCarSpeed() {
      ...
      int[] var2 = this.mCanBusInfoInt;
      var3.add(new DriverUpdateEntity(0, 3, var1.append((var2[2] + var2[3] * 256) / 16).append("Km/h").toString()));
      this.updateGeneralDriveData(var3);
      this.updateDriveDataActivity((Bundle)null);
   ...
   private void setPanoramicStatus() {
      ...
      SharePreUtil.setBoolValue(var4, "_175_is_back_camera", var2);
      var4 = this.mContext;
      if (var1 == 2) {
         var2 = true;
      } else {
      ...
      SharePreUtil.setBoolValue(var4, "_175_is_panoramic", var2);
      var4 = this.mContext;
      if (var1 != 0) {
         var2 = true;
      } else {
      ...
      if (!SharePreUtil.getBoolValue(this.mContext, "_175_is_back_camera", false) && !CommUtil.isMiscReverse()) {
         if (SharePreUtil.getBoolValue(this.mContext, "_175_is_panoramic", false)) {
   ...
   private void setTypeDataInfo() {
      ...
      var9.add(this.getTireEntity(var1, this.getTisWarmMsg(var6), this.getTirePressure(this.mCanBusInfoInt[5], var2), this.getTireTemp(this.mCanBusInfoInt[6], var5), this.getVoltage(this.mCanBusInfoInt[7], var3), this.getSensor(var4)));
   ...
   void initAmplifierData(Context var1) {
      GeneralAmplifierData.frontRear = 10 - SharePreUtil.getIntValue(var1, "_175_amplifier_fade", 0);
      GeneralAmplifierData.leftRight = SharePreUtil.getIntValue(var1, "_175_amplifier_balance", 0) - 10;
      GeneralAmplifierData.bandBass = SharePreUtil.getIntValue(var1, "_175_amplifier_bass", 0) - 10;
      GeneralAmplifierData.bandMiddle = SharePreUtil.getIntValue(var1, "_175_amplifier_middle", 0) - 10;
      GeneralAmplifierData.bandTreble = SharePreUtil.getIntValue(var1, "_175_amplifier_treble", 0) - 10;
   ...
   void setLanguage_recNull(Context var1) {
      int var2 = SharePreUtil.getIntValue(var1, "_175_SAVE_LANGUAGE", 0);
      ArrayList var3 = new ArrayList();
