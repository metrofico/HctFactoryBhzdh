...
public class UiMgr extends AbstractUiMgr {
   ...
   public UiMgr(Context var1) {
      ...
      this.getMsgMgr(var1).updateSetting(0, 0, SharePreUtil.getIntValue(var1, "share_25_language", 0));
      this.getMsgMgr(var1).updateSetting(1, 0, SharePreUtil.getBoolValue(var1, "share_25_is_support_panoramic", false));
         ...
         public void onClickItem(int var1, int var2, int var3) {
            ...
            if (var1 == 0) {
               if (var2 == 0) {
                  ...
                  SharePreUtil.setIntValue(this.this$0.mContext, "share_25_language", var3);
               ...
               SharePreUtil.setBoolValue(var5, "share_25_is_support_panoramic", var4);
               this.this$0.getMsgMgr(this.val$context).updateSetting(var1, var2, var3);
            }
      ...
      var4.setOnBackCameraStatusListener(new OnBackCameraStatusListener(this, var1, var4) {
         ...
         public void addViewToWindows() {
            boolean var1 = SharePreUtil.getBoolValue(this.val$context, "share_25_is_support_panoramic", false);
