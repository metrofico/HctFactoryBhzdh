...
public class UiMgr extends AbstractUiMgr {
   ...
   OnAirBtnClickListener mOnAirBtnClickListenerFrontBottom = new OnAirBtnClickListener(this) {
      ...
      public void onClickItem(int var1) {
         if (var1 != 0) {
            ...
            this.this$0.sendAirData0xE1(18);
         }
   ...
   OnDriveDataPageStatusListener onDriveDataPageStatusListener = new OnDriveDataPageStatusListener(this) {
      ...
      public void onStatusChange(int var1) {
         this.this$0.activeRequest(134);
         this.this$0.activeRequest(26);
         this.this$0.activeRequest(129);
      }
   };
   ...
   private void sendAirData0xE1(int var1) {
      CanbusMsgSender.sendMsg(new byte[]{22, -31, (byte)var1, 0});
   }
   ...
   public void sendMediaInfo0xF3(int var1) {
