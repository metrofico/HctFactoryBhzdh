...
public class SetTimeView {
   ...
   private void ButtClickEvent(View var1, TimeResultListener var2, AlertDialog var3) {
      ...
      this.imageButtonAdd1.setOnClickListener(new View.OnClickListener(this) {
         ...
         public void onClick(View var1) {
            ...
            this.this$0.year.setText(this.this$0.timeYear + "年");
         }
      });
      ...
      this.imageButtonAdd2.setOnClickListener(new View.OnClickListener(this) {
         ...
         public void onClick(View var1) {
            ...
            this.this$0.day.setText(this.this$0.timeDay + "日");
            this.this$0.month.setText(this.this$0.timeMonth + "月");
         }
      });
      ...
      this.imageButtonAdd4.setOnClickListener(new View.OnClickListener(this) {
         ...
         public void onClick(View var1) {
            ...
            this.this$0.hour.setText(this.this$0.df_2Integer.format((long)this.this$0.timeHour) + "");
         }
      });
      ...
      this.imageButtonAdd5.setOnClickListener(new View.OnClickListener(this) {
         ...
         public void onClick(View var1) {
            if (this.this$0.timeMinute != 45) {
               SetTimeView var2 = this.this$0;
               var2.timeMinute = var2.timeMinute + 15;
            } else {
               this.this$0.timeMinute = 0;
            }

            this.this$0.minute.setText(this.this$0.df_2Integer.format((long)this.this$0.timeMinute) + "");
         }
      });
   ...
   private void InitTextViewData(View var1, String var2) {
      ...
      Date var4 = new Date();
      String var5 = (new SimpleDateFormat("yyyyMMddHHmmss")).format(var4);
      this.timeYear = Integer.parseInt(var5.substring(0, 4));
      this.year.setText(this.timeYear + "年");
      this.timeMonth = Integer.parseInt(var5.substring(4, 6));
      this.month.setText(this.timeMonth + "月");
      this.timeDay = Integer.parseInt(var5.substring(6, 8));
      this.day.setText(this.timeDay + "日");
      this.timeHour = Integer.parseInt(var5.substring(8, 10));
      this.hour.setText(this.timeHour + "");
      int var3 = Integer.parseInt(var5.substring(10, 12));
      this.timeMinute = var3;
      if (var3 > 0 && var3 <= 15) {
         this.timeMinute = 15;
      } else if (var3 > 15 && var3 <= 30) {
         this.timeMinute = 30;
      } else if (var3 > 30 && var3 <= 45) {
         this.timeMinute = 45;
      } else if (var3 > 45 && var3 <= 60) {
         this.timeMinute = 0;
      } else if (var3 > 60) {
         this.timeMinute = 0;
      }
