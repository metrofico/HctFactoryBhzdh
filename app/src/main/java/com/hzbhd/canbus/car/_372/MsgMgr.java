...
public class MsgMgr extends AbstractMsgMgr {
   ...
   private String get0x3CState(boolean var1) {
      if (!DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[2])) {
         return this.mContext.getString(2131764474);
      } else {
         return var1 ? this.mContext.getString(2131764473) : this.mContext.getString(2131764472);
      }
   }
   ...
   private int getCarSettingRightIndex(String var1) {
      return this.getUiMgr(this.mContext).getSettingRightIndex(this.mContext, "_333_setting_carState", var1);
   }
   ...
   private String getTemperature(int var1, String var2, int var3, int var4) {
      if (var1 == var3) {
         return "LO";
      } else if (var1 == var4) {
         return "HI";
      } else {
         return var2.trim().equals("C") ? this.df_2Decimal.format((double)var1 * 0.5) + this.getTempUnitC(this.mContext) : var1 + this.getTempUnitF(this.mContext);
      }
   }
   ...
   private void haveDistanceInfo() {
      ...
      if (var1 != 0) {
         if (var1 != 1) {
            ...
            var2.add(new DriverUpdateEntity(this.getUiMgr(this.mContext).getDrivingPageIndexes(this.mContext, "_333_drivePage_front_radar_info"), this.getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_333_drivePage_front_radar_left"), this.getRadarDistanceStr(this.mCanBusInfoInt[6])));
            var2.add(new DriverUpdateEntity(this.getUiMgr(this.mContext).getDrivingPageIndexes(this.mContext, "_333_drivePage_front_radar_info"), this.getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_333_drivePage_front_radar_mid"), this.getRadarDistanceStr(this.mCanBusInfoInt[7])));
            var2.add(new DriverUpdateEntity(this.getUiMgr(this.mContext).getDrivingPageIndexes(this.mContext, "_333_drivePage_front_radar_info"), this.getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_333_drivePage_front_radar_right"), this.getRadarDistanceStr(this.mCanBusInfoInt[8])));
   ...
   private void noHaveDistanceInfo() {
      ...
      this.getUiMgr(this.mContext).getParkPageUiSet(this.mContext).setShowRadar(false);
   }
   ...
   private void sendPhoneStateInfo(int var1, int var2) {
      ...
      this.getUiMgr(this.mContext).sendPhoneStateInfo();
   }

   private void sendUSBInfo(String var1, String var2) {
      int var3;
      if (var1 != null) {
         int[] var4 = this.getByteArrayToIntArray(var1.getBytes(StandardCharsets.UTF_8));
         var3 = var4.length;
         MyLog.e("歌曲:" + var1, "长度:" + var3);
         if (var3 > 0) {
            this.data0xCB1 = var4[0];
         } else {
            this.data0xCB1 = 32;
         }

         if (var3 > 1) {
            this.data0xCB2 = var4[1];
         } else {
            this.data0xCB2 = 32;
         }

         if (var3 > 2) {
            this.data0xCB3 = var4[2];
         } else {
            this.data0xCB3 = 32;
         }

         if (var3 > 3) {
            this.data0xCB4 = var4[3];
         } else {
            this.data0xCB4 = 32;
         }

         if (var3 > 4) {
            this.data0xCB5 = var4[4];
         } else {
            this.data0xCB5 = 32;
         }

         if (var3 > 5) {
            this.data0xCB6 = var4[5];
         } else {
            this.data0xCB6 = 32;
         }

         if (var3 > 6) {
            this.data0xCB7 = var4[6];
         } else {
            this.data0xCB7 = 32;
         }

         if (var3 > 7) {
            this.data0xCB8 = var4[7];
         } else {
            this.data0xCB8 = 32;
         }

         if (var3 > 8) {
            this.data0xCB9 = var4[8];
         } else {
            this.data0xCB9 = 32;
         }

         if (var3 > 9) {
            this.data0xCB10 = var4[9];
         } else {
            this.data0xCB10 = 32;
         }

         if (var3 > 10) {
            this.data0xCB11 = var4[10];
         } else {
            this.data0xCB11 = 32;
         }

         if (var3 > 11) {
            this.data0xCB12 = var4[11];
         } else {
            this.data0xCB12 = 32;
         }

         if (var3 > 12) {
            this.data0xCB13 = var4[12];
         } else {
            this.data0xCB13 = 32;
         }

         if (var3 > 13) {
            this.data0xCB14 = var4[13];
         } else {
            this.data0xCB14 = 32;
         }

         if (var3 > 14) {
            this.data0xCB15 = var4[14];
         } else {
            this.data0xCB15 = 32;
         }

         if (var3 > 15) {
            this.data0xCB16 = var4[15];
         } else {
            this.data0xCB16 = 32;
         }

         if (var3 > 16) {
            this.data0xCB17 = var4[16];
         } else {
            this.data0xCB17 = 32;
         }

         if (var3 > 17) {
            this.data0xCB18 = var4[17];
         } else {
            this.data0xCB18 = 32;
         }

         if (var3 > 18) {
            this.data0xCB19 = var4[18];
         } else {
            this.data0xCB19 = 32;
         }

         if (var3 > 19) {
            this.data0xCB20 = var4[19];
         } else {
            this.data0xCB20 = 32;
         }

         this.getUiMgr(this.mContext).sendID3Info(2, this.data0xCB1, this.data0xCB2, this.data0xCB3, this.data0xCB4, this.data0xCB5, this.data0xCB6, this.data0xCB7, this.data0xCB8, this.data0xCB9, this.data0xCB10, this.data0xCB11, this.data0xCB12, this.data0xCB13, this.data0xCB14, this.data0xCB15, this.data0xCB16, this.data0xCB17, this.data0xCB18, this.data0xCB19, this.data0xCB20);
      }

      if (var2 != null) {
         int[] var5 = this.getByteArrayToIntArray(var2.getBytes(StandardCharsets.UTF_8));
         var3 = var5.length;
         MyLog.e("歌手:" + var2, "长度:" + var3);
         if (var3 > 0) {
            this.data0xCB1 = var5[0];
         } else {
            this.data0xCB1 = 32;
         }

         if (var3 > 1) {
            this.data0xCB2 = var5[1];
         } else {
            this.data0xCB2 = 32;
         }

         if (var3 > 2) {
            this.data0xCB3 = var5[2];
         } else {
            this.data0xCB3 = 32;
         }

         if (var3 > 3) {
            this.data0xCB4 = var5[3];
         } else {
            this.data0xCB4 = 32;
         }

         if (var3 > 4) {
            this.data0xCB5 = var5[4];
         } else {
            this.data0xCB5 = 32;
         }

         if (var3 > 5) {
            this.data0xCB6 = var5[5];
         } else {
            this.data0xCB6 = 32;
         }

         if (var3 > 6) {
            this.data0xCB7 = var5[6];
         } else {
            this.data0xCB7 = 32;
         }

         if (var3 > 7) {
            this.data0xCB8 = var5[7];
         } else {
            this.data0xCB8 = 32;
         }

         if (var3 > 8) {
            this.data0xCB9 = var5[8];
         } else {
            this.data0xCB9 = 32;
         }

         if (var3 > 9) {
            this.data0xCB10 = var5[9];
         } else {
            this.data0xCB10 = 32;
         }

         if (var3 > 10) {
            this.data0xCB11 = var5[10];
         } else {
            this.data0xCB11 = 32;
         }

         if (var3 > 11) {
            this.data0xCB12 = var5[11];
         } else {
            this.data0xCB12 = 32;
         }

         if (var3 > 12) {
            this.data0xCB13 = var5[12];
         } else {
            this.data0xCB13 = 32;
         }

         if (var3 > 13) {
            this.data0xCB14 = var5[13];
         } else {
            this.data0xCB14 = 32;
         }

         if (var3 > 14) {
            this.data0xCB15 = var5[14];
         } else {
            this.data0xCB15 = 32;
         }

         if (var3 > 15) {
            this.data0xCB16 = var5[15];
         } else {
            this.data0xCB16 = 32;
         }

         if (var3 > 16) {
            this.data0xCB17 = var5[16];
         } else {
            this.data0xCB17 = 32;
         }

         if (var3 > 17) {
            this.data0xCB18 = var5[17];
         } else {
            this.data0xCB18 = 32;
         }

         if (var3 > 18) {
            this.data0xCB19 = var5[18];
         } else {
            this.data0xCB19 = 32;
         }

         if (var3 > 19) {
            this.data0xCB20 = var5[19];
         } else {
            this.data0xCB20 = 32;
         }

         this.getUiMgr(this.mContext).sendID3Info(4, this.data0xCB1, this.data0xCB2, this.data0xCB3, this.data0xCB4, this.data0xCB5, this.data0xCB6, this.data0xCB7, this.data0xCB8, this.data0xCB9, this.data0xCB10, this.data0xCB11, this.data0xCB12, this.data0xCB13, this.data0xCB14, this.data0xCB15, this.data0xCB16, this.data0xCB17, this.data0xCB18, this.data0xCB19, this.data0xCB20);
      }
   }

   private void set0x3CInfo() {
      int var1 = this.getUiMgr(this.mContext).getDrivingPageIndexes(this.mContext, "_372_drive_data");
      ArrayList var2 = new ArrayList();
      var2.add(new DriverUpdateEntity(var1, this.getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data1"), this.get0x3CState(DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[2]))));
      var2.add(new DriverUpdateEntity(var1, this.getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data2"), this.get0x3CState(DataHandleUtils.getBoolBit5(this.mCanBusInfoInt[2]))));
      var2.add(new DriverUpdateEntity(var1, this.getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data4"), this.get0x3CState(DataHandleUtils.getBoolBit4(this.mCanBusInfoInt[2]))));
      var2.add(new DriverUpdateEntity(var1, this.getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data5"), this.get0x3CState(DataHandleUtils.getBoolBit3(this.mCanBusInfoInt[2]))));
      var2.add(new DriverUpdateEntity(var1, this.getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data6"), this.get0x3CState(DataHandleUtils.getBoolBit2(this.mCanBusInfoInt[2]))));
      var2.add(new DriverUpdateEntity(var1, this.getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data7"), this.get0x3CState(DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[2]))));
      var2.add(new DriverUpdateEntity(var1, this.getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data8"), this.get0x3CState(DataHandleUtils.getBoolBit0(this.mCanBusInfoInt[2]))));
      var2.add(new DriverUpdateEntity(var1, this.getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data9"), this.get0x3CState(DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[3]))));
      var2.add(new DriverUpdateEntity(var1, this.getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_372_drive_data10"), this.get0x3CState(DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[3]))));
      this.updateGeneralDriveData(var2);
      this.updateDriveDataActivity((Bundle)null);
   }
   ...
   private void setAccInfo0xEA() {
      if (!this.isAccInfoChange(this.mCanBusInfoInt)) {
         ...
         var1.add((new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_acc"), 0, this.getAccState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 0, 4)))).setValueStr(true));
         var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_acc"), 1, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 4, 4)));
         var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_acc"), 2, this.mCanBusInfoInt[3]));
   ...
   private void setAirInfo0x21() {
      ...
      var6[6] = this.blockBit(var6[6], 1);
      var6 = this.mCanBusInfoInt;
      var6[7] = 0;
      var6[6] = this.blockBit(var6[6], 2);
      if (!this.isAirDataChange()) {
         ...
         boolean var3 = DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[3]);
         ...
         GeneralAirData.front_left_blow_window = var4;
         GeneralAirData.front_right_blow_window = var4;
         ...
         GeneralAirData.front_left_temperature = this.getTemperature(this.mCanBusInfoInt[4], var7, 0, 255);
         GeneralAirData.front_right_temperature = this.getTemperature(this.mCanBusInfoInt[5], var7, 0, 255);
   ...
   private void setAlertInfo0x37() {
      ...
      if (DataHandleUtils.getBoolBit3(this.mCanBusInfoInt[2])) {
         var6 = var4 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131757961) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit4(this.mCanBusInfoInt[2])) {
         var5 = var6 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131757962) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit5(this.mCanBusInfoInt[2])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131757963) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[2])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131757964) + "】    ";
         var2 = var1 + 1;
      }
      ...
      int var3 = var2;
      if (DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[2])) {
         var6 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131757965) + "】    ";
         var3 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit0(this.mCanBusInfoInt[3])) {
         var4 = var6 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131757993) + "】    ";
         var1 = var3 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[3])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131757994) + "】    ";
         var3 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit2(this.mCanBusInfoInt[3])) {
         var4 = var5 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131757995) + "】    ";
         var2 = var3 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit3(this.mCanBusInfoInt[3])) {
         var5 = var4 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131757996) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit4(this.mCanBusInfoInt[3])) {
         var4 = var5 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131757997) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit5(this.mCanBusInfoInt[3])) {
         var5 = var4 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131757998) + "】    ";
         var3 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[3])) {
         var4 = var5 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131757999) + "】    ";
         var1 = var3 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[3])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758000) + "】    ";
         var3 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit0(this.mCanBusInfoInt[4])) {
         var4 = var5 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131758001) + "】    ";
         var2 = var3 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[4])) {
         var5 = var4 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758002) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit3(this.mCanBusInfoInt[4])) {
         var6 = var4 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758004) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit4(this.mCanBusInfoInt[4])) {
         var5 = var6 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758005) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit5(this.mCanBusInfoInt[4])) {
         var4 = var5 + "  【  " + var2 + "：" + this.mContext.getString(2131758006) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[4])) {
         var4 = var5 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131758008) + "】    ";
         var2 = var3 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[5])) {
         var5 = var4 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758009) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit2(this.mCanBusInfoInt[5])) {
         var6 = var5 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758010) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit3(this.mCanBusInfoInt[5])) {
         var4 = var6 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758011) + "】    ";
         var3 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit4(this.mCanBusInfoInt[5])) {
         var5 = var4 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131758012) + "】    ";
         var1 = var3 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit5(this.mCanBusInfoInt[5])) {
         var4 = var5 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758013) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[5])) {
         var5 = var4 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758014) + "】    ";
         var3 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[5])) {
         var4 = var5 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131758015) + "】    ";
         var1 = var3 + 1;
      }
      ...
      var2 = var1;
      if (DataHandleUtils.getBoolBit0(this.mCanBusInfoInt[6])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758016) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[6])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758017) + "】    ";
         var3 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit2(this.mCanBusInfoInt[6])) {
         var6 = var4 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131758018) + "】    ";
         var1 = var3 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit3(this.mCanBusInfoInt[6])) {
         var5 = var6 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758019) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[6])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758022) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit0(this.mCanBusInfoInt[7])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758023) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[7])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758024) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit2(this.mCanBusInfoInt[7])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758025) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit3(this.mCanBusInfoInt[7])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758026) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit4(this.mCanBusInfoInt[7])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758027) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit5(this.mCanBusInfoInt[7])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758028) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[7])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758029) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[7])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758030) + "】    ";
         var3 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit0(this.mCanBusInfoInt[8])) {
         var5 = var4 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131758031) + "】    ";
         var1 = var3 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[8])) {
         var4 = var5 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758032) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit2(this.mCanBusInfoInt[8])) {
         var5 = var4 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758033) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit3(this.mCanBusInfoInt[8])) {
         var6 = var5 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758034) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit4(this.mCanBusInfoInt[8])) {
         var4 = var6 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758035) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[8])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758037) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[8])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758038) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit0(this.mCanBusInfoInt[9])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758039) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[9])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758040) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit2(this.mCanBusInfoInt[9])) {
         var6 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758041) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit3(this.mCanBusInfoInt[9])) {
         var4 = var6 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758042) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit4(this.mCanBusInfoInt[9])) {
         var6 = var4 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758043) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit5(this.mCanBusInfoInt[9])) {
         var5 = var6 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758044) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[9])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758045) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[9])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758046) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit0(this.mCanBusInfoInt[10])) {
         var6 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758047) + "】    ";
         var3 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[10])) {
         var4 = var6 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131758048) + "】    ";
         var1 = var3 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit2(this.mCanBusInfoInt[10])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758049) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit3(this.mCanBusInfoInt[10])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758050) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit4(this.mCanBusInfoInt[10])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758051) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit5(this.mCanBusInfoInt[10])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758052) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[10])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758053) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[10])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758054) + "】    ";
         var3 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit0(this.mCanBusInfoInt[11])) {
         var5 = var4 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131758055) + "】    ";
         var1 = var3 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[11])) {
         var4 = var5 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758056) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit5(this.mCanBusInfoInt[11])) {
         var6 = var5 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131758060) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[11])) {
         var4 = var6 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131758061) + "】    ";
         var3 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[11])) {
         var5 = var4 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131758062) + "】    ";
         var1 = var3 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit0(this.mCanBusInfoInt[12])) {
         var4 = var5 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131757966) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[12])) {
         var5 = var4 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131757967) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit2(this.mCanBusInfoInt[12])) {
         var6 = var5 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131757968) + "】    ";
         var3 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit3(this.mCanBusInfoInt[12])) {
         var4 = var6 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131757969) + "】    ";
         var2 = var3 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit4(this.mCanBusInfoInt[12])) {
         var5 = var4 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131757970) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit5(this.mCanBusInfoInt[12])) {
         var4 = var5 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131757971) + "】    ";
         var3 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[12])) {
         var5 = var4 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131757972) + "】    ";
         var2 = var3 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[12])) {
         var4 = var5 + "  【  " + var2 + "：" + this.mContext.getString(2131757973) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[13])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131757975) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit2(this.mCanBusInfoInt[13])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131757976) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit3(this.mCanBusInfoInt[13])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131757977) + "】    ";
         var3 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit4(this.mCanBusInfoInt[13])) {
         var5 = var4 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131757978) + "】    ";
         var1 = var3 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit5(this.mCanBusInfoInt[13])) {
         var4 = var5 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131757979) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[13])) {
         var5 = var4 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131757980) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[13])) {
         var6 = var5 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131757981) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit0(this.mCanBusInfoInt[14])) {
         var4 = var6 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131757982) + "】    ";
         var3 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit2(this.mCanBusInfoInt[14])) {
         var4 = var5 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131757984) + "】    ";
         var3 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit3(this.mCanBusInfoInt[14])) {
         var5 = var4 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131757985) + "】    ";
         var2 = var3 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit4(this.mCanBusInfoInt[14])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131757986) + "】    ";
         var1 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit5(this.mCanBusInfoInt[14])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131757987) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[14])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131757988) + "】    ";
         var3 = var2 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[14])) {
         var6 = var4 + "  【  " + var7 + var3 + "：" + this.mContext.getString(2131757989) + "】    ";
         var1 = var3 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit0(this.mCanBusInfoInt[15])) {
         var5 = var6 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131757990) + "】    ";
         var2 = var1 + 1;
      }
      ...
      if (DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[15])) {
         var4 = var5 + "  【  " + var7 + var2 + "：" + this.mContext.getString(2131757991) + "】    ";
         var1 = var2 + 1;
      }

      var5 = var4;
      if (DataHandleUtils.getBoolBit2(this.mCanBusInfoInt[15])) {
         var5 = var4 + "  【  " + var7 + var1 + "：" + this.mContext.getString(2131757992) + "】    ";
      }
   ...
   private void setCarFactionState0x39() {
      int var1 = this.getUiMgr(this.mContext).getDrivingPageIndexes(this.mContext, "_333_driveData_factionState");
      ArrayList var2 = new ArrayList();
      var2.add(new DriverUpdateEntity(var1, 0, this.getSwitchState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 0, 2))));
      var2.add(new DriverUpdateEntity(var1, 1, this.getSwitchState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 2, 2))));
      var2.add(new DriverUpdateEntity(var1, 2, this.getSwitchState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 4, 2))));
      var2.add(new DriverUpdateEntity(var1, 3, this.getSwitchState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 6, 2))));
      var2.add(new DriverUpdateEntity(var1, 4, this.getSwitchState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 0, 2))));
      var2.add(new DriverUpdateEntity(var1, 5, this.getSwitchState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 2, 2))));
      var2.add(new DriverUpdateEntity(var1, 6, this.getCarStateMode(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 4, 3))));
      var2.add(new DriverUpdateEntity(var1, 7, this.getSwitchState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 0, 2))));
      var2.add(new DriverUpdateEntity(var1, 8, this.getSwitchState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 2, 2))));
      this.updateGeneralDriveData(var2);
      this.updateDriveDataActivity((Bundle)null);
   }

   private void setCarState0x38() {
      int var2 = this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_carState");
      ArrayList var3 = new ArrayList();
      var3.add(new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_1"), DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 7, 1)));
      var3.add((new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_2"), this.getFuelState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[3], 5, 1)))).setValueStr(true));
      int var1 = DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 5, 3);
      var3.add((new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_7"), var1)).setProgress(var1));
      var3.add(new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_8"), DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 4, 1)));
      var3.add(new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_9"), DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 3, 1)));
      var3.add((new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_10"), this.getReversingState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 2, 1)))).setValueStr(true));
      var3.add((new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_11"), this.getPState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 1, 1)))).setValueStr(true));
      var3.add((new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_12"), this.getLittleLampState(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[4], 0, 1)))).setValueStr(true));
      var3.add(new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_13"), DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[5], 6, 2)));
      var3.add(new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_14"), DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[5], 4, 2)));
      var3.add(new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_15"), DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[5], 3, 1)));
      var3.add(new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_16"), DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[5], 1, 2)));
      var3.add(new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_18"), DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[6], 7, 1)));
      var3.add(new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_19"), DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[6], 6, 1)));
      var3.add(new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_20"), DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[6], 5, 1)));
      var3.add(new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_21"), DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[6], 4, 1)));
      var3.add(new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_22"), this.getLangrage()));
      var3.add(new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_23"), this.getFuelConsumptionUnit(DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[7], 6, 2))));
      var3.add(new SettingUpdateEntity(var2, this.getCarSettingRightIndex("_333_setting_carState_25"), DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[7], 3, 1)));
   ...
   private void setControlCommand0x01() {
      ...
      } else if (var1 > 6 && var1 <= 9) {
         this.setBacklightLevel(3);
      } else if (var1 > 9 && var1 <= 12) {
   ...
   private void setCruiseSpeedLimit0x3D() {
      ...
      ArrayList var1 = new ArrayList();
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_cruise_speed"), 0, this.mCanBusInfoInt[2]));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_cruise_speed"), 1, this.mCanBusInfoInt[3]));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_cruise_speed"), 2, this.mCanBusInfoInt[4]));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_cruise_speed"), 3, this.mCanBusInfoInt[5]));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_cruise_speed"), 4, this.mCanBusInfoInt[6]));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_cruise_speed"), 5, this.mCanBusInfoInt[7]));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_limit"), 0, this.mCanBusInfoInt[8]));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_limit"), 1, this.mCanBusInfoInt[9]));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_limit"), 2, this.mCanBusInfoInt[10]));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_limit"), 3, this.mCanBusInfoInt[11]));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_limit"), 4, this.mCanBusInfoInt[12]));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_limit"), 5, this.mCanBusInfoInt[13]));
      this.updateGeneralSettingData(var1);
      this.updateSettingActivity((Bundle)null);
   }
   ...
   private void setEconomicModelInfo0x44() {
      ArrayList var1 = new ArrayList();
      var1.add((new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_acc"), 3, this.getEconomicModelState(this.mCanBusInfoInt[2]))).setValueStr(true));
      this.updateGeneralSettingData(var1);
      this.updateSettingActivity((Bundle)null);
   }
   ...
   private void setRadarSoundInfo0x3E() {
      int var1 = this.getUiMgr(this.mContext).getDrivingPageIndexes(this.mContext, "_333_drivePage_front_radar_info");
      ArrayList var2 = new ArrayList();
      if (DataHandleUtils.getBoolBit7(this.mCanBusInfoInt[2])) {
         var2.add(new DriverUpdateEntity(var1, 3, this.mContext.getString(2131763114)));
      } else {
         var2.add(new DriverUpdateEntity(var1, 3, this.mContext.getString(2131763115)));
      }
   ...
   private void setSpeed0x3B() {
      ...
      ArrayList var1 = new ArrayList();
      var1.add((new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 0, this.isShowSpeedTag(DataHandleUtils.getBoolBit1(this.mCanBusInfoInt[2])))).setValueStr(true));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 1, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 7, 1)));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 2, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 6, 1)));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 3, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 5, 1)));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 4, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 4, 1)));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 5, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 3, 1)));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 6, DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[2], 2, 1)));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 7, this.mCanBusInfoInt[3]));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 8, this.mCanBusInfoInt[4]));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 9, this.mCanBusInfoInt[5]));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 10, this.mCanBusInfoInt[6]));
      var1.add(new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_speed_memory"), 11, this.mCanBusInfoInt[7]));
      this.updateGeneralSettingData(var1);
      this.updateSettingActivity((Bundle)null);
   }
   ...
   private void setTripComputerInfo0x33() {
      ArrayList var2 = new ArrayList();
      int var1 = this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_0");
      ...
      var1 = this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_0");
      var3 = new StringBuilder();
      int[] var7 = this.mCanBusInfoInt;
      var2.add((new SettingUpdateEntity(var1, 1, var3.append(this.getMsbLsbResult(var7[4], var7[5])).append(" KM").toString())).setValueStr(true));
      var1 = this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_0");
      ...
      var2.add((new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_0"), 3, this.timeFormat.format((long)this.mCanBusInfoInt[8]) + ":" + this.timeFormat.format((long)this.mCanBusInfoInt[9]) + ":" + this.timeFormat.format((long)this.mCanBusInfoInt[10]))).setValueStr(true));
      this.updateGeneralSettingData(var2);
      this.updateSettingActivity((Bundle)null);
   }

   private void setTripComputerInfo0x34() {
      this.getUiMgr(this.mContext).ComputerInfoData3Bit7 = 0;
      this.getUiMgr(this.mContext).ComputerInfoData3Bit6 = 0;
      ArrayList var2 = new ArrayList();
      int var1 = this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_1");
      StringBuilder var3 = new StringBuilder();
      DecimalFormat var5 = this.oneDecimal;
      int[] var4 = this.mCanBusInfoInt;
      var2.add((new SettingUpdateEntity(var1, 0, var3.append(var5.format((double)this.getMsbLsbResult(var4[2], var4[3]) * 0.1)).append(" L/100Km").toString())).setValueStr(true));
      var1 = this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_1");
      var3 = new StringBuilder();
      var4 = this.mCanBusInfoInt;
      var2.add((new SettingUpdateEntity(var1, 1, var3.append(this.getMsbLsbResult(var4[4], var4[5])).append(" KM/H").toString())).setValueStr(true));
      var1 = this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_1");
      var3 = new StringBuilder();
      var4 = this.mCanBusInfoInt;
      var2.add((new SettingUpdateEntity(var1, 2, var3.append(this.getMsbLsbResult(var4[6], var4[7])).append(" KM").toString())).setValueStr(true));
      this.updateGeneralSettingData(var2);
      this.updateSettingActivity((Bundle)null);
   }
   ...
   private void setTripComputerInfo0x35() {
      this.getUiMgr(this.mContext).ComputerInfoData3Bit7 = 0;
      this.getUiMgr(this.mContext).ComputerInfoData3Bit5 = 0;
      ArrayList var2 = new ArrayList();
      int var1 = this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_2");
      StringBuilder var3 = new StringBuilder();
      DecimalFormat var4 = this.oneDecimal;
      int[] var5 = this.mCanBusInfoInt;
      var2.add((new SettingUpdateEntity(var1, 0, var3.append(var4.format((long)(this.getMsbLsbResult(var5[2], var5[3]) / 10))).append(" L/100Km").toString())).setValueStr(true));
      var1 = this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_2");
      StringBuilder var7 = new StringBuilder();
      int[] var6 = this.mCanBusInfoInt;
      var2.add((new SettingUpdateEntity(var1, 1, var7.append(this.getMsbLsbResult(var6[4], var6[5])).append(" KM/H").toString())).setValueStr(true));
      var1 = this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_2");
      var3 = new StringBuilder();
      int[] var8 = this.mCanBusInfoInt;
      var2.add((new SettingUpdateEntity(var1, 2, var3.append(this.getMsbLsbResult(var8[6], var8[7])).append(" KM").toString())).setValueStr(true));
      this.updateGeneralSettingData(var2);
      this.updateSettingActivity((Bundle)null);
   }
   ...
   private void setVersionInfo0x71() {
      ArrayList var1 = new ArrayList();
      var1.add((new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_page_1"), 0, this.getCarSeries(this.mCanBusInfoInt[2]))).setValueStr(true));
      var1.add((new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_page_1"), 1, this.getCarModel(this.mCanBusInfoInt[3]))).setValueStr(true));
      var1.add((new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_page_1"), 2, this.mCanBusInfoInt[4] + 2000 - 6 + "年" + this.mCanBusInfoInt[5] + "月" + this.mCanBusInfoInt[6] + "日")).setValueStr(true));
      var1.add((new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_drive_page_1"), 3, "V" + this.mCanBusInfoInt[8] + "." + this.mCanBusInfoInt[9] + "." + this.mCanBusInfoInt[10])).setValueStr(true));
      this.updateGeneralSettingData(var1);
      this.updateSettingActivity((Bundle)null);
   }
                              ...
                              default:
                                 switch (var1) {
                                    ...
                                    case 32:
                                       ...
                                       if (var1 == 1) {
                                          var3 = this.mContext;
                                          this.startSettingActivity(var3, this.getUiMgr(var3).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_0"), 0);
                                          this.computerInfoTag = 2;
                                       } else if (var1 == 2) {
                                          var3 = this.mContext;
                                          this.startSettingActivity(var3, this.getUiMgr(var3).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_1"), 0);
                                          this.computerInfoTag = 3;
                                       } else if (var1 == 3) {
                                          var3 = this.mContext;
                                          this.startSettingActivity(var3, this.getUiMgr(var3).getLeftIndexes(this.mContext, "_333_drive_DrivingPage_2"), 0);
      ...
      if (!this.lastData.equals(var1)) {
         ...
         this.runOnUi(new AbstractMsgMgr.CallBackInterface(this, var1) {
            ...
            public void callback() {
               (new SetAlertView()).showDialog(this.this$0.getActivity(), this.val$showContent);
            }
         });
      }
   ...
   private void updateSetUi(String var1) {
      ArrayList var2 = new ArrayList();
      var2.add((new SettingUpdateEntity(this.getUiMgr(this.mContext).getLeftIndexes(this.mContext, "_333_setting_carState"), this.getUiMgr(this.mContext).getSettingRightIndex(this.mContext, "_333_setting_carState", "_333_setting_carState_25"), var1)).setValueStr(true));
      this.updateGeneralSettingData(var2);
      this.updateSettingActivity((Bundle)null);
   }
   ...
   public void auxInDestdroy() {
      super.auxInDestdroy();
      if (this.eachId == 4) {
         this.getUiMgr(this.mContext).sendSourceInfo(0, 0, 0, 0, 0, 0, 0, 0);
      }
   }
   ...
   public void auxInInfoChange() {
      ...
      if (this.eachId == 4) {
         this.getUiMgr(this.mContext).sendSourceInfo(7, 48, 0, 0, 0, 0, 0, 0);
      }
   }

   public void btMusicInfoChange() {
      super.btMusicInfoChange();
      this.getUiMgr(this.mContext).sendSourceInfo(11, 0, 0, 0, 0, 0, 0, 0);
   }
   ...
   public void btPhoneIncomingInfoChange(byte[] var1, boolean var2, boolean var3) {
      ...
      if (this.eachId == 4) {
         this.huangUpTag = 0;
         this.getUiMgr(this.mContext).sendID3Info(var1);
         this.getUiMgr(this.mContext);
         UiMgr.phoneStateData1Bit4 = 1;
         this.getUiMgr(this.mContext);
   ...
   public void btPhoneStatusInfoChange(int var1, byte[] var2, boolean var3, boolean var4, boolean var5, boolean var6, int var7, int var8, Bundle var9) {
      ...
      if (this.eachId == 4) {
         this.getUiMgr(this.mContext).sendSourceInfo(5, 64, 0, 0, 0, 0, 0, 0);
   ...
   public void currentVolumeInfoChange(int var1, boolean var2) {
      ...
      if (this.eachId == 4) {
         ...
         if (var2) {
            ...
            this.volInfoData0 = var3;
         }

         this.getUiMgr(this.mContext).sendVolInfo(this.volInfoData0);
      }
   }
   ...
   public void discInfoChange(byte var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8, boolean var9, int var10, String var11, String var12, String var13) {
      ...
      if (this.eachId == 4) {
         this.getUiMgr(this.mContext).sendSourceInfo(2, 16, var5, var6, 0, 0, 0, 0);
         this.sendUSBInfo(var11, var13);
      }
   }
   ...
   public void radioInfoChange(int var1, String var2, String var3, String var4, int var5) {
      ...
      if (this.eachId == 4) {
         ...
         this.radioData3 = 0;
         this.getUiMgr(this.mContext).sendRadioInfo(this.radioData0, this.radioData1, this.radioData2, this.radioData3);
         this.getUiMgr(this.mContext).sendSourceInfo(1, 0, 0, 0, 0, 0, 0, 0);
      }
   }
   ...
   public void videoInfoChange(byte var1, byte var2, int var3, int var4, byte var5, byte var6, byte var7, String var8, byte var9, byte var10, String var11, String var12, String var13, int var14, byte var15, boolean var16, int var17) {
      ...
      if (this.eachId == 4) {
         this.getUiMgr(this.mContext).sendSourceInfo(8, 19, var3, var9, this.getLsb(var4), this.getMsb(var4), 0, 0);
      }
   }
}
