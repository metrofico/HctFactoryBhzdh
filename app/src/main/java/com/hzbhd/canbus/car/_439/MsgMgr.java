...
public class MsgMgr extends AbstractMsgMgr {
   ...
   private Handler mHandler = new Handler(this, Looper.getMainLooper()) {
      ...
      public void handleMessage(Message var1) {
         ...
         switch (var1.what) {
            case 252:
               if (System.getInt(BaseUtil.INSTANCE.getContext().getContentResolver(), "CAN_BUS_SMART_PANEL_PAGE_SWITCH_439", 1) == 1 && !this.this$0.panelButton.getShowTag()) {
   ...
   private void set0x37() {
      if (!this.isRepairDataNoChange(this.mCanBusInfoInt)) {
         ...
         DriveData.dataA2 = var1.append(DataHandleUtils.getMsbLsbResult(var2[2], var2[3])).append("").toString();
               ...
               this.runOnUi(new AbstractMsgMgr.CallBackInterface(this, var2) {
                  ...
                  public void callback() {
                     try {
                        ...
                        AlertWindowView var1 = this.this$0.getAlertView();
                        Context var2 = this.this$0.mContext;
                        StringBuilder var3 = new StringBuilder();
                        var1.show(var2, var3.append(this.this$0.mContext.getString(2131765954)).append(":").append(this.val$alertContent).toString());
               ...
               if (this.this$0.panelButton == null) {
                  this.this$0.panelButton = new PanelButton(this.val$context, new PanelButton.PanoramaListener(this) {
                     ...
                     public void clickEvent() {
                        this.this$1.this$0.startOtherActivity(this.this$1.val$context, HzbhdComponentName.ID439PanelActivity);
                     }
                  });
               }
   ...
   // $FF: synthetic method
   void lambda$registerAirControlListener$0$com_hzbhd_canbus_car__439_MsgMgr(String var1) {
