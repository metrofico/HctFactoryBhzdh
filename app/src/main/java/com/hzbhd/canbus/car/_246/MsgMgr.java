...
public class MsgMgr extends AbstractMsgMgr {
   ...
   private void set0x16SpeedInfo() {
      ...
      var3.add(new DriverUpdateEntity(var1, var2, var5.append(this.getMsbLsbResult(var4[3], var4[2]) / 16).append("km/h").toString()));
   ...
   private void set0x41CarInfo0x02Data() {
      ...
      var3.add(new DriverUpdateEntity(var1, var2, var4.append(var5[3] * 256 + var5[4]).append(" RPM").toString()));
      ...
      var4 = new StringBuilder();
      var5 = this.mCanBusInfoInt;
      var3.add(new DriverUpdateEntity(var2, var1, var4.append((double)(var5[7] * 256 + var5[8]) * 0.01).append(" V").toString()));
      Context var8 = this.mContext;
      StringBuilder var6 = new StringBuilder();
      int[] var7 = this.mCanBusInfoInt;
      this.updateOutDoorTemp(var8, var6.append((double)(var7[9] * 256 + var7[10]) * 0.1).append(this.getTempUnitC(this.mContext)).toString());
      var2 = this.getUigMgr(this.mContext).getDrivingPageIndexes(this.mContext, "_246_car_info");
      var1 = this.getUigMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_246_car_info16");
      var4 = new StringBuilder();
      var5 = this.mCanBusInfoInt;
      var3.add(new DriverUpdateEntity(var2, var1, var4.append(var5[11] * 65536 + var5[12] * 256 + var5[13]).append(" Km").toString()));
   ...
   public void initCommand(Context var1) {
      ...
      ((UiMgr)UiMgrFactory.getCanUiMgr(var1)).initAmplifierInfo(var1);
   }
