...
public class UiMgr extends AbstractUiMgr {
   ...
   public UiMgr(Context var1) {
      ...
      var7.getFrontArea().setSeatHeatColdClickListeners(new OnAirSeatHeatColdMinPlusClickListener[]{var6, var3, var5, var4});
      DriverDataPageUiSet var11 = this.getDriverDataPageUiSet(var1);
      int[] var9 = this.getSettingItemPosition(var2, "_41_delete_fuel_record");
      var11.setLeftPosition(var9[0]);
      var11.setRightPosition(var9[1]);
      AmplifierPageUiSet var10 = this.getAmplifierPageUiSet(var1);
      var10.setOnAmplifierSeekBarListener(new OnAmplifierSeekBarListener(this) {
         final UiMgr this$0;
            ...
            if (var3 != 1) {
               if (var3 != 2) {
                  if (var3 == 3) {
                     ...
                     SharePreUtil.setIntValue(this.this$0.mContext, "__162_SAVE_AMP_VOL", var2);
                     GeneralAmplifierData.volume = var2;
                     this.this$0.sendAmpKeyMsg(15, var2);
                  }
               } else {
                  this.this$0.mIsClickReset = false;
                  SharePreUtil.setIntValue(this.this$0.mContext, "__162_SAVE_AMP_TRE", var2);
                  GeneralAmplifierData.bandTreble = var2;
                  this.this$0.isEightNumer();
                  this.this$0.setAmpParams();
               }
            } else {
               this.this$0.mIsClickReset = false;
               SharePreUtil.setIntValue(this.this$0.mContext, "__162_SAVE_AMP_BASS", var2);
      ...
      var10.setOnAmplifierPositionListener(new OnAmplifierPositionListener(this) {
         final UiMgr this$0;
            ...
            if (var3 != 1) {
               if (var3 == 2) {
                  if (this.this$0.mIsClickReset) {
                     ...
                     SharePreUtil.setIntValue(this.this$0.mContext, "__162_SAVE_AMP_LR", var2);
               ...
               SharePreUtil.setIntValue(this.this$0.mContext, "__162_SAVE_AMP_FR", var2);
      ...
      var10.setOnAmplifierResetPositionListener(new OnAmplifierResetPositionListener(this) {
         final UiMgr this$0;
      ...
      PanelKeyPageUiSet var8 = this.getPanelKeyPageUiSet(var1);
      var8.setOnPanelKeyPositionListener(new OnPanelKeyPositionListener(this, var8) {
         final UiMgr this$0;
         ...
         public void click(int var1) {
            Log.d("mww panelKeyPageUiSet", (String)this.val$panelKeyPageUiSet.getList().get(var1));
            ...
            switch (var2) {
               case -1526445371:
                  if (var3.equals("OPEL_KEY_Right")) {
                     var4 = 0;
                  }
                  break;
               case -49664595:
                  if (var3.equals("OPEL_KEY_Dark")) {
                     var4 = 1;
                  }
                  break;
               case -49650983:
                  if (var3.equals("OPEL_KEY_Down")) {
                     var4 = 2;
                  }
                  break;
               case -49422786:
                  ...
                  break;
               case -49412727:
                  if (var3.equals("OPEL_KEY_Loud")) {
                     var4 = 4;
                  }
                  break;
               case -49392746:
                  if (var3.equals("OPEL_KEY_Menu")) {
                     var4 = 5;
                  }
                  break;
               case -49383462:
                  if (var3.equals("OPEL_KEY_Mode")) {
                     var4 = 6;
                  }
                  break;
               case 1010003379:
                  ...
                  break;
               case 1010003602:
                  if (var3.equals("OPEL_KEY_Up")) {
                     var4 = 8;
                  }
                  break;
               case 1245324382:
                  if (var3.equals("OPEL_KEY_ESC")) {
                     var4 = 9;
                  }
            }
            ...
            switch (var4) {
               case 0:
                  this.this$0.sendKey2Msg(32);
                  break;
               case 1:
                  this.this$0.sendKey2Msg(128);
                  break;
               case 2:
                  this.this$0.sendKey2Msg(8);
                  break;
               case 3:
                  this.this$0.sendKey2Msg(16);
                  break;
               case 4:
                  var1 = SharePreUtil.getBoolValue(this.this$0.mContext, "CAN_162_LOUD", false) ^ 1;
                  SharePreUtil.setBoolValue(this.this$0.mContext, "CAN_162_LOUD", (boolean)var1);
                  this.this$0.sendAmpKeyMsg(17, var1);
                  break;
               case 5:
                  this.this$0.sendKey2Msg(1);
                  break;
               case 6:
                  this.this$0.sendKey2Msg(64);
                  break;
               case 7:
                  this.this$0.sendKey1Msg(32);
                  break;
               case 8:
                  this.this$0.sendKey2Msg(4);
                  break;
               case 9:
                  this.this$0.sendKey2Msg(2);
            }
   ...
   private boolean isEightNumer() {
      return true;
   }

   private void requestCommand() {
      byte[] var1 = new byte[]{22, -112, -46, 0};
      this.getSettingTimerUtil().startTimer(new TimerTask(this, new byte[][]{{22, -112, 50, 0}, {22, -112, 37, 0}, var1}) {
         int i;
         final UiMgr this$0;
   ...
   private void sendAirKeyMsg(int var1) {
      this.mHandler.postDelayed(new Runnable(this, var1) {
         ...
         public void run() {
            CanbusMsgSender.sendMsg(new byte[]{22, 8, (byte)this.val$cmd, 1});
         }
      }, 30L);
      this.mHandler.postDelayed(new Runnable(this, var1) {
         final UiMgr this$0;
         ...
         public void run() {
            CanbusMsgSender.sendMsg(new byte[]{22, 8, (byte)this.val$cmd, 0});
         }
      }, 30L);
   }
   ...
   private void sendAmpKeyMsg(int var1, int var2) {
      this.mHandler.postDelayed(new Runnable(this, var1, var2) {
         ...
         public void run() {
            CanbusMsgSender.sendMsg(new byte[]{22, 9, (byte)this.val$cmd, (byte)this.val$param});
         }
      }, 30L);
   }

   private void sendKey1Msg(int var1) {
   ...
   private void sendKey2Msg(int var1) {
      this.mHandler.postDelayed(new Runnable(this, var1) {
         final UiMgr this$0;
         final int val$cmd;
         ...
         public void run() {
            CanbusMsgSender.sendMsg(new byte[]{22, 8, 0, (byte)this.val$cmd});
         }
      }, 30L);
      this.mHandler.postDelayed(new Runnable(this) {
         final UiMgr this$0;
