...
public class AutoParkVoiceManger {
   ...
   // $FF: synthetic method
   void lambda$initMediaPlayer$0$com_hzbhd_canbus_car__306_AutoParkVoiceManger(MediaPlayer var1) {
   ...
   // $FF: synthetic method
   void lambda$initMediaPlayer$1$com_hzbhd_canbus_car__306_AutoParkVoiceManger(MediaPlayer var1) {
