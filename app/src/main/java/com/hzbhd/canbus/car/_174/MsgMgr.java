...
public class MsgMgr extends AbstractMsgMgr {
   ...
   private boolean isOnlyDoorMsgShow() {
      if (SharePreUtil.getBoolValue(this.mContext, "_174_isleft_front_door_open", false) != GeneralDoorData.isLeftFrontDoorOpen) {
         return true;
      } else if (SharePreUtil.getBoolValue(this.mContext, "_174_isright_front_door_open", false) != GeneralDoorData.isRightFrontDoorOpen) {
         return true;
      } else if (SharePreUtil.getBoolValue(this.mContext, "_174_isright_rear_door_open", false) != GeneralDoorData.isRightRearDoorOpen) {
         return true;
      } else if (SharePreUtil.getBoolValue(this.mContext, "_174_isleft_rear_door_open", false) != GeneralDoorData.isLeftRearDoorOpen) {
         return true;
      } else {
         return SharePreUtil.getBoolValue(this.mContext, "_174_isback_open", false) != GeneralDoorData.isBackOpen;
      }
   }

   private boolean isOnlyRearUpdate() {
      if (SharePreUtil.getIntValue(this.mContext, "_174_air_rear", 0) != this.isOnlyRearUpdate) {
         return true;
      } else {
         return SharePreUtil.getIntValue(this.mContext, "_174_air_rear_temp", 0) != this.isOnlyRearTempDate;
      }
   }
   ...
   private void setCarSpeed() {
      ...
      int[] var2 = this.mCanBusInfoInt;
      var1.add(new DriverUpdateEntity(0, 3, var3.append((var2[2] + var2[3] * 256) / 16).append("Km/h").toString()));
   ...
   private void setPanoramicSetting() {
      ...
      for(int var1 = 0; var1 < 4; ++var1) {
         var6.add(new SettingUpdateEntity(0, var1, (new int[]{var3, var4, var2, var5})[var1]));
      }
   ...
   private void setPanoramicStatus() {
      ...
      SharePreUtil.setBoolValue(var4, "_174_is_back_camera", var2);
      var4 = this.mContext;
      if (var1 == 2) {
         var2 = true;
      } else {
      ...
      SharePreUtil.setBoolValue(var4, "_174_is_panoramic", var2);
      var4 = this.mContext;
      if (var1 != 0) {
         var2 = true;
      } else {
      ...
      if (!SharePreUtil.getBoolValue(this.mContext, "_174_is_back_camera", false) && !CommUtil.isMiscReverse()) {
         if (SharePreUtil.getBoolValue(this.mContext, "_174_is_panoramic", false)) {
   ...
   private void setTypeDataInfo() {
      ...
      label23: {
         ...
         var2 = DataHandleUtils.getBoolBit6(this.mCanBusInfoInt[4]);
      ...
      var8.add(this.getTireEntity(var1, this.getTisWarmMsg(var5), this.getTirePressure(this.mCanBusInfoInt[5], var4), this.getTireTemp(this.mCanBusInfoInt[6], var3), this.getVoltage(this.mCanBusInfoInt[7], var2), this.getSensor(var6)));
   ...
   void initAmplifierData(Context var1) {
      GeneralAmplifierData.frontRear = 10 - SharePreUtil.getIntValue(var1, "_174_amplifier_fade", 0);
      GeneralAmplifierData.leftRight = SharePreUtil.getIntValue(var1, "_174_amplifier_balance", 0) - 10;
      GeneralAmplifierData.bandBass = SharePreUtil.getIntValue(var1, "_174_amplifier_bass", 0) - 10;
      GeneralAmplifierData.bandMiddle = SharePreUtil.getIntValue(var1, "_174_amplifier_middle", 0) - 10;
      GeneralAmplifierData.bandTreble = SharePreUtil.getIntValue(var1, "_174_amplifier_treble", 0) - 10;
   ...
   void setLanguage_recNull(Context var1) {
      int var2 = SharePreUtil.getIntValue(var1, "_174_SAVE_LANGUAGE", 0);
      ArrayList var3 = new ArrayList();
