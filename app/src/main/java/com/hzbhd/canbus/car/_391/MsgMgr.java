...
public class MsgMgr extends AbstractMsgMgr {
                  ...
                  if (var1 != 25) {
                     switch (var1) {
                        ...
                        case 6:
                           ...
                           break;
                        case 7:
                           this.realKeyClick4(this.mContext, 39);
                           break;
                        case 8:
   ...
   private void set0x11Speed() {
      ...
      var1.add(new DriverUpdateEntity(this.getUiMgr(this.mContext).getDrivingPageIndexes(this.mContext, "_391_drive"), this.getUiMgr(this.mContext).getDrivingItemIndexes(this.mContext, "_391_drive1"), this.mCanBusInfoInt[3] + "km/h"));
