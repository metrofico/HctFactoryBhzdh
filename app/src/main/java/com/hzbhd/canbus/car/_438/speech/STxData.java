   ...
   public static class AcCtrl {
      ...
      public static class Mode {
         ...
         public static enum ModeEnum {
            ...
            static {
               ModeEnum var0 = new ModeEnum("face", 0);
               face = var0;
               ModeEnum var2 = new ModeEnum("foot", 1);
               foot = var2;
               ModeEnum var3 = new ModeEnum("facefoot", 2);
               facefoot = var3;
               ModeEnum var1 = new ModeEnum("footdefrost", 3);
               footdefrost = var1;
               $VALUES = new ModeEnum[]{var0, var2, var3, var1};
            }
         }
      }
   ...
   public static class CarCtrl {
      ...
      public static class WindowOpen {
         ...
         public static enum TypeEnum {
            ...
            static {
               TypeEnum var0 = new TypeEnum("leftfront", 0);
               leftfront = var0;
               TypeEnum var1 = new TypeEnum("rightfront", 1);
               rightfront = var1;
               $VALUES = new TypeEnum[]{var0, var1};
            }
         }
      }
      ...
      public static class WiperCtrl {
         ...
         public static enum ModeEnum {
            ...
            static {
               ModeEnum var3 = new ModeEnum("intermittent", 0);
               intermittent = var3;
               ModeEnum var2 = new ModeEnum("speedlow", 1);
               speedlow = var2;
               ModeEnum var0 = new ModeEnum("speedhigh", 2);
               speedhigh = var0;
               ModeEnum var1 = new ModeEnum("wash", 3);
               wash = var1;
               $VALUES = new ModeEnum[]{var3, var2, var0, var1};
            }
         }
      }
