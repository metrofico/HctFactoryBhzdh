...
public class UiMgr extends AbstractUiMgr {
   ...
   public UiMgr(Context var1) {
      ...
      var2.setOnSettingItemClickListener(new OnSettingItemClickListener(this) {
         ...
         public void onClickItem(int var1, int var2) {
            ...
            if (var1 == var3.getSettingLeftIndexes(var3.mContext, "_374_car_aux")) {
               var3 = this.this$0;
               if (var2 == var3.getSettingRightIndex(var3.mContext, "_374_car_aux", "_374_car_aux")) {
   ...
   private com.hzbhd.canbus.car._0.MsgMgr getMsgMgr(Context var1) {
      if (this.mMsgMgr == null) {
         this.mMsgMgr = (com.hzbhd.canbus.car._0.MsgMgr)MsgMgrFactory.getCanMsgMgr(var1);
      }
