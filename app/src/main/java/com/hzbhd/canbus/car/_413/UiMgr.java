...
public class UiMgr extends AbstractUiMgr {
      ...
      public void onClickItem(int var1) {
         if (var1 != 0) {
            if (var1 != 1) {
               ...
               this.this$0.sendAirInfo0x3D(25);
            }
         } else {
            this.this$0.sendAirInfo0x3D(35);
         }
   ...
   OnAirBtnClickListener mOnAirBtnClickListenerFrontRight = new OnAirBtnClickListener(this) {
      ...
      public void onClickItem(int var1) {
         if (var1 != 0) {
            if (var1 == 1) {
               this.this$0.sendAirInfo0x3D(41);
            }
         } else {
      ...
      public void onClickItem(int var1) {
         if (var1 != 0) {
            if (var1 != 1) {
               if (var1 != 2) {
                  if (var1 == 3) {
                     this.this$0.sendAirInfo0x3D(3);
                  }
               } else {
                  this.this$0.sendAirInfo0x3D(4);
               }
            } else {
               this.this$0.sendAirInfo0x3D(30);
            }
         } else {
   ...
   OnAirBtnClickListener mOnAirBtnClickListenerRearBottom = new OnAirBtnClickListener(this) {
      ...
      public void onClickItem(int var1) {
         if (var1 != 0) {
            if (var1 == 1) {
               this.this$0.sendAirInfo0x3D(34);
            }
         } else {
            this.this$0.sendAirInfo0x3D(19);
         }
   ...
   OnAirSeatHeatColdMinPlusClickListener mOnMinPlusClickListenerColdFrontLeft = new OnAirSeatHeatColdMinPlusClickListener(this) {
      ...
      public void onClickPlus() {
         this.this$0.sendAirInfo0x3D(23);
      }
   };
   OnAirSeatHeatColdMinPlusClickListener mOnMinPlusClickListenerColdFrontRight = new OnAirSeatHeatColdMinPlusClickListener(this) {
      ...
      public void onClickPlus() {
         this.this$0.sendAirInfo0x3D(24);
      }
   };
   ...
   private OnAirTemperatureUpDownClickListener mOnUpDownClickListenerFrontRight = new OnAirTemperatureUpDownClickListener(this) {
      ...
      public void onClickDown() {
         this.this$0.sendAirInfo0x3D(16);
      }

      public void onClickUp() {
         this.this$0.sendAirInfo0x3D(15);
      }
   };
   private OnAirTemperatureUpDownClickListener mOnUpDownClickListenerRear = new OnAirTemperatureUpDownClickListener(this) {
      final UiMgr this$0;
      ...
      public void onClickDown() {
         this.this$0.sendAirInfo0x3D(33);
      }

      public void onClickUp() {
         this.this$0.sendAirInfo0x3D(32);
      }
   };
   ...
   OnAirSeatClickListener onAirSeatClickListener = new OnAirSeatClickListener(this) {
      ...
      public void onRightSeatClick() {
         this.this$0.sendAirInfo0x3D(36);
      }
   };
   private OnAirSeatHeatColdMinPlusClickListener onMinPlusClickListenerLeft = new OnAirSeatHeatColdMinPlusClickListener(this) {
      ...
      public void onClickPlus() {
         this.this$0.sendAirInfo0x3D(17);
      }
   };
   private OnAirSeatHeatColdMinPlusClickListener onMinPlusClickListenerRight = new OnAirSeatHeatColdMinPlusClickListener(this) {
      ...
      public void onClickPlus() {
         this.this$0.sendAirInfo0x3D(18);
      }
   };
   ...
   public UiMgr(Context var1) {
      ...
      var2.getFrontArea().setSeatHeatColdClickListeners(new OnAirSeatHeatColdMinPlusClickListener[]{this.onMinPlusClickListenerLeft, this.onMinPlusClickListenerRight, this.mOnMinPlusClickListenerColdFrontLeft, this.mOnMinPlusClickListenerColdFrontRight});
      ...
      this.getSettingUiSet(this.mContext).setOnSettingItemSelectListener(new OnSettingItemSelectListener(this) {
         ...
         public void onClickItem(int var1, int var2, int var3) {
            ...
            if (var1 == var4.getSettingLeftIndexes(var4.mContext, "_413_panoramic")) {
               var4 = this.this$0;
               if (var2 == var4.getSettingRightIndex(var4.mContext, "_413_panoramic", "_413_panoramic1")) {
                  var4 = this.this$0;
                  var4.getMsgMgr(var4.mContext).updateSettings(var1, var2, var3);
                  if (var3 == 0) {
                     var4 = this.this$0;
                     var4.getMsgMgr(var4.mContext).hideDvrButton();
                  } else {
                     var4 = this.this$0;
                     var4.getMsgMgr(var4.mContext).showDvrButton();
                  }
               }
            }
      ...
      this.getParkPageUiSet(this.mContext).setOnPanoramicItemClickListener(new OnPanoramicItemClickListener(this) {
         ...
         public void onClickItem(int var1) {
            if (var1 != 0) {
               if (var1 == 1) {
                  this.this$0.sendPanoramicCmd(3);
               }
            } else {
               this.this$0.sendPanoramicCmd(2);
            }
   ...
   public void sendPanoramicCmd(int var1) {
      CanbusMsgSender.sendMsg(new byte[]{22, -3, 2, (byte)var1});
   }
