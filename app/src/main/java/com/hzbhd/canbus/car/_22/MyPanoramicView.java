...
public class MyPanoramicView extends RelativeLayout implements View.OnClickListener, View.OnTouchListener {
   ...
   public MyPanoramicView(Context var1, int var2) {
      ...
      var5[0] = var7;
      RelativeLayout var8 = this.mRlBtnStart;
      var5[1] = var8;
      var5[2] = this.mIbParaPark;
      var5[3] = this.mIbUpDown;
      this.mPage3 = var5;
      View[] var4 = new View[]{var7, var8, this.mRlBtnBack, this.mRlSixBtn};
      this.mPage4 = var4;
      View[] var13 = new View[]{var7};
      this.mPage5 = var13;
      View[] var12 = new View[]{this.mTvParkAssistIntroduce};
      this.mPage6 = var12;
      this.mPageArrays = new View[][]{var6, var11, var5, var4, var13, var12};
