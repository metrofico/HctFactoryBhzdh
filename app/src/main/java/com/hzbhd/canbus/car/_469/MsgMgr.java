...
public class MsgMgr extends AbstractMsgMgr {
   ...
   private void cycleNotifyVersionName(Context var1) {
      ...
      var7 = var6 / 180;
      byte var3 = (byte)var8.get_MMI_SWYear();
      byte var5 = (byte)var8.get_MMI_Swweek();
      byte var4 = (byte)(var7 + 1);
      byte var2 = (byte)(var6 % 180);
      CycleRequest.getInstance().start(0, new ActionCallback(this, new byte[]{22, 24, -1, -94, 40, -22, 34, var3, var5, var4, var2, 0, 0, 1}) {
         final MsgMgr this$0;
   ...
   private void setAir0x18FFA7DA(int[] var1) {
      int var2 = DataHandleUtils.getIntFromByteWithBit(var1[7], 0, 4);
      Object var5 = null;
      String var4;
      switch (var2) {
         case 0:
            ...
            break;
         case 1:
            var4 = "ReturnAirSensorFailure";
            break;
         case 2:
            var4 = "LowVoltageinCoolingSystemPowerSupply";
            break;
         case 3:
            var4 = "DefrostSensorFailure";
            break;
         case 4:
            var4 = "HighVoltageinCoolingSystemPowerSupply";
            break;
         case 5:
            var4 = "ExhaustSensorFailure";
            break;
         case 6:
            var4 = "CoolingSystemPressureAlarm";
            break;
         case 7:
            var4 = "CoolingSystemBackupPowerAlarm";
            break;
         case 8:
            var4 = "CommunicationFailure";
            break;
         default:
            var4 = null;
      }

      this.notifyOtherModule("AIR_FAULT", var4);
      var2 = DataHandleUtils.getIntFromByteWithBit(var1[8], 0, 2);
      String var6 = "Reserved";
      if (var2 != 0) {
         if (var2 != 1) {
            if (var2 != 2) {
               if (var2 != 3) {
      ...
      this.notifyOtherModule("COMPRESSOR_STATUS", var4);
      boolean var3;
      if (DataHandleUtils.getIntFromByteWithBit(var1[8], 2, 2) == 1) {
         var3 = true;
      } else {
         var3 = false;
      }

      this.notifyOtherModule("AIR_FAN_STATUS", var3);
      var2 = DataHandleUtils.getIntFromByteWithBit(var1[8], 4, 2);
      if (var2 != 0) {
         if (var2 != 1) {
            if (var2 != 2) {
               var4 = var6;
      ...
      this.notifyOtherModule("POWER_STATUS", var4);
      var2 = DataHandleUtils.getIntFromByteWithBit(var1[8], 6, 2);
      if (var2 != 0) {
         if (var2 != 1) {
            if (var2 != 2) {
               if (var2 != 3) {
      ...
      this.notifyOtherModule("SYSTEM_STATUS", var4);
      this.notifyOtherModule("CABIN_TEMPERATURE", (double)DataHandleUtils.getMsbLsbResult(var1[10], var1[9]) * 0.1 - 40.0);
      this.notifyOtherModule("DEFROST_TEMPERATURE", (double)DataHandleUtils.getMsbLsbResult(var1[12], var1[11]) * 0.1 - 40.0);
      this.notifyOtherModule("HIGH_VOLTAGE", DataHandleUtils.getIntFromByteWithBit(var1[13], 0, 8) * 4);
      this.notifyOtherModule("COMPRESSOR_CURRENT", (double)DataHandleUtils.getIntFromByteWithBit(var1[14], 0, 8) * 0.1);
   }
         ...
         try {
            if (!TextUtils.isEmpty((CharSequence)this.speechVoice.get(var2))) {
               ...
               if (android.provider.Settings.System.getString(this.mContext.getContentResolver(), "SHARE_MS_BEEP_SPEECH").equals("BEEP")) {
                  VoiceManger var3 = this.voiceManger;
                  StringBuilder var4 = new StringBuilder();
                  var3.play(var1, var4.append("voice/").append((String)this.beepVoice.get(var2)).toString());
               } else {
                  VoiceManger var8 = this.voiceManger;
                  StringBuilder var7 = new StringBuilder();
                  var8.play(var1, var7.append("voice/").append((String)this.speechVoice.get(var2)).toString());
               }
   ...
   private void setRadarVoiceData(Context var1) {
      ...
      var3 = this.nowRadarData12;
      var2 = this.mCanBusInfoInt[14];
      if (var3 != var2) {
         this.nowRadarData12 = var2;
         this.setRadarVoice(var1, DataHandleUtils.getIntFromByteWithBit(var2, 0, 3));
      }
   ...
   public void canbusInfoChange(Context var1, byte[] var2) {
      ...
      this.mCanBusInfoInt = var7;
      if (this.getMsDataType(var7) == 419393561) {
      ...
      } else if (this.getMsDataType(this.mCanBusInfoInt) == 218053139) {
         if (this.isTrackInfoChange(var2)) {
            return;
         }

         int var4 = DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[8], 4, 4);
         int var6 = DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[9], 0, 4);
         DataHandleUtils.getMsbLsbResult_4bit(var6, var4);
         int var3 = DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[9], 4, 4);
         int var5 = DataHandleUtils.getIntFromByteWithBit(this.mCanBusInfoInt[10], 0, 4);
         DataHandleUtils.getMsbLsbResult_4bit(var5, var3);
         var3 = (var4 & 255 | (var6 & 255) << 4 | (var3 & 255) << 8 | (var5 & 255) << 12) - 1040;
      ...
      int[] var8 = this.getByteArrayToIntArray(var2);
      this.mCanBusInfoInt = var8;
      if (this.getMsDataType(var8) == 419407834) {
         this.setAir0x18FFA7DA(this.mCanBusInfoInt);
      }

   }

   public void getCmd() {
      String var1 = this.sharedPreferences.getString("last_cmd", (String)null);
      if (LogUtil.log5()) {
         LogUtil.d("<get_last_cmd>: " + var1);
      }
      ...
      if (var1 != null) {
         if (LogUtil.log5()) {
            LogUtil.d("<get_last_cmd>: " + Arrays.toString(Base64.decode(var1, 0)));
         }

         OptionAirCmd469.getInstance().airCmd = Base64.decode(var1, 0);
   ...
   public void initCommand(Context var1) {
      ...
      var2.setComponent(new ComponentName("com.ms.sanychart", "com.ms.sanychart.MainServices"));
      var1.startService(var2);
      this.sharedPreferences = var1.getSharedPreferences("_s9_prefs", 0);
      this.getCmd();
   }
