...
public class MyPanoramicView extends RelativeLayout implements View.OnClickListener, View.OnTouchListener {
   ...
   public MyPanoramicView(Context var1, int var2) {
      ...
      View[] var11 = new View[]{this.mIbPa};
      this.mPage1 = var11;
      View[] var5 = new View[2];
      RelativeLayout var8 = this.mRlBtnCancel;
      var5[0] = var8;
      var5[1] = this.mIbVertPark;
      this.mPage2 = var5;
      View[] var6 = new View[4];
      var6[0] = var8;
      RelativeLayout var7 = this.mRlBtnStart;
      var6[1] = var7;
      var6[2] = this.mIbParaPark;
      var6[3] = this.mIbUpDown;
      this.mPage3 = var6;
      View[] var4 = new View[]{var8, var7, this.mRlBtnBack, this.mRlSixBtn};
      this.mPage4 = var4;
      View[] var12 = new View[]{var8};
      this.mPage5 = var12;
      View[] var13 = new View[]{this.mTvParkAssistIntroduce};
      this.mPage6 = var13;
      this.mPageArrays = new View[][]{var11, var5, var6, var4, var12, var13};
