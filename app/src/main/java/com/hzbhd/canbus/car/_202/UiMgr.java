...
public class UiMgr extends AbstractUiMgr {
   ...
   public void send0xD2Info(byte[] var1, byte[] var2) {
      byte[] var4 = this.SplicingByte(var1, var2);

      for(int var3 = 0; var3 < var4.length; ++var3) {
         MyLog.temporaryTracking("数据" + var3 + ":" + Integer.toHexString(var4[var3]));
      }

      CanbusMsgSender.sendMsg(this.SplicingByte(var1, var2));
   }
