...
public class AirFrontWindowView extends RelativeLayout implements View.OnClickListener {
   ...
   public AirFrontWindowView(Context var1, AttributeSet var2) {
      super(var1, var2);
      this.mContext = var1;
   ...
   public void initViews(AirPageWindowView var1, AirPageUiSet var2) {
      this.mActivity = var1;
      ...
      if (var2 != null) {
         ...
         this.set = var5;
         if (var5 != null) {
            if (var5.isShowPmValue()) {
               this.mPmLayoutLl.setVisibility(0);
            }

            this.mLineBtnAction = this.set.getLineBtnAction();
            OnAirBtnClickListener[] var7 = this.set.getOnAirBtnClickListeners();
            OnAirBtnClickListener[] var6 = var7;
            if (var7 == null) {
               var6 = new OnAirBtnClickListener[]{null, null, null, null};
            }

            boolean var3 = this.set.isAllBtnCanClick();
            String[] var8 = this.set.getDisableBtnArray();
            String[][] var4 = this.mLineBtnAction;
            if (var4 != null) {
               if (var4.length > 0) {
                  this.mTopLbv.initButton(this.mContext, var4[0], var3, var8, var6[0]);
               }

               var4 = this.mLineBtnAction;
               if (var4.length > 1) {
                  this.mBottomLeftLbv.initButton(this.mContext, var4[1], var3, var8, var6[1]);
               }

               var4 = this.mLineBtnAction;
               if (var4.length > 2) {
                  this.mBottomRightLbv.initButton(this.mContext, var4[2], var3, var8, var6[2]);
               }

               var4 = this.mLineBtnAction;
               if (var4.length > 3) {
                  this.mBottomLbv.initButton(this.mContext, var4[3], var3, var8, var6[3]);
               }
            }

            String var11;
            OnAirSeatHeatColdMinPlusClickListener[] var12;
            if (this.set.isShowSeatHeat()) {
               ...
               var11 = this.getStringByName(this.set.getSeatHeatSrnArray()[0]);
               this.mHeatLeftShhsv.setValue(var11);
               this.mHeatRightShhsv.setValue(var11);
               this.mSeatHeatValueRes = this.set.getSeatHeatSrnArray();
               var12 = this.set.getSeatHeatColdClickListeners();
               if (var12 != null) {
                  this.mHeatLeftShhsv.setOnUpDownClickListener(var12[0]);
                  this.mHeatRightShhsv.setOnUpDownClickListener(var12[1]);
               }
            ...
            if (this.set.isShowSeatCold()) {
               ...
               var11 = this.getStringByName(this.set.getSeatColdSrnArray()[0]);
               this.mColdLeftShhsv.setValue(var11);
               this.mColdRightShhsv.setValue(var11);
               this.mSeatColdValueRes = this.set.getSeatColdSrnArray();
               var12 = this.set.getSeatHeatColdClickListeners();
               if (var12 != null) {
                  this.mColdLeftShhsv.setOnUpDownClickListener(var12[2]);
                  this.mColdRightShhsv.setOnUpDownClickListener(var12[3]);
               }
            } else if (this.mContext.getResources().getConfiguration().orientation == 1) {
            ...
            if (this.set.isCanSetLeftTemp()) {
               OnAirTemperatureUpDownClickListener[] var13 = this.set.getTempSetViewOnUpDownClickListeners();
               OnAirTempTouchListener[] var9 = this.set.getTempTouchListeners();
               if (var13 != null) {
                  this.mTempSetViewLeft.setOnUpDownClickListener(var13[0]);
               }

               if (var9 != null) {
                  this.mTempSetViewLeft.setOnUpDownTouchListener(var9[0]);
               }
            }

            OnAirTemperatureUpDownClickListener[] var10;
            OnAirTempTouchListener[] var14;
            if (this.set.isCanSetCenterTemp()) {
               var10 = this.set.getTempSetViewOnUpDownClickListeners();
               var14 = this.set.getTempTouchListeners();
               if (var10 != null) {
                  this.mTempSetViewCenter.setOnUpDownClickListener(var10[1]);
               }

               if (var14 != null) {
                  this.mTempSetViewCenter.setOnUpDownTouchListener(var14[1]);
               }
            }
            ...
            if (this.set.isCanSetRightTemp()) {
               ...
               if (var14 != null) {
                  this.mTempSetViewRight.setOnUpDownTouchListener(var14[2]);
               }
            }
            ...
            OnAirSeatClickListener var15 = this.set.getOnAirSeatClickListener();
            this.mOnAirSeatClickListener = var15;
            if (var15 != null) {
               this.mLeftSeatIv.setOnClickListener(new View.OnClickListener(this) {
                  final AirFrontWindowView this$0;
            ...
            if (AirActivity.mIsClickOpen) {
               OnAirPageStatusListener var16 = this.set.getOnAirPageStatusListener();
               this.mOnAirPageStatusListener = var16;
               if (var16 != null) {
                  var16.onStatusChange(1);
               }
            }
   ...
   public void onClick(View var1) {
      if (var1.getId() == 2131362804) {
         AirPageWindowView var2 = this.mActivity;
         if (var2 == null) {
            return;
         }
