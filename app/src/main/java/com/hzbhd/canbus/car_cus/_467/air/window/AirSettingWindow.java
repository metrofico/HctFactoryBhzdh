...
public class AirSettingWindow {
   ...
   private void initWindow(Context var1) {
      ...
      this.intiView(var1);
      boolean var2 = SharePreUtil.getBoolValue(var1, "key.air.settings.show.tag。467", false);
   ...
   private void intiView(Context var1) {
      View var2 = LayoutInflater.from(var1).inflate(2131558583, (ViewGroup)null);
      this.view = var2;
      ...
      var4.setOnClickListener(new View.OnClickListener(this, var1) {
         ...
         public void onClick(View var1) {
            SharePreUtil.setBoolValue(this.val$context, "key.air.settings.show.tag。467", this.this$0.isShowAirSettings);
            this.this$0.hide();
