...
public class MyButton extends LinearLayout {
   ...
   public MyButton(Context var1) {
      this(var1, (AttributeSet)null);
   }

   public MyButton(Context var1, AttributeSet var2) {
      this(var1, var2, 0);
   }

   public MyButton(Context var1, AttributeSet var2, int var3) {
      super(var1, var2, var3);
      View var4 = LayoutInflater.from(var1).inflate(2131558610, this, true);
      this.view = var4;
      Button var5 = (Button)var4.findViewById(2131361993);
      this.btn = var5;
      var5.setOnTouchListener(new View.OnTouchListener(this) {
         final MyButton this$0;
         ...
         public boolean onTouch(View var1, MotionEvent var2) {
            if (var2.getAction() == 0) {
               this.this$0.btn.setBackgroundResource(2131231598);
               return true;
            } else if (var2.getAction() == 4) {
               this.this$0.btn.setBackgroundResource(2131231602);
               return true;
            } else {
               if (var2.getAction() == 1) {
                  this.this$0.btn.setBackgroundResource(2131231602);
