...
public class HybridDataView2 extends RelativeLayout {
   ...
   public HybridDataView2(Context var1) {
      this(var1, (AttributeSet)null);
   }

   public HybridDataView2(Context var1, AttributeSet var2) {
      this(var1, var2, 0);
   }

   public HybridDataView2(Context var1, AttributeSet var2, int var3) {
      super(var1, var2, var3);
      this.mView = LayoutInflater.from(var1).inflate(2131558466, this, true);
      this.initView();
   }
