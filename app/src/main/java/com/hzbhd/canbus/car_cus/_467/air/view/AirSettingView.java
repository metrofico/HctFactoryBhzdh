...
public class AirSettingView extends LinearLayout implements AirInfoObserver {
   ...
   public AirSettingView(Context var1, AttributeSet var2, int var3) {
      ...
      this.minute = 0;
      this.context = var1;
      View var4 = LayoutInflater.from(var1).inflate(2131558577, this, true);
      ...
      var5.setOnTouchListener(new View.OnTouchListener(this) {
         ...
         public boolean onTouch(View var1, MotionEvent var2) {
            if (var2.getAction() == 0) {
               ...
               String var5 = ((EditText)this.this$0.parentView.findViewById(2131363529)).getText().toString();
               String var4 = ((EditText)this.this$0.parentView.findViewById(2131363530)).getText().toString();
               if (!var5.equals("") && !var4.equals("")) {
                  this.this$0.IntEditTimeHour = Integer.parseInt(var5);
                  this.this$0.IntEditTimeMinute = Integer.parseInt(var4);
                  if (LogUtil.log5()) {
                  ...
                  if (var8.length() == 0) {
                     ...
                     if (this.this$0.IntEditTimeHour > 24) {
                        ...
                        ((EditText)this.this$0.parentView.findViewById(2131363529)).setText("");
                        ((EditText)this.this$0.parentView.findViewById(2131363530)).setText("");
                        this.this$0.settingsTimeHour.setText(var5);
                        this.this$0.settingsTimeMin.setText(var4);
                        this.this$0.settingTime.setVisibility(8);
                        ((InputMethodManager)this.this$0.getContext().getSystemService("input_method")).hideSoftInputFromWindow(var1.getWindowToken(), 0);
                        return true;
                     }
