...
public class MessageSender {
   ...
   public static String getCommonSwitch() {
      return SharePreUtil.getStringValue(getContext(), "_273_commonSwitch", "");
   }
   ...
   private void saveCanBusInfo(int[] var1, int var2) {
      ...
      if (var2 == 1) {
         SharePreUtil.setStringValue(getContext(), "_273_airInfo1", var5.toString());
      } else if (var2 == 2) {
         SharePreUtil.setStringValue(getContext(), "_273_airInfo2", var5.toString());
      }
   ...
   public static void saveCommonSwitch(int[] var0) {
      ...
      SharePreUtil.setStringValue(getContext(), "_273_commonSwitch", var3.toString());
   }
   ...
   public static void showAirSender(int var0, int var1, boolean var2) {
      ...
      CanbusMsgSender.sendMsg(new byte[]{22, 1, 24, -1, -61, 25, 0, var8, var3, var6, var9, var4, var5, var7, (byte)var10});
   }
   ...
   public static void showCommonSwitch(int var0, int var1, boolean var2) {
      ...
      CanbusMsgSender.sendMsg(new byte[]{22, 1, 24, -2, -87, 23, 0, var4, var7, var5, var6, var8, var3, var9, (byte)var0});
   }
}
