...
public class CarSelectWindow {
   ...
   private void intiView(Context var1) {
      View var2 = LayoutInflater.from(var1).inflate(2131558534, (ViewGroup)null);
      this.view = var2;
      ...
      this.mode1 = var5;
      var5.setTitle(var1.getString(2131765994));
      ...
      this.mode2 = var5;
      var5.setTitle(var1.getString(2131765995));
      ...
      var5 = (CheckItemView2)this.view.findViewById(2131362862);
      this.mode3 = var5;
      var5.setTitle(var1.getString(2131765996));
