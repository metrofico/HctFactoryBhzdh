...
public class MainSettingPersonalActivity extends AbstractBaseActivity implements View.OnClickListener {
   ...
   private void initView() {
      ...
      this.sdv_esc.setOnItemClickListener(new MainSettingPersonalActivity$$ExternalSyntheticLambda0());
   }
   ...
   public void refreshUi(Bundle var1) {
      if (var1 != null) {
         this.mWhat = var1.getInt("_283_CarSetting_what");
         ...
         if (var2 != 16) {
            ...
            ((MyRelativeView)this.findViewById(2131363323)).refreshUi();
         }
