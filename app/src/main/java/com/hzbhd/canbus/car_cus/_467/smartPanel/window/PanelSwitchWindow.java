...
public class PanelSwitchWindow {
   ...
   private void intiView(Context var1) {
      View var2 = LayoutInflater.from(var1).inflate(2131558571, (ViewGroup)null);
      this.view = var2;
      ...
      this.reset.setOnClickListener(new View.OnClickListener(this, var1) {
         ...
         public void onClick(View var1) {
            if (this.this$0.on_view.isCheck()) {
               System.putInt(BaseUtil.INSTANCE.getContext().getContentResolver(), "CAN_BUS_SMART_PANEL_PAGE_SWITCH_467", 1);
            } else {
               System.putInt(BaseUtil.INSTANCE.getContext().getContentResolver(), "CAN_BUS_SMART_PANEL_PAGE_SWITCH_467", 0);
            }
