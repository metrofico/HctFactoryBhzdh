...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
   ...
   public NavigationMenuItemView(Context var1, AttributeSet var2, int var3) {
      ...
      AccessibilityDelegateCompat var5 = new AccessibilityDelegateCompat(this) {
         ...
         public void onInitializeAccessibilityNodeInfo(View var1, AccessibilityNodeInfoCompat var2) {
            ...
            var2.setCheckable(this.this$0.checkable);
         }
      };
      this.accessibilityDelegate = var5;
      ...
      ViewCompat.setAccessibilityDelegate(var4, var5);
   }
   ...
   private StateListDrawable createDefaultBackground() {
      ...
      if (this.getContext().getTheme().resolveAttribute(androidx.appcompat.R.attr.colorControlHighlight, var2, true)) {
         StateListDrawable var1 = new StateListDrawable();
         var1.addState(CHECKED_STATE_SET, new ColorDrawable(var2.data));
   ...
   public void setIcon(Drawable var1) {
      ...
      if (var1 != null) {
         ...
         if (this.hasIconTintList) {
            Drawable.ConstantState var4 = var1.getConstantState();
            if (var4 != null) {
