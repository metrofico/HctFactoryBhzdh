   ...
   public void draw(Canvas var1) {
      ...
      if (var4 != null) {
         if (this.foregroundBoundsChanged) {
            this.foregroundBoundsChanged = false;
            Rect var6 = this.selfBounds;
            Rect var5 = this.overlayBounds;
            int var2 = this.getRight() - this.getLeft();
            int var3 = this.getBottom() - this.getTop();
            if (this.mForegroundInPadding) {
               var6.set(0, 0, var2, var3);
            } else {
               var6.set(this.getPaddingLeft(), this.getPaddingTop(), var2 - this.getPaddingRight(), var3 - this.getPaddingBottom());
            }

            Gravity.apply(this.foregroundGravity, var4.getIntrinsicWidth(), var4.getIntrinsicHeight(), var6, var5);
            var4.setBounds(var5);
         }
